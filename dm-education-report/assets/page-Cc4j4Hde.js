...
}`,c=[{id:`workbench`,label:`健康存摺安全版（目前預設）`,description:`單一病人版報告，強調資料時效、類型不明與歷史申報安全。`,prompt:i},{id:`colleague`,label:`v14`,description:`保留 DCSI、R／PR 規則、固定段落及個別化目標值。`,prompt:a}],l=[{id:`workbench`,label:`八面向安全稽核版（目前預設）`,description:`檢查事實、時間、類型、用藥、數據、可讀性、行動性與隱私。`,prompt:o},{id:`colleague`,label:`audit`,description:`以病人傷害風險為主，並輸出結構化 JSON 稽核結果。`,prompt:s}],u=`20260803165444`,d=[{id:`A`,label:`A｜現行流程・不帶入指引`,description:`生成 LLM 收到 system prompt 與病人資料；不附指引全文。`,usesGuideline:!1,llmWritesPatientText:!0},{id:`B`,label:`B｜現行流程・帶入指引全文`,description:`生成與稽核都額外附上整份《2022第2型糖尿病臨床照護指引》。需先載入指引 TXT。`,usesGuideline:!0,llmWritesPatientText:!0},{id:`C`,label:`C｜模組選擇流程（草案・未經醫療團隊核准）`,description:`LLM 只依病人資料輸出模組代碼與選取理由；病人可見正文由程式以固定文字組合，LLM 不改寫、不補數值。`,usesGuideline:!1,llmWritesPatientText:!1}];function f(e){let t=d.find(t=>t.id===e);if(!t)throw Error(`未知的流程 arm：${e}`);return t}function p(e){if(e.totalTokens<=e.tokenLimit)return null;let t=e.totalTokens-e.tokenLimit;return{code:`token-limit`,message:`估計輸入約 ${e.totalTokens.toLocaleString(`zh-TW`)} tokens，超過模型上限 ${e.tokenLimit.toLocaleString(`zh-TW`)} tokens 約 ${t.toLocaleString(`zh-TW`)} tokens。`,howToFix:`本工具不會自動截斷指引或病人資料。請改選不帶入指引的 A，或改用輸入上限更大的模型。`,hard:!0}}function m(e){let t=[];return e.model||t.push({code:`no-model`,message:`還沒選定 Gemini 模型。`,howToFix:`請在模型下拉選單選擇，或在自訂欄位輸入完整的模型 ID。`,hard:!0}),e.requiresClientKey&&!e.apiKey.trim()&&t.push({code:`no-api-key`,message:`這個版本沒有伺服器可以代為保管金鑰，必須在頁面輸入 Gemini 金鑰。`,howToFix:`請在上方「Gemini 臨時存取金鑰」貼上金鑰。重新整理頁面即清除，不會寫入任何儲存空間。`,hard:!0}),e.arm===`B`&&!e.guidelineText.trim()&&t.push({code:`guideline-missing`,message:`已選 B（帶入指引全文），但目前沒有載入任何指引 TXT。`,howToFix:`請先按「載入指引 TXT」選擇完整的指引檔案；否則請改選 A，以免以為帶入了其實沒有。`,hard:!0}),t}function ee(e){let t=[];e.llmText.trim()||t.push(e.rawInput.trim()?{code:`not-formatted`,message:`已經有原始病人資料，但還沒整理成 LLM 好讀文字。`,howToFix:`請按上方步驟 01 的「整理為 LLM 好讀文字」。更換病人檔案後也需要重新整理一次。`,hard:!0}:{code:`no-patient-data`,message:`還沒有病人資料。`,howToFix:`請在步驟 01 上傳 JSON／TXT、貼上文字，或按「載入去識別示範」，再按「整理為 LLM 好讀文字」。`,hard:!0}),e.arm!==`C`&&!e.generatorPrompt.trim()&&t.push({code:`empty-generator-prompt`,message:`生成用的 system prompt 是空白的。`,howToFix:`請在下方貼上 prompt，或按「恢復工作台預設」載回預設版本。`,hard:!0}),t.push(...m(e));let n=p(e);return n&&t.push(n),t}function te(e){let t=[];e.llmText.trim()||t.push({code:`no-patient-data`,message:`稽核需要 LLM 好讀病人資料，目前是空的。`,howToFix:`請先完成步驟 01 的整理。`,hard:!0}),e.report.trim()||t.push({code:`no-report`,message:`還沒有可稽核的報告。`,howToFix:`請先執行「生成衛教報告」，或直接把要稽核的報告貼進報告欄位。`,hard:!0}),e.evalPrompt.trim()||t.push({code:`empty-eval-prompt`,message:`稽核用的 system prompt 是空白的。`,howToFix:`請在下方貼上 prompt，或按「恢復工作台預設」載回預設版本。`,hard:!0}),t.push(...m(e));let n=p(e);return n&&t.push(n),t}function ne(e){return e.some(e=>e.hard)}var re=652078,ie=283353,ae=1048576;function h(e){return e>=19968&&e<=40959||e>=13312&&e<=19903||e>=63744&&e<=64255||e>=12288&&e<=12351||e>=65280&&e<=65519}function g(e){let t=0,n=0,r=0,i=0,a=0;for(let o of e){a+=1;let e=o.codePointAt(0)??0;h(e)?t+=1:e<128?o===` `||o===`	`||o===`
`||o===`\r`||o===`\f`||o===`\v`?r+=1:n+=1:i+=1}return{total:a,cjk:t,asciiVisible:n,whitespace:r,other:i}}function oe(e){if(!e)return 0;let{cjk:t,asciiVisible:n,whitespace:r,other:i}=g(e);return Math.round(t+n/4+r/5+i/2)}function se(e){return e?[...e].length===652078?{tokens:ie,method:`measured`}:{tokens:oe(e),method:`estimate`}:{tokens:0,method:`estimate`}}function ce(e){return[...e].length}function _(e){return e.toLocaleString(`zh-TW`)}var le=`【參考指引全文：2022第2型糖尿病臨床照護指引】`;function ue(e,t,n){let r=n??{tokens:oe(t),method:`estimate`};return{label:e,chars:ce(t),tokens:r.tokens,method:r.method}}function v(e,t,n){let r=n.text??``,i=r.trim().length>0,a=n.include&&i,o=t.map(e=>e.text),s=a?`${o.join(`

`)}\n\n${le}\n${r}`:o.join(`

`),c=[ue(`system prompt`,e),...t.map(e=>ue(e.label,e.text,e.count))];return a&&c.push(ue(`指引全文`,r,se(r))),{text:s,systemPrompt:e,parts:c,totalChars:c.reduce((e,t)=>e+t.chars,0),totalTokens:c.reduce((e,t)=>e+t.tokens,0),hasEstimate:c.some(e=>e.method===`estimate`),guidelineIncluded:a,guidelineRequestedButMissing:n.include&&!i}}function de(e){return v(e.systemPrompt,[{label:`病人資料`,text:e.patientText}],{include:e.includeGuideline,text:e.guidelineText})}function fe(e){return v(e.systemPrompt,[{label:`病人資料`,text:`【病人資料】\n${e.patientText}`},{label:`待評估報告`,text:`【待評估報告】\n${e.report}`}],{include:e.includeGuideline,text:e.guidelineText})}function pe(e){return v(e.systemPrompt,[{label:`病人事實摘要`,text:e.factsText}],{include:!1,text:``})}var me=[`REPORT_DATE`,`BIRTHDAY`,`INDX_DATE`,`SEX`,`P4P`,`HT`,`HL`,`CKD`,`T`,`DCSI`,`AGEGP`,`GRADE`],he={REPORT_DATE:`報告日期`,BIRTHDAY:`出生日期`,INDX_DATE:`糖尿病指標日期`,SEX:`性別代碼`,P4P:`是否參加糖尿病P4P`,HT:`高血壓`,HL:`高血脂`,CKD:`慢性腎臟病`,T:`糖尿病病程年數`,DCSI:`DCSI總分`,AGEGP:`年齡分組`,GRADE:`整體分級`},ge={medication:`用藥紀錄`,labData:`檢驗資料`,chinesemed:`中藥用藥`,imaging:`影像資料`,allergy:`過敏資料`,surgery:`手術資料`,discharge:`出院資料`,medDays:`用藥天數資料`,patientSummary:`病人摘要`,cancerScreening:`癌症篩檢`,adultHealthCheck:`成人健檢`};function y(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function b(e){return e==null||e===``||e===`null`?`未提供`:typeof e==`object`?JSON.stringify(e):String(e).replaceAll(`\r`,` `).replaceAll(`
`,` `).trim()||`未提供`}function x(e){return Array.isArray(e)?e.map(x):y(e)?Object.fromEntries(Object.keys(e).sort().map(t=>[t,x(e[t])])):e}function _e(e){let t=new Map;for(let n of e){let e=JSON.stringify(x(n)),r=t.get(e);r?r.count+=1:t.set(e,{record:n,count:1})}return[...t.values()]}function S(e,t){let n=me.indexOf(e),r=me.indexOf(t);if(n!==-1||r!==-1)return n===-1?1:r===-1?-1:n-r;let i=e.match(/^(R|PR)(\d+)$/),a=t.match(/^(R|PR)(\d+)$/);return i&&a?i[1]===a[1]?Number(i[2])-Number(a[2]):i[1]===`R`?-1:1:i?-1:a?1:e.localeCompare(t)}function ve(e,t=0){let n=`  `.repeat(t);if(Array.isArray(e))return e.length?e.flatMap((e,r)=>y(e)||Array.isArray(e)?[`${n}- 第 ${r+1} 筆`,...ve(e,t+1)]:[`${n}- ${b(e)}`]):[`${n}（空陣列）`];if(y(e)){let r=Object.entries(e);return r.length?r.flatMap(([e,r])=>y(r)||Array.isArray(r)?[`${n}${e}：`,...ve(r,t+1)]:[`${n}${e}：${b(r)}`]):[`${n}（空物件）`]}return[`${n}${b(e)}`]}function C(e,t){let n=e[t];return y(n)&&Array.isArray(n.rObject)?n.rObject:[]}function ye(e){return y(e)?Object.entries(e).filter(([,e])=>e!=null&&e!==``&&e!==`null`).map(([e,t])=>`${e}:${b(t)}`).join(`｜`):b(e)}function be(e){if(!y(e))return[`【輸入資料】`,...ve(e),``,`【資料使用限制】`,`以上僅重新排版，沒有推定缺少的診斷、日期、用藥狀態或治療資訊。`].join(`
`);if(![`downloadType`,`userInfo`,`userInput`,`rawSources`].some(t=>t in e))return[`【來源JSON欄位】`,...ve(e),``,`【資料使用限制】`,`以上保留來源欄位並重新排版；空值或未出現欄位不得自行解讀為0或正常。`].join(`
`);let t=[`【檔案與基本資料】`,`資料匯出類型：${b(e.downloadType)}`],n=y(e.userInfo)?e.userInfo:{},r=y(e.userInput)?e.userInput:{},i=y(e.rawSources)?e.rawSources:{};for(let[e,r]of Object.entries(n))t.push(`${e}：${b(r)}`);t.push(``,`【來源模型欄位】`,`以下保留來源原值；未提供不等同於0。`);let a=Object.keys(r).sort(S);a.length||t.push(`未提供來源模型欄位。`);for(let e of a){let n=he[e]?`（${he[e]}）`:``;t.push(`${e}${n}：${b(r[e])}`)}t.push(``,`【DCSI與風險欄位說明】`),t.push(`僅保留來源DCSI、R與PR原始欄位；整理階段不重新解釋分數。來源未出現的欄位不得自行補值，也不得直接視為0。`),t.push(``,`【資料來源概況】`);let o=Object.entries(i);o.length||t.push(`未提供rawSources資料來源。`);for(let[e,n]of o){let r=y(n)&&Array.isArray(n.rObject)?n.rObject:[];t.push(`${ge[e]??e}（${e}）：${r.length}筆${r.length?``:`，來源為空陣列`}`)}let s=C(i,`medication`),c=_e(s),l=new Map;for(let e of c){let t=y(e.record)?e.record:{},n=`${b(t.drug_date).replaceAll(`/`,`-`)}｜${`ICD ${b(t.icd_code)}｜${b(t.icd_cname)}`}`,r=ye(Object.fromEntries(Object.entries(t).filter(([e])=>![`drug_date`,`icd_code`,`icd_cname`].includes(e)))),i=l.get(n)??[];i.push({text:r||`原紀錄沒有其他欄位`,count:e.count}),l.set(n,i)}t.push(``,`【用藥紀錄】`),t.push(`來源共${s.length}筆；完全相同紀錄合併後${c.length}筆。重複次數以×N保留；不同欄位不合併。`),s.length||t.push(`未提供用藥紀錄。`);for(let e of[...l.keys()].sort().reverse()){t.push(e);for(let n of l.get(e)??[])t.push(`- ${n.text}${n.count>1?`｜×${n.count}`:``}`)}let u=C(i,`labData`),d=_e(u),f=new Map;for(let e of d){let t=y(e.record)?e.record:{},n=[b(t.fee_ym),b(t.order_code),b(t.order_name),`方法:${b(t.assay_method)}`,`檢體或模式:${b(t.inspect_mode)}`].join(`｜`),r=`${b(t.assay_item_name)}=${b(t.assay_value)}`;b(t.unit_data)!==`未提供`&&(r+=` ${b(t.unit_data)}`),r+=`｜參考:${b(t.consult_value)}`;let i=Object.entries(t).filter(([e,t])=>![`fee_ym`,`order_code`,`order_name`,`assay_method`,`inspect_mode`,`assay_item_name`,`assay_value`,`unit_data`,`consult_value`].includes(e)&&t!=null&&t!==``).map(([e,t])=>`${e}:${b(t)}`);i.length&&(r+=`｜其他欄位:${i.join(`、`)}`);let a=f.get(n)??[];a.push({text:r,count:e.count}),f.set(n,a)}t.push(``,`【檢驗與檢查紀錄】`),t.push(`來源共${u.length}筆；完全相同紀錄合併後${d.length}筆。若來源只有費用年月而沒有採檢日時，不得推定同月份內的先後順序。`),u.length||t.push(`未提供檢驗與檢查紀錄。`);for(let e of[...f.keys()].sort().reverse()){t.push(e);for(let n of f.get(e)??[])t.push(`- ${n.text}${n.count>1?`｜×${n.count}`:``}`)}t.push(``,`【其他來源的非空紀錄】`);let p=0;for(let[e]of o.filter(([e])=>![`medication`,`labData`].includes(e))){let n=C(i,e);if(!n.length)continue;p+=n.length;let r=_e(n);t.push(`${ge[e]??e}（${e}）：來源${n.length}筆，完全相同紀錄合併後${r.length}筆。`),r.forEach((e,n)=>{t.push(`- ${n+1}. ${ye(e.record)}${e.count>1?`｜×${e.count}`:``}`)})}p||t.push(`其餘來源目前沒有可列出的紀錄。`);let m=Object.keys(e).filter(e=>![`downloadType`,`userInfo`,`userInput`,`rawSources`].includes(e));if(m.length){t.push(``,`【其他根層欄位】`);for(let n of m)t.push(`${n}：${b(e[n])}`)}return t.push(``,`【資料使用限制】`),t.push(`以上為來源JSON重新排版；除合併完全相同紀錄外，未刪除不同結果，也未判定哪一筆較可信。重複筆數均以×N保留。`),t.push(`不同檢驗數值可能代表真實病程變化，也可能涉及資料品質；若有疑義，應由醫療人員結合實際採檢時間與臨床狀況確認。`),t.push(`來源未提供的日期、糖尿病類型、診斷、檢驗、用藥狀態或治療資訊不得自行補寫；歷史申報用藥不得直接描述為目前仍在使用。`),t.join(`
`)}var w=300;function xe(e,t=w){let n=e.replace(/\s+/g,` `).trim();return n.length<=t?n:`${n.slice(0,t)}…（原始回應共 ${n.length} 字，此處僅顯示前 ${t} 字）`}function Se(e,t){let n=t.toLowerCase();return e===400&&(n.includes(`api key not valid`)||n.includes(`api_key_invalid`))?{title:`Gemini 不接受這把 API 金鑰（HTTP 400）`,advice:`請確認貼上的是完整、未過期的金鑰，且該金鑰已啟用 Generative Language API。重新貼一次時注意不要含到前後空白。`}:e===400?{title:`Gemini 認為這次請求的內容或參數有問題（HTTP 400）`,advice:`常見原因是模型 ID 不支援目前的請求格式，或輸入內容含有無法處理的欄位。請對照下方原始錯誤，先試著改用預設模型。`}:e===401||e===403?{title:`這把金鑰沒有呼叫此模型的權限（HTTP `+e+`）`,advice:`請確認金鑰所屬專案已啟用 Generative Language API、未被限制來源網域，且帳單設定允許使用這個模型。`}:e===404?{title:`找不到這個模型 ID（HTTP 404）`,advice:`請確認模型名稱拼寫正確且你的金鑰有權存取。可先切回預設的 gemini-3.6-flash 確認流程本身正常。`}:e===413?{title:`請求內容過大，被拒絕（HTTP 413）`,advice:`這通常發生在帶入指引全文（B）時。請確認是否真的需要整份指引；本工具不會自動截斷指引，需要縮減請由你決定。`}:e===429?{title:`超過配額或速率上限（HTTP 429）`,advice:`免費層級對大型輸入特別容易觸發。請稍候再試、改用較小的輸入（例如改跑 A），或換一把有額度的金鑰。`}:e===408||e===504||e===524||e===522?{title:`請求逾時（HTTP ${e}）`,advice:`帶入指引全文時輸入約 283,353 tokens，單次回應可能需要數分鐘，中間的代理層可能先行斷線。可改跑 A 確認流程正常，或改用回應較快的模型。`}:e===499?{title:`連線在回應完成前被中斷（HTTP 499）`,advice:`多半是瀏覽器或中間代理層提前關閉連線。若是在 B 模式發生，請視為逾時處理。`}:e>=500?{title:`Gemini 端暫時性錯誤（HTTP ${e}）`,advice:`這不是你的輸入造成的。請稍候重試；若持續發生，改用另一個模型或稍後再跑。`}:{title:`Gemini 回傳 HTTP ${e}`,advice:`請參考下方原始錯誤內容判斷原因。`}}function Ce(e){let t=e.trim();return t&&t.toLowerCase()!==`unknown`?t:``}function T(e){let{status:t=null,apiMessage:n=``,rawBody:r=``,cause:i,timedOut:a=!1}=e,o=Ce(e.statusText??``);if(i instanceof Error&&i.name===`AbortError`&&!a)return{title:`已依你的要求停止這次請求`,advice:`沒有送出任何後續請求；你可以調整設定後重新執行。`,raw:``,status:null,aborted:!0,timedOut:!1};if(a||i instanceof Error&&i.name===`TimeoutError`)return{title:`等待 Gemini 回應超過設定的時間上限`,advice:`帶入指引全文時輸入約 283,353 tokens，回應時間會明顯拉長。可以延長逾時上限、改跑 A 對照，或改用較快的模型。請求已中止，沒有部分結果。`,raw:i instanceof Error?i.message:``,status:null,aborted:!1,timedOut:!0};if(i instanceof TypeError)return{title:`瀏覽器無法送出這次請求（網路層失敗）`,advice:`常見原因：網路中斷、瀏覽器擴充功能或企業代理封鎖了對 Gemini 的請求、或 CORS 被擋。請開瀏覽器主控台看是否有被封鎖的紀錄，並試著關閉擴充功能後重試。`,raw:i.message,status:null,aborted:!1,timedOut:!1};if(t===null)return{title:`請求失敗`,advice:`請參考下方原始錯誤內容。`,raw:i instanceof Error?i.message:String(i??``),status:null,aborted:!1,timedOut:!1};if(!n&&r){let e=/^\s*<(?:!doctype|html)/i.test(r),n=Se(t,r);return{title:e?`回應不是 Gemini 的 JSON，而是一頁 HTML（HTTP ${t}${o?` ${o}`:``}）`:n.title,advice:e?`這代表請求沒有走到 Gemini，或在中途被代理層攔下並改回錯誤頁。${n.advice}`:n.advice,raw:xe(r),status:t,aborted:!1,timedOut:!1}}let s=Se(t,n);return{title:s.title,advice:s.advice,raw:n?xe(n):``,status:t,aborted:!1,timedOut:!1}}var we=`https://generativelanguage.googleapis.com/v1/interactions`;function E(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}async function D(e){let t=await e.text(),n=null;try{let e=JSON.parse(t);E(e)&&(n=e)}catch{n=null}return{ok:e.ok,status:e.status,statusText:e.statusText,json:n,rawBody:t}}function Te(e){return typeof e.output_text==`string`?e.output_text:typeof e.outputText==`string`?e.outputText:[...Array.isArray(e.steps)?e.steps:[]].reverse().flatMap(e=>!E(e)||e.type!==`model_output`||!Array.isArray(e.content)?[]:e.content).filter(e=>E(e)&&e.type===`text`&&typeof e.text==`string`).map(e=>String(e.text)).join(`
`).trim()||(Array.isArray(e.outputs)?e.outputs:[]).flatMap(e=>E(e)&&Array.isArray(e.content)?e.content:[]).filter(e=>E(e)&&typeof e.text==`string`).map(e=>String(e.text)).join(`
`).trim()||(Array.isArray(e.candidates)?e.candidates:[]).flatMap(e=>{if(!E(e))return[];let t=e.content;return E(t)&&Array.isArray(t.parts)?t.parts:[]}).filter(e=>E(e)&&typeof e.text==`string`).map(e=>String(e.text)).join(`
`).trim()}function O(e){if(!e)return``;let t=e.error;return E(t)&&typeof t.message==`string`?t.message:typeof e.error==`string`?e.error:``}function k(e,t){let n=new AbortController,r=setTimeout(()=>n.abort(new DOMException(`timeout`,`TimeoutError`)),t);return{signal:AbortSignal.any([e,n.signal]),timedOut:()=>n.signal.aborted,cleanup:()=>clearTimeout(r)}}var A=class extends Error{constructor(e){super(e.title),this.name=`GeminiRequestError`,this.failure=e}};async function Ee(e){let{apiKey:t,model:n,systemPrompt:r,input:i,signal:a,direct:o,simulate:s}=e,c=k(a,e.timeoutMs??9e5),l=Date.now();try{if(o&&!t.trim())throw new A(T({status:null,apiMessage:`這個版本需要在頁面輸入 Gemini API 金鑰。`}));let e=await D(o?await fetch(we,{method:`POST`,signal:c.signal,headers:{"Content-Type":`application/json`,"x-goog-api-key":t.trim()},body:JSON.stringify({model:n,input:i,system_instruction:r,store:!1})}):await fetch(`/api/gemini`,{method:`POST`,signal:c.signal,headers:{"Content-Type":`application/json`},body:JSON.stringify({apiKey:t,model:n,systemPrompt:r,input:i})}));if(!e.ok)throw new A(T({status:e.status,statusText:e.statusText,apiMessage:O(e.json),rawBody:e.json?``:e.rawBody}));if(!e.json)throw new A(T({status:e.status,statusText:e.statusText,rawBody:e.rawBody}));let a=o?Te(e.json):String(e.json.text??``);if(!a.trim())throw new A(T({status:e.status,apiMessage:O(e.json)||`Gemini 已回應，但回應中找不到文字輸出。`,rawBody:e.json?``:e.rawBody}));return{text:a,usage:E(e.json.usage)?e.json.usage:E(e.json.usage_metadata)?e.json.usage_metadata:null,elapsedMs:Date.now()-l}}catch(e){throw e instanceof A?e:new A(T({cause:e,timedOut:c.timedOut()}))}finally{c.cleanup()}}async function De(e){let{apiKey:t,model:n,text:r,direct:i,signal:a}=e,o=i?`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(n)}:countTokens`:`/api/gemini/count-tokens`,s=await D(i?await fetch(o,{method:`POST`,signal:a,headers:{"Content-Type":`application/json`,"x-goog-api-key":t.trim()},body:JSON.stringify({contents:[{parts:[{text:r}]}]})}):await fetch(o,{method:`POST`,signal:a,headers:{"Content-Type":`application/json`},body:JSON.stringify({apiKey:t,model:n,text:r})}));if(!s.ok||!s.json)throw new A(T({status:s.status,statusText:s.statusText,apiMessage:O(s.json),rawBody:s.json?``:s.rawBody}));let c=s.json.totalTokens??s.json.total_tokens??s.json.tokens,l=Number(c);if(!Number.isFinite(l))throw new A(T({status:s.status,apiMessage:`countTokens 回應中沒有 totalTokens。`}));return l}var Oe=`draft-0.1`,j=[{id:`BASE-01`,topic:`BASE`,title:`資料時效與使用範圍`,appliesWhen:`每份報告固定顯示，由程式自動加入，LLM 不需選取。`,typeGate:`any`,autoOnly:!0,patientText:`關於這份報告
...
}`;function st(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,i.click(),URL.revokeObjectURL(r)}function ct(e){return`${_(ce(e))} 字`}function lt(e){let t=e.match(/"audit_status"\s*:\s*"(PASS|REVISE|FAIL)"/i)?.[1]?.toUpperCase(),n=e.match(/(?:^|\n)\s*(?:##\s*稽核結論\s*\n\s*)?(PASS|REVISE|NEEDS_REVIEW|FAIL)\b/im)?.[1]?.toUpperCase(),r=t||n;return r===`FAIL`?{label:`FAIL`,tone:`danger`}:r===`REVISE`?{label:`REVISE`,tone:`warning`}:r===`NEEDS_REVIEW`?{label:`需人工覆核`,tone:`warning`}:r===`PASS`?{label:`PASS`,tone:`success`}:{label:`已完成`,tone:`neutral`}}function ut({blockers:e,label:t}){return e.length?(0,Q.jsxs)(`div`,{className:`blockerList`,role:`status`,children:[(0,Q.jsx)(`strong`,{children:t}),(0,Q.jsx)(`ul`,{children:e.map(e=>(0,Q.jsxs)(`li`,{className:e.hard?`hard`:`soft`,children:[(0,Q.jsx)(`span`,{className:`blockerMessage`,children:e.message}),(0,Q.jsx)(`span`,{className:`blockerFix`,children:e.howToFix})]},e.code))})]}):null}function dt({input:e,title:t,note:n}){let r=e.totalTokens>ae,i=Math.min(999,Math.round(e.totalTokens/ae*100));return(0,Q.jsxs)(`details`,{className:`compositionPanel`,children:[(0,Q.jsxs)(`summary`,{children:[t,`：約 `,_(e.totalTokens),` tokens（`,_(e.totalChars),` 字）`,(0,Q.jsxs)(`span`,{className:r?`limitBadge over`:`limitBadge`,children:[`模型上限的 `,i,`%`]})]}),(0,Q.jsx)(`table`,{children:(0,Q.jsxs)(`tbody`,{children:[e.parts.map(e=>(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`th`,{children:e.label}),(0,Q.jsxs)(`td`,{children:[_(e.chars),` 字`]}),(0,Q.jsxs)(`td`,{children:[`約 `,_(e.tokens),` tokens`,(0,Q.jsx)(`em`,{children:e.method===`measured`?`實測`:`估算`})]})]},e.label)),(0,Q.jsxs)(`tr`,{className:`totalRow`,children:[(0,Q.jsx)(`th`,{children:`合計`}),(0,Q.jsxs)(`td`,{children:[_(e.totalChars),` 字`]}),(0,Q.jsxs)(`td`,{children:[`約 `,_(e.totalTokens),` tokens`]})]})]})}),(0,Q.jsxs)(`p`,{children:[n?`${n} `:``,e.hasEstimate?`標示「估算」的段落是以字元組成推估，誤差在指引全文上約 0.1%，其他文字可能更大；需要精確值請按「用 countTokens 精算」。`:`所有段落都是 Gemini 官方實測值。`]})]})}function $(){let[e,t]=(0,r.useState)(``),[n,a]=(0,r.useState)(``),[s,p]=(0,r.useState)(``),[m,h]=(0,r.useState)(`raw`),[g,oe]=(0,r.useState)(``),[le,ue]=(0,r.useState)(!1),[v,me]=(0,r.useState)(et),[he,ge]=(0,r.useState)(``),[y,b]=(0,r.useState)(`workbench`),[x,_e]=(0,r.useState)(`workbench`),[S,ve]=(0,r.useState)(i),[C,ye]=(0,r.useState)(o),[w,xe]=(0,r.useState)(``),[Se,Ce]=(0,r.useState)(``),[we,E]=(0,r.useState)(null),[D,Te]=(0,r.useState)(`A`),[O,k]=(0,r.useState)(``),[Oe,j]=(0,r.useState)(``),[M,N]=(0,r.useState)(``),[P,F]=(0,r.useState)(`idle`),[ke,Ae]=(0,r.useState)(null),[je,Me]=(0,r.useState)(0),[I,L]=(0,r.useState)(rt),[R,z]=(0,r.useState)(null),[Ne,B]=(0,r.useState)(``),[Pe,Fe]=(0,r.useState)(!1),[V,Ie]=(0,r.useState)(``),Le=(0,r.useRef)(null),Re=(0,r.useRef)(null),H=(0,r.useRef)(null),He=(0,r.useRef)(null),U=P!==`idle`,W=(0,r.useMemo)(()=>lt(M),[M]),Ke=v===tt?he.trim():v,qe=f(D),G=D===`B`,K=typeof window<`u`&&window.location.hostname.endsWith(`github.io`),q=(0,r.useMemo)(()=>{let t=e.trim();if(!t.startsWith(`{`)&&!t.startsWith(`[`))return null;try{return JSON.parse(t)}catch{return null}},[e]),J=(0,r.useMemo)(()=>q?Ze(q):null,[q]),Y=(0,r.useMemo)(()=>D===`C`?pe({systemPrompt:ze,factsText:J?`${Qe(J)}\n\n${Ge(Ve(null,J))}`:``}):de({systemPrompt:S,patientText:n,includeGuideline:G,guidelineText:w}),[D,J,S,n,G,w]),X=(0,r.useMemo)(()=>fe({systemPrompt:C,patientText:n,report:O,includeGuideline:G,guidelineText:w}),[C,n,O,G,w]),Je={arm:D,llmText:n,rawInput:e,generatorPrompt:S,evalPrompt:C,report:O,model:Ke,apiKey:g,requiresClientKey:K,guidelineText:w,tokenLimit:ae},Ye=(0,r.useMemo)(()=>{let e=ee({...Je,totalTokens:Y.totalTokens});return D===`C`&&!q&&e.push({code:`arm-c-needs-json`,message:`C（模組選擇流程）需要原始 JSON 病人資料才能做確定性事實抽取。`,howToFix:`請在步驟 01 上傳或貼上原始 JSON。純文字輸入無法使用 C。`,hard:!0}),e},[D,n,e,S,Ke,g,K,w,Y.totalTokens,q]),Xe=(0,r.useMemo)(()=>te({...Je,totalTokens:X.totalTokens}),[D,n,C,O,Ke,g,K,w,X.totalTokens]),Z=(0,r.useMemo)(()=>we===null?se(w):{tokens:we,method:`measured`},[w,we]);(0,r.useEffect)(()=>{if(ke===null)return;let e=window.setInterval(()=>{Me(Math.floor((Date.now()-ke)/1e3))},250);return()=>window.clearInterval(e)},[ke]),(0,r.useEffect)(()=>{R&&He.current&&He.current.scrollIntoView({block:`nearest`,behavior:`smooth`})},[R]);function $(e,t){z({title:e,advice:t,raw:``,status:null,aborted:!1,timedOut:!1})}function ft(e){if(b(e),e===`custom`)return;let t=c.find(t=>t.id===e);t&&ve(t.prompt)}function pt(e){if(_e(e),e===`custom`)return;let t=l.find(t=>t.id===e);t&&ye(t.prompt)}function mt(){ft(y===`custom`?`workbench`:y)}function ht(){pt(x===`custom`?`workbench`:x)}async function gt(e){if(z(null),e.size>$e){$(`指引 TXT 超過 5 MB`,`請確認是否選到正確的檔案；本工具不會自動截斷指引。`);return}if(!e.name.toLowerCase().endsWith(`.txt`)){$(`指引目前只支援 TXT`,`請先把 PDF 轉成純文字 TXT 再載入。`);return}let t=await e.text();if(!t.trim()){$(`指引 TXT 沒有可用文字`,`檔案讀起來是空的，請確認轉檔結果。`);return}xe(t),Ce(e.name),E(null);let n=ce(t);B(n===652078?`已載入指引：${_(n)} 字元，與已知全文完全相同，token 數採用官方實測值 ${_(ie)}。`:`已載入指引：${_(n)} 字元。與已知全文（${_(re)} 字元）不同，token 數為估算值。`)}function _t(e){let t=e.target.files?.[0];t&&gt(t),e.target.value=``}async function vt(e){if(z(null),e.size>$e){$(`檔案超過 5 MB`,`請先縮小檔案再上傳。`);return}let n=e.name.toLowerCase();if(!n.endsWith(`.json`)&&!n.endsWith(`.txt`)){$(`目前只支援 JSON 與 TXT`,`請改用 .json 或 .txt 檔案。`);return}let r=await e.text();if(ce(r)>it&&r.includes(`糖尿病臨床照護指引`)){$(`這個檔案看起來是指引全文，不是病人資料`,`已經略過，沒有覆蓋你目前的病人資料。指引請用下方「載入指引 TXT」按鈕載入。`);return}t(r),p(e.name),a(``),k(``),j(``),N(``),h(`raw`),B(`已載入新的病人資料，請重新按「整理為 LLM 好讀文字」。`)}function yt(e){let t=e.target.files?.[0];t&&vt(t),e.target.value=``}function bt(e){e.preventDefault(),Fe(!1);let t=e.dataTransfer.files?.[0];t&&vt(t)}function xt(){if(z(null),B(``),!e.trim()){$(`還沒有病人資料`,`請先上傳檔案、貼上文字，或按「載入去識別示範」。`);return}F(`formatting`);try{let t=e.trim();t.startsWith(`{`)||t.startsWith(`[`)?a(be(JSON.parse(t))):a(t),h(`formatted`),k(``),j(``),N(``)}catch{$(`這段內容看起來像 JSON，但格式無法解析`,`請檢查括號、逗號或引號是否成對；也可以改用 TXT 純文字輸入。`)}finally{F(`idle`)}}async function St(e,t,n){return Ee({apiKey:g,model:Ke,systemPrompt:e,input:t,signal:n,direct:K,timeoutMs:I*60*1e3,simulate:void 0})}async function Ct(){if(z(null),B(``),ne(Ye)){let e=Ye.find(e=>e.hard);return e&&$(e.message,e.howToFix),``}F(`generating`),Ae(Date.now()),Me(0);let e=new AbortController;H.current=e;try{if(D===`C`){if(!J)throw Error(`缺少可用的 JSON 病人資料。`);let t={reportDate:J.reportDate.known?J.reportDate.value:null,dataCutoff:J.dataCutoff.known?J.dataCutoff.value:null},n=Ve(Be((await St(ze,Y.text,e.signal)).text),J),r=Ue(n,t);k(r),j(We(n,J,t)),N(``);let i=n.decisions.filter(e=>e.kind!==`excluded`&&e.kind!==`prevention-moderate`).length;return B(`完成：程式依 R／PR 納入 ${i} 個併發症主題、${n.moderateTopics.length} 個簡短提醒、${n.selfCareModuleIds.length} 個自我照護模組。病人可見正文完全來自固定文字；LLM 只提供優先排序與提醒${n.selection?.disagreements.length?`，並對程式判定提出 ${n.selection.disagreements.length} 點不同意見（已記錄未採用）`:``}。`),r}let t=await St(S,Y.text,e.signal);return k(t.text),j(``),N(``),t.text}catch(e){return e instanceof A?e.failure.aborted||z(e.failure):z(T({cause:e})),``}finally{H.current===e&&(H.current=null),Ae(null),F(`idle`)}}async function wt(e){z(null);let t=e||O,r=te({...Je,report:t,totalTokens:X.totalTokens});if(ne(r)){let e=r.find(e=>e.hard);e&&$(e.message,e.howToFix);return}F(`evaluating`),Ae(Date.now()),Me(0);let i=new AbortController;H.current=i;try{N((await St(C,fe({systemPrompt:C,patientText:n,report:t,includeGuideline:G,guidelineText:w}).text,i.signal)).text)}catch(e){e instanceof A?e.failure.aborted||z(e.failure):z(T({cause:e}))}finally{H.current===i&&(H.current=null),Ae(null),F(`idle`)}}function Tt(){H.current?.abort()}async function Et(){let e=await Ct();e&&await wt(e)}async function Dt(){if(z(null),!w.trim()){$(`還沒載入指引`,`請先按「載入指引 TXT」。`);return}if(K&&!g.trim()){$(`精算需要 Gemini 金鑰`,`請先在上方輸入金鑰；countTokens 不會產生生成費用。`);return}F(`counting`);let e=new AbortController;H.current=e;try{let t=await De({apiKey:g,model:Ke,text:w,direct:K,signal:e.signal});E(t),B(`countTokens 實測：指引全文為 ${_(t)} tokens。`)}catch(e){e instanceof A?e.failure.aborted||z(e.failure):z(T({cause:e}))}finally{H.current===e&&(H.current=null),Ae(null),F(`idle`)}}async function Ot(e,t){await navigator.clipboard.writeText(e),Ie(t),window.setTimeout(()=>Ie(``),1600)}function kt(){t(``),a(``),p(``),k(``),j(``),N(``),z(null),B(``),h(`raw`)}let At=U||ne(Ye),jt=U||ne(Xe);return(0,Q.jsxs)(`main`,{children:[(0,Q.jsxs)(`header`,{className:`topbar`,children:[(0,Q.jsxs)(`a`,{className:`brand`,href:`#top`,"aria-label":`糖衛工作台首頁`,children:[(0,Q.jsx)(`span`,{className:`brandMark`,children:`糖衛`}),(0,Q.jsx)(`span`,{children:`報告工作台`})]}),(0,Q.jsxs)(`div`,{className:`topMeta`,children:[(0,Q.jsxs)(`span`,{className:`privacyPill`,children:[(0,Q.jsx)(`span`,{className:`statusDot`}),`不寫入本站資料庫`]}),(0,Q.jsx)(`span`,{className:`modelPill`,children:`金鑰僅暫存本頁`})]})]}),(0,Q.jsxs)(`section`,{className:`hero`,id:`top`,children:[(0,Q.jsxs)(`div`,{className:`heroCopy`,children:[(0,Q.jsx)(`p`,{className:`eyebrow`,children:`DIABETES EDUCATION REPORT LAB`}),(0,Q.jsx)(`h1`,{children:`從病人資料，到可讀的衛教報告與品質稽核。`}),(0,Q.jsx)(`p`,{className:`heroLead`,children:`上傳 JSON、TXT 或直接貼上文字；先確認 LLM 好讀版本，再用可編輯的 prompt 生成報告並獨立稽核。`})]}),(0,Q.jsxs)(`div`,{className:`flowMap`,"aria-label":`處理流程`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`01`}),(0,Q.jsx)(`strong`,{children:`整理資料`}),(0,Q.jsx)(`small`,{children:`保留來源與限制`})]}),(0,Q.jsx)(`i`,{children:`→`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`02`}),(0,Q.jsx)(`strong`,{children:`生成報告`}),(0,Q.jsx)(`small`,{children:`自訂 system prompt`})]}),(0,Q.jsx)(`i`,{children:`→`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`03`}),(0,Q.jsx)(`strong`,{children:`品質稽核`}),(0,Q.jsx)(`small`,{children:`看見風險與修改建議`})]})]})]}),R&&(0,Q.jsxs)(`div`,{className:`errorBanner`,role:`alert`,ref:He,children:[(0,Q.jsx)(`strong`,{children:`目前無法繼續`}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`b`,{children:R.title}),(0,Q.jsx)(`i`,{children:R.advice}),R.raw&&(0,Q.jsxs)(`code`,{children:[`原始錯誤：`,R.raw]})]}),(0,Q.jsx)(`button`,{onClick:()=>z(null),"aria-label":`關閉錯誤訊息`,children:`×`})]}),Ne&&!R&&(0,Q.jsxs)(`div`,{className:`noticeBanner`,role:`status`,children:[(0,Q.jsx)(`span`,{children:Ne}),(0,Q.jsx)(`button`,{onClick:()=>B(``),"aria-label":`關閉提示`,children:`×`})]}),(0,Q.jsxs)(`section`,{className:`workspace`,children:[(0,Q.jsxs)(`article`,{className:`stepCard inputCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`01`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`INPUT`}),(0,Q.jsx)(`h2`,{children:`病人資料整理`}),(0,Q.jsx)(`span`,{children:`JSON 會在瀏覽器內轉成文字；TXT 與貼上的純文字會保留原文。`})]})]}),(0,Q.jsxs)(`div`,{className:`inputGrid`,children:[(0,Q.jsxs)(`div`,{className:`dropZone ${Pe?`dragging`:``}`,onDragOver:e=>{e.preventDefault(),Fe(!0)},onDragLeave:()=>Fe(!1),onDrop:bt,children:[(0,Q.jsx)(`input`,{ref:Le,type:`file`,accept:`.json,.txt,application/json,text/plain`,onChange:yt,hidden:!0}),(0,Q.jsxs)(`div`,{className:`fileGlyph`,children:[`JSON`,(0,Q.jsx)(`br`,{}),`TXT`]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`strong`,{children:s||`拖曳檔案到這裡`}),(0,Q.jsx)(`p`,{children:s?`${ct(e)}，可重新上傳替換`:`支援 .json、.txt，單檔上限 5 MB`})]}),(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>Le.current?.click(),children:`選擇檔案`})]}),(0,Q.jsxs)(`div`,{className:`editorShell inputEditor`,children:[(0,Q.jsxs)(`div`,{className:`editorToolbar`,children:[(0,Q.jsxs)(`div`,{className:`tabs`,role:`tablist`,"aria-label":`病人資料版本`,children:[(0,Q.jsx)(`button`,{className:m===`raw`?`active`:``,onClick:()=>h(`raw`),children:`原始輸入`}),(0,Q.jsx)(`button`,{className:m===`formatted`?`active`:``,onClick:()=>h(`formatted`),children:`LLM 好讀文字`})]}),(0,Q.jsx)(`span`,{children:ct(m===`raw`?e:n)})]}),(0,Q.jsx)(`textarea`,{"aria-label":m===`raw`?`原始病人資料`:`LLM好讀病人資料`,value:m===`raw`?e:n,onChange:e=>m===`raw`?t(e.target.value):a(e.target.value),placeholder:m===`raw`?`在此貼上 JSON 或純文字病人資料…`:`整理後的文字會顯示在這裡，您仍可手動修改。`,spellCheck:!1})]})]}),(0,Q.jsxs)(`div`,{className:`cardActions splitActions`,children:[(0,Q.jsxs)(`div`,{className:`inlineActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton`,onClick:xt,disabled:U,children:`整理為 LLM 好讀文字`}),(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>{t(ot),p(`示範資料.json`),h(`raw`),a(``),B(`已載入示範資料，請按「整理為 LLM 好讀文字」。`)},disabled:U,children:`載入去識別示範`})]}),(0,Q.jsxs)(`div`,{className:`inlineActions`,children:[n&&(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>void Ot(n,`資料`),children:V===`資料`?`已複製`:`複製整理文字`}),n&&(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>st(`病人資料_整理版_for_llm.txt`,n),children:`下載 TXT`}),(e||n)&&(0,Q.jsx)(`button`,{className:`dangerTextButton`,onClick:kt,children:`清除本頁資料`})]})]})]}),(0,Q.jsxs)(`article`,{className:`stepCard generatorCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`02`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`GENERATE`}),(0,Q.jsx)(`h2`,{children:`生成糖尿病衛教報告`}),(0,Q.jsx)(`span`,{children:`prompt 與模型都可修改；API 金鑰僅在執行時使用，不會寫入本站。`})]})]}),(0,Q.jsxs)(`div`,{className:`guidelinePanel`,children:[(0,Q.jsxs)(`div`,{className:`guidelinePanelCopy`,children:[(0,Q.jsx)(`span`,{className:`guidelineEyebrow`,children:`GUIDELINE A/B/C TEST`}),(0,Q.jsx)(`strong`,{children:`流程比較`}),(0,Q.jsx)(`p`,{children:qe.description})]}),(0,Q.jsxs)(`div`,{className:`guidelineControls`,children:[(0,Q.jsx)(`input`,{ref:Re,type:`file`,accept:`.txt,text/plain`,onChange:_t,hidden:!0}),(0,Q.jsx)(`select`,{className:`textInput guidelineSelect`,"aria-label":`選擇生成流程`,value:D,onChange:e=>Te(e.target.value),disabled:U,children:d.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id))}),(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>Re.current?.click(),disabled:U,children:w?`更換指引 TXT`:`載入指引 TXT`}),w&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>void Dt(),disabled:U,children:P===`counting`?`精算中…`:`用 countTokens 精算`}),(0,Q.jsx)(`button`,{className:`dangerTextButton`,onClick:()=>{xe(``),Ce(``),E(null),D===`B`&&Te(`A`)},disabled:U,children:`移除指引`})]})]}),(0,Q.jsxs)(`dl`,{className:`guidelineFacts`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引是否已載入`}),(0,Q.jsx)(`dd`,{className:w?`ok`:`missing`,children:w?`已載入：${Se}`:`尚未載入`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引字元數`}),(0,Q.jsx)(`dd`,{children:w?`${_(ce(w))} 字元`:`—`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引 token 數`}),(0,Q.jsx)(`dd`,{children:w?`${_(Z.tokens)} tokens（${Z.method===`measured`?`實測`:`估算`}）`:`—`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`本次生成會帶入指引`}),(0,Q.jsxs)(`dd`,{className:Y.guidelineIncluded?`ok`:`missing`,children:[Y.guidelineIncluded?`會帶入`:`不會帶入`,Y.guidelineRequestedButMissing&&`（已選 B 但指引是空的）`]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`本次稽核會帶入指引`}),(0,Q.jsx)(`dd`,{className:X.guidelineIncluded?`ok`:`missing`,children:X.guidelineIncluded?`會帶入`:`不會帶入`})]})]}),(0,Q.jsxs)(`p`,{className:`guidelinePrivacy`,children:[`指引只保留在本頁；選擇 B 並執行時才會隨請求送出，不寫入本站資料庫。整份指引會明顯增加輸入量、等待時間與費用。 本工具在任何情況下都不會自動截斷指引或病人資料。`,D===`C`&&` C 使用模組目錄 draft-0.1，尚未經醫療團隊核准，組出的報告只能用於流程比較。`]})]}),(0,Q.jsxs)(`div`,{className:`twoColumns`,children:[(0,Q.jsxs)(`div`,{className:`settingsPane`,children:[(0,Q.jsxs)(`div`,{className:`credentialBox`,children:[(0,Q.jsxs)(`div`,{className:`labelRow credentialLabelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:nt,children:`Gemini 臨時存取金鑰`}),(0,Q.jsx)(`span`,{children:`重新整理即清除`})]}),(0,Q.jsxs)(`div`,{className:`passwordRow`,children:[(0,Q.jsx)(`input`,{id:nt,name:`dmEducationGeminiTransientCredentialManualEntry`,className:`textInput apiKeyInput`,type:le?`text`:`password`,value:g,onChange:e=>oe(e.target.value),placeholder:`請手動貼上本次使用的 Gemini 金鑰`,autoComplete:`new-password`,autoCapitalize:`off`,autoCorrect:`off`,"data-1p-ignore":`true`,"data-lpignore":`true`,"data-bwignore":`true`,"data-form-type":`other`,spellCheck:!1}),(0,Q.jsx)(`button`,{type:`button`,className:`showKeyButton`,onClick:()=>ue(e=>!e),children:le?`隱藏`:`顯示`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`只暫存在本頁記憶體，不寫入資料庫或瀏覽器儲存空間。GitHub Pages 版會由瀏覽器直接傳給 Google Gemini；私人站版則透過本站伺服器。請只在可信任的網址輸入金鑰。`})]}),(0,Q.jsx)(`label`,{className:`fieldLabel modelLabel`,htmlFor:`model`,children:`Gemini 模型`}),(0,Q.jsx)(`select`,{id:`model`,className:`textInput selectInput`,value:v,onChange:e=>me(e.target.value),children:at.map(e=>(0,Q.jsx)(`option`,{value:e.value,children:e.label},e.value))}),v===tt&&(0,Q.jsx)(`input`,{className:`textInput customModelInput`,"aria-label":`自訂Gemini模型ID`,value:he,onChange:e=>ge(e.target.value),placeholder:`例如 gemini-flash-latest`,spellCheck:!1}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`生成與品質稽核目前使用同一個模型；選擇自訂時請輸入 Gemini API 支援的模型 ID。`}),(0,Q.jsx)(`label`,{className:`fieldLabel modelLabel`,htmlFor:`timeout`,children:`單次請求逾時上限（分鐘）`}),(0,Q.jsx)(`input`,{id:`timeout`,className:`textInput`,type:`number`,min:1,max:60,value:I,onChange:e=>L(Math.max(1,Math.min(60,Number(e.target.value)||rt)))}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`帶入指引全文時單次可能需要數分鐘。逾時會明確顯示為逾時，與你按「停止」區分。`}),(0,Q.jsx)(`label`,{className:`fieldLabel promptPresetLabel`,htmlFor:`generatorPromptPreset`,children:`生成規則版本`}),(0,Q.jsxs)(`select`,{id:`generatorPromptPreset`,className:`textInput selectInput`,value:y,onChange:e=>ft(e.target.value),disabled:D===`C`,children:[c.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,Q.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:D===`C`?`C 使用固定的模組選擇器 prompt，不使用這裡的生成 prompt。`:y===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:c.find(e=>e.id===y)?.description}),(0,Q.jsxs)(`div`,{className:`labelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`generatorPrompt`,children:`生成用 system prompt`}),(0,Q.jsx)(`button`,{className:`miniButton`,onClick:mt,children:y===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,Q.jsx)(`textarea`,{id:`generatorPrompt`,className:`promptEditor`,value:D===`C`?ze:S,onChange:e=>{ve(e.target.value),b(`custom`)},readOnly:D===`C`,spellCheck:!1}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`病人資料會自動接在 system prompt 後送出，不必複製到 prompt 內。`})]}),(0,Q.jsxs)(`div`,{className:`outputPane`,children:[(0,Q.jsxs)(`div`,{className:`outputHeader`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{className:`outputDot teal`}),(0,Q.jsx)(`strong`,{children:D===`C`?`組合後的病人版報告`:`Gemini 報告`})]}),(0,Q.jsx)(`span`,{children:O?ct(O):`等待生成`})]}),(0,Q.jsx)(`textarea`,{"aria-label":`Gemini產生的糖尿病衛教報告`,className:`outputEditor`,value:O,onChange:e=>{k(e.target.value),N(``)},placeholder:`產生的報告會顯示在這裡。您可以人工修改後，再送交 eval LLM 稽核。`,spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`outputActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(O,`報告`),disabled:!O,children:V===`報告`?`已複製`:`複製`}),(0,Q.jsx)(`button`,{onClick:()=>st(`糖尿病衛教報告.txt`,O),disabled:!O,children:`下載 TXT`})]}),Oe&&(0,Q.jsxs)(`details`,{className:`tracePanel`,open:!0,children:[(0,Q.jsx)(`summary`,{children:`醫師版報告（含 DCSI、R1–R7、PR1–PR7 代碼與分數，病人版不顯示）`}),(0,Q.jsx)(`pre`,{children:Oe}),(0,Q.jsxs)(`div`,{className:`traceActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(Oe,`醫師版`),children:V===`醫師版`?`已複製`:`複製醫師版`}),(0,Q.jsx)(`button`,{onClick:()=>st(`糖尿病衛教報告_醫師版.txt`,Oe),children:`下載醫師版 TXT`})]})]})]})]}),(0,Q.jsxs)(`div`,{className:`cardActionsColumn`,children:[(0,Q.jsx)(dt,{input:Y,title:`本次生成會送出的輸入`,note:D===`C`?`C 只送出精簡事實摘要，不送原始申報明細，也不送指引。`:void 0}),(0,Q.jsx)(ut,{blockers:Ye,label:`目前不能生成的原因`}),(0,Q.jsxs)(`div`,{className:`cardActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton`,onClick:()=>void Ct(),disabled:At,children:P===`generating`?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`spinner`}),`Gemini 生成中… `,je,` 秒`]}):`生成衛教報告`}),(0,Q.jsx)(`button`,{className:`secondaryButton runAll`,onClick:()=>void Et(),disabled:At,children:`生成並接續稽核`}),P===`generating`&&(0,Q.jsx)(`button`,{className:`stopButton`,onClick:Tt,children:`停止生成`})]})]})]}),(0,Q.jsxs)(`article`,{className:`stepCard evalCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`03`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`EVALUATE`}),(0,Q.jsx)(`h2`,{children:`獨立品質稽核`}),(0,Q.jsx)(`span`,{children:`eval LLM 同時看到整理後病人資料與待評估報告。`})]})]}),(0,Q.jsxs)(`div`,{className:`twoColumns`,children:[(0,Q.jsxs)(`div`,{className:`settingsPane`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPromptPreset`,children:`稽核規則版本`}),(0,Q.jsxs)(`select`,{id:`evalPromptPreset`,className:`textInput selectInput`,value:x,onChange:e=>pt(e.target.value),children:[l.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,Q.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:x===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:l.find(e=>e.id===x)?.description}),x===`colleague`&&!G&&(0,Q.jsxs)(`p`,{className:`promptWarning`,children:[`這個版本假設稽核模型已取得臨床指引；目前流程選的是 `,D,`，不會自動附上兩份 PDF，因此輸出的指引章節與引用仍需人工核對。`]}),(0,Q.jsxs)(`div`,{className:`labelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPrompt`,children:`eval LLM system prompt`}),(0,Q.jsx)(`button`,{className:`miniButton`,onClick:ht,children:x===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,Q.jsx)(`textarea`,{id:`evalPrompt`,className:`promptEditor evalPrompt`,value:C,onChange:e=>{ye(e.target.value),_e(`custom`)},spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`evalInputMap`,children:[(0,Q.jsx)(`span`,{children:`稽核輸入`}),(0,Q.jsx)(`strong`,{children:`病人資料`}),(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`報告`}),(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`評分規則`}),X.guidelineIncluded&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`指引全文`})]})]})]}),(0,Q.jsxs)(`div`,{className:`outputPane evalOutput`,children:[(0,Q.jsxs)(`div`,{className:`outputHeader`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{className:`outputDot amber`}),(0,Q.jsx)(`strong`,{children:`稽核結果`})]}),M?(0,Q.jsx)(`span`,{className:`verdict ${W.tone}`,children:W.label}):(0,Q.jsx)(`span`,{children:`等待稽核`})]}),(0,Q.jsx)(`textarea`,{"aria-label":`eval LLM稽核結果`,className:`outputEditor`,value:M,onChange:e=>N(e.target.value),placeholder:`這裡會列出稽核結論、分項評分、重大問題與具體修改建議。`,spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`outputActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(M,`稽核`),disabled:!M,children:V===`稽核`?`已複製`:`複製`}),(0,Q.jsx)(`button`,{onClick:()=>st(`衛教報告_稽核結果.txt`,M),disabled:!M,children:`下載 TXT`})]})]})]}),(0,Q.jsxs)(`div`,{className:`cardActionsColumn`,children:[(0,Q.jsx)(dt,{input:X,title:`本次稽核會送出的輸入`}),(0,Q.jsx)(ut,{blockers:Xe,label:`目前不能稽核的原因`}),(0,Q.jsxs)(`div`,{className:`cardActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton amberButton`,onClick:()=>void wt(),disabled:jt,children:P===`evaluating`?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`spinner`}),`品質稽核中… `,je,` 秒`]}):`執行品質稽核`}),P===`evaluating`&&(0,Q.jsx)(`button`,{className:`stopButton`,onClick:Tt,children:`停止稽核`})]})]})]})]}),(0,Q.jsxs)(`section`,{className:`safetyNote`,children:[(0,Q.jsx)(`div`,{className:`safetyIcon`,children:`i`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`strong`,{children:`上線前的必要提醒`}),(0,Q.jsx)(`p`,{children:`此工具是內容生成與稽核工作台，不是診斷系統。正式提供病人前，仍應由醫療團隊核准固定衛教內容、prompt、模型版本與發送規則，並建立人工抽查及版本紀錄。`})]})]}),(0,Q.jsxs)(`footer`,{children:[(0,Q.jsx)(`span`,{children:`糖尿病衛教報告工作台`}),(0,Q.jsx)(`span`,{children:`資料僅在本頁處理；按下生成或稽核時才送往 Gemini API。`}),(0,Q.jsx)(`span`,{className:`buildStamp`,children:`build ${u}`})]})]})}export{$ as default};