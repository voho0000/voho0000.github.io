...
`).trim()}async function O(e,t,n,r,i){if(typeof window<`u`&&window.location.hostname.endsWith(`github.io`)){if(!e.trim())throw Error(`GitHub Pages 版本需要在頁面輸入 Gemini API 金鑰。`);let a=await fetch(`https://generativelanguage.googleapis.com/v1/interactions`,{method:`POST`,signal:i,headers:{"Content-Type":`application/json`,"x-goog-api-key":e.trim()},body:JSON.stringify({model:t,input:r,system_instruction:n,store:!1})}),o=await a.json();if(!a.ok){let e=v(o.error)&&typeof o.error.message==`string`?o.error.message:`Gemini API 回傳 ${a.status}`;throw Error(e)}let s=D(o);if(!s)throw Error(`Gemini 已回應，但找不到文字輸出。`);return{text:s}}let a=await fetch(`/api/gemini`,{method:`POST`,signal:i,headers:{"Content-Type":`application/json`},body:JSON.stringify({apiKey:e,model:t,systemPrompt:n,input:r})}),o=await a.json();if(!a.ok||!o.text)throw Error(o.error||`Gemini 沒有回傳可用內容。`);return o}function k(e){return`${e.length.toLocaleString(`zh-TW`)} 字`}function re(e){let t=e.match(/"audit_status"\s*:\s*"(PASS|REVISE|FAIL)"/i)?.[1]?.toUpperCase(),n=e.match(/(?:^|\n)\s*(?:##\s*稽核結論\s*\n\s*)?(PASS|REVISE|NEEDS_REVIEW|FAIL)\b/im)?.[1]?.toUpperCase(),r=t||n;return r===`FAIL`?{label:`FAIL`,tone:`danger`}:r===`REVISE`?{label:`REVISE`,tone:`warning`}:r===`NEEDS_REVIEW`?{label:`需人工覆核`,tone:`warning`}:r===`PASS`?{label:`PASS`,tone:`success`}:{label:`已完成`,tone:`neutral`}}function A(){let[e,t]=(0,r.useState)(``),[n,a]=(0,r.useState)(``),[s,h]=(0,r.useState)(``),[g,_]=(0,r.useState)(`raw`),[v,y]=(0,r.useState)(``),[b,x]=(0,r.useState)(!1),[S,C]=(0,r.useState)(f),[w,T]=(0,r.useState)(``),[D,A]=(0,r.useState)(`workbench`),[j,M]=(0,r.useState)(`workbench`),[N,P]=(0,r.useState)(i),[F,I]=(0,r.useState)(o),[L,R]=(0,r.useState)(``),[z,B]=(0,r.useState)(``),[V,H]=(0,r.useState)(`idle`),[ie,U]=(0,r.useState)(0),[W,G]=(0,r.useState)(``),[ae,K]=(0,r.useState)(!1),[q,J]=(0,r.useState)(``),Y=(0,r.useRef)(null),X=(0,r.useRef)(null),Z=V!==`idle`,oe=(0,r.useMemo)(()=>re(z),[z]),Q=S===p?w.trim():S;(0,r.useEffect)(()=>{if(V!==`generating`&&V!==`evaluating`){U(0);return}let e=Date.now();U(0);let t=window.setInterval(()=>{U(Math.floor((Date.now()-e)/1e3))},250);return()=>window.clearInterval(t)},[V]);function se(e){if(A(e),e===`custom`)return;let t=c.find(t=>t.id===e);t&&P(t.prompt)}function ce(e){if(M(e),e===`custom`)return;let t=l.find(t=>t.id===e);t&&I(t.prompt)}function le(){se(D===`custom`?`workbench`:D)}function ue(){ce(j===`custom`?`workbench`:j)}async function de(e){if(G(``),e.size>d){G(`檔案超過 5 MB，請先縮小檔案再上傳。`);return}if(!e.name.toLowerCase().endsWith(`.json`)&&!e.name.toLowerCase().endsWith(`.txt`)){G(`目前支援 JSON 與 TXT 檔案。`);return}t(await e.text()),h(e.name),a(``),R(``),B(``),_(`raw`)}function fe(e){let t=e.target.files?.[0];t&&de(t),e.target.value=``}function pe(e){e.preventDefault(),K(!1);let t=e.dataTransfer.files?.[0];t&&de(t)}function me(){if(G(``),!e.trim()){G(`請先上傳檔案或貼上病人資料。`);return}H(`formatting`);try{let t=e.trim();t.startsWith(`{`)||t.startsWith(`[`)?a(ne(JSON.parse(t))):a(t),_(`formatted`),R(``),B(``)}catch{G(`這段內容看起來像 JSON，但格式無法解析。請檢查括號、逗號或引號；也可以改用 TXT 純文字輸入。`)}finally{H(`idle`)}}async function he(){if(G(``),!n.trim())return G(`請先完成『整理為 LLM 好讀文字』，並確認內容。`),``;if(!N.trim())return G(`生成用的 system prompt 不可為空白。`),``;if(!Q)return G(`請選擇 Gemini 模型，或輸入自訂模型 ID。`),``;H(`generating`);let e=new AbortController;X.current=e;try{let t=await O(v,Q,N,n,e.signal);return R(t.text||``),B(``),t.text||``}catch(e){return e instanceof Error&&e.name===`AbortError`||G(e instanceof Error?e.message:`生成報告時發生錯誤。`),``}finally{X.current===e&&(X.current=null),H(`idle`)}}async function ge(e){G(``);let t=e||L;if(!n.trim()||!t.trim()){G(`稽核前需要有 LLM 好讀病人資料與已生成的報告。`);return}if(!F.trim()){G(`稽核用的 system prompt 不可為空白。`);return}if(!Q){G(`請選擇 Gemini 模型，或輸入自訂模型 ID。`);return}H(`evaluating`);let r=new AbortController;X.current=r;try{B((await O(v,Q,F,`【病人資料】\n${n}\n\n【待評估報告】\n${t}`,r.signal)).text||``)}catch(e){e instanceof Error&&e.name===`AbortError`||G(e instanceof Error?e.message:`品質稽核時發生錯誤。`)}finally{X.current===r&&(X.current=null),H(`idle`)}}function _e(){X.current?.abort()}async function ve(){let e=await he();e&&await ge(e)}async function $(e,t){await navigator.clipboard.writeText(e),J(t),window.setTimeout(()=>J(``),1600)}function ye(){t(``),a(``),h(``),R(``),B(``),G(``),_(`raw`)}return(0,u.jsxs)(`main`,{children:[(0,u.jsxs)(`header`,{className:`topbar`,children:[(0,u.jsxs)(`a`,{className:`brand`,href:`#top`,"aria-label":`糖衛工作台首頁`,children:[(0,u.jsx)(`span`,{className:`brandMark`,children:`糖衛`}),(0,u.jsx)(`span`,{children:`報告工作台`})]}),(0,u.jsxs)(`div`,{className:`topMeta`,children:[(0,u.jsxs)(`span`,{className:`privacyPill`,children:[(0,u.jsx)(`span`,{className:`statusDot`}),`不寫入本站資料庫`]}),(0,u.jsx)(`span`,{className:`modelPill`,children:`金鑰僅暫存本頁`})]})]}),(0,u.jsxs)(`section`,{className:`hero`,id:`top`,children:[(0,u.jsxs)(`div`,{className:`heroCopy`,children:[(0,u.jsx)(`p`,{className:`eyebrow`,children:`DIABETES EDUCATION REPORT LAB`}),(0,u.jsx)(`h1`,{children:`從病人資料，到可讀的衛教報告與品質稽核。`}),(0,u.jsx)(`p`,{className:`heroLead`,children:`上傳 JSON、TXT 或直接貼上文字；先確認 LLM 好讀版本，再用可編輯的 prompt 生成報告並獨立稽核。`})]}),(0,u.jsxs)(`div`,{className:`flowMap`,"aria-label":`處理流程`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`span`,{children:`01`}),(0,u.jsx)(`strong`,{children:`整理資料`}),(0,u.jsx)(`small`,{children:`保留來源與限制`})]}),(0,u.jsx)(`i`,{children:`→`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`span`,{children:`02`}),(0,u.jsx)(`strong`,{children:`生成報告`}),(0,u.jsx)(`small`,{children:`自訂 system prompt`})]}),(0,u.jsx)(`i`,{children:`→`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`span`,{children:`03`}),(0,u.jsx)(`strong`,{children:`品質稽核`}),(0,u.jsx)(`small`,{children:`看見風險與修改建議`})]})]})]}),W&&(0,u.jsxs)(`div`,{className:`errorBanner`,role:`alert`,children:[(0,u.jsx)(`strong`,{children:`目前無法繼續`}),(0,u.jsx)(`span`,{children:W}),(0,u.jsx)(`button`,{onClick:()=>G(``),"aria-label":`關閉錯誤訊息`,children:`×`})]}),(0,u.jsxs)(`section`,{className:`workspace`,children:[(0,u.jsxs)(`article`,{className:`stepCard inputCard`,children:[(0,u.jsxs)(`div`,{className:`stepHeading`,children:[(0,u.jsx)(`div`,{className:`stepNumber`,children:`01`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{children:`INPUT`}),(0,u.jsx)(`h2`,{children:`病人資料整理`}),(0,u.jsx)(`span`,{children:`JSON 會在瀏覽器內轉成文字；TXT 與貼上的純文字會保留原文。`})]})]}),(0,u.jsxs)(`div`,{className:`inputGrid`,children:[(0,u.jsxs)(`div`,{className:`dropZone ${ae?`dragging`:``}`,onDragOver:e=>{e.preventDefault(),K(!0)},onDragLeave:()=>K(!1),onDrop:pe,children:[(0,u.jsx)(`input`,{ref:Y,type:`file`,accept:`.json,.txt,application/json,text/plain`,onChange:fe,hidden:!0}),(0,u.jsxs)(`div`,{className:`fileGlyph`,children:[`JSON`,(0,u.jsx)(`br`,{}),`TXT`]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`strong`,{children:s||`拖曳檔案到這裡`}),(0,u.jsx)(`p`,{children:s?`${k(e)}，可重新上傳替換`:`支援 .json、.txt，單檔上限 5 MB`})]}),(0,u.jsx)(`button`,{className:`secondaryButton`,onClick:()=>Y.current?.click(),children:`選擇檔案`})]}),(0,u.jsxs)(`div`,{className:`editorShell inputEditor`,children:[(0,u.jsxs)(`div`,{className:`editorToolbar`,children:[(0,u.jsxs)(`div`,{className:`tabs`,role:`tablist`,"aria-label":`病人資料版本`,children:[(0,u.jsx)(`button`,{className:g===`raw`?`active`:``,onClick:()=>_(`raw`),children:`原始輸入`}),(0,u.jsx)(`button`,{className:g===`formatted`?`active`:``,onClick:()=>_(`formatted`),children:`LLM 好讀文字`})]}),(0,u.jsx)(`span`,{children:k(g===`raw`?e:n)})]}),(0,u.jsx)(`textarea`,{"aria-label":g===`raw`?`原始病人資料`:`LLM好讀病人資料`,value:g===`raw`?e:n,onChange:e=>g===`raw`?t(e.target.value):a(e.target.value),placeholder:g===`raw`?`在此貼上 JSON 或純文字病人資料…`:`整理後的文字會顯示在這裡，您仍可手動修改。`,spellCheck:!1})]})]}),(0,u.jsxs)(`div`,{className:`cardActions splitActions`,children:[(0,u.jsxs)(`div`,{className:`inlineActions`,children:[(0,u.jsx)(`button`,{className:`primaryButton`,onClick:me,disabled:Z,children:V===`formatting`?`整理中…`:`整理為 LLM 好讀文字`}),(0,u.jsx)(`button`,{className:`textButton`,onClick:()=>{t(te),h(`示範資料.json`),_(`raw`),a(``)},disabled:Z,children:`載入去識別示範`})]}),(0,u.jsxs)(`div`,{className:`inlineActions`,children:[n&&(0,u.jsx)(`button`,{className:`textButton`,onClick:()=>void $(n,`資料`),children:q===`資料`?`已複製`:`複製整理文字`}),n&&(0,u.jsx)(`button`,{className:`textButton`,onClick:()=>E(`病人資料_整理版_for_llm.txt`,n),children:`下載 TXT`}),(e||n)&&(0,u.jsx)(`button`,{className:`dangerTextButton`,onClick:ye,children:`清除本頁資料`})]})]})]}),(0,u.jsxs)(`article`,{className:`stepCard generatorCard`,children:[(0,u.jsxs)(`div`,{className:`stepHeading`,children:[(0,u.jsx)(`div`,{className:`stepNumber`,children:`02`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{children:`GENERATE`}),(0,u.jsx)(`h2`,{children:`生成糖尿病衛教報告`}),(0,u.jsx)(`span`,{children:`prompt 與模型都可修改；API 金鑰僅在執行時使用，不會寫入本站。`})]})]}),(0,u.jsxs)(`div`,{className:`twoColumns`,children:[(0,u.jsxs)(`div`,{className:`settingsPane`,children:[(0,u.jsxs)(`div`,{className:`credentialBox`,children:[(0,u.jsxs)(`div`,{className:`labelRow credentialLabelRow`,children:[(0,u.jsx)(`label`,{className:`fieldLabel`,htmlFor:m,children:`Gemini 臨時存取金鑰`}),(0,u.jsx)(`span`,{children:`重新整理即清除`})]}),(0,u.jsxs)(`div`,{className:`passwordRow`,children:[(0,u.jsx)(`input`,{id:m,name:`dmEducationGeminiTransientCredentialManualEntry`,className:`textInput apiKeyInput`,type:b?`text`:`password`,value:v,onChange:e=>y(e.target.value),placeholder:`請手動貼上本次使用的 Gemini 金鑰`,autoComplete:`new-password`,autoCapitalize:`off`,autoCorrect:`off`,"data-1p-ignore":`true`,"data-lpignore":`true`,"data-bwignore":`true`,"data-form-type":`other`,spellCheck:!1}),(0,u.jsx)(`button`,{type:`button`,className:`showKeyButton`,onClick:()=>x(e=>!e),children:b?`隱藏`:`顯示`})]}),(0,u.jsx)(`p`,{className:`fieldNote`,children:`只暫存在本頁記憶體，不寫入資料庫或瀏覽器儲存空間。GitHub Pages 版會由瀏覽器直接傳給 Google Gemini；私人站版則透過本站伺服器。請只在可信任的網址輸入金鑰。`})]}),(0,u.jsx)(`label`,{className:`fieldLabel modelLabel`,htmlFor:`model`,children:`Gemini 模型`}),(0,u.jsx)(`select`,{id:`model`,className:`textInput selectInput`,value:S,onChange:e=>C(e.target.value),children:ee.map(e=>(0,u.jsx)(`option`,{value:e.value,children:e.label},e.value))}),S===p&&(0,u.jsx)(`input`,{className:`textInput customModelInput`,"aria-label":`自訂Gemini模型ID`,value:w,onChange:e=>T(e.target.value),placeholder:`例如 gemini-flash-latest`,spellCheck:!1}),(0,u.jsx)(`p`,{className:`fieldNote`,children:`生成與品質稽核目前使用同一個模型；選擇自訂時請輸入 Gemini API 支援的模型 ID。`}),(0,u.jsx)(`label`,{className:`fieldLabel promptPresetLabel`,htmlFor:`generatorPromptPreset`,children:`生成規則版本`}),(0,u.jsxs)(`select`,{id:`generatorPromptPreset`,className:`textInput selectInput`,value:D,onChange:e=>se(e.target.value),children:[c.map(e=>(0,u.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,u.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,u.jsx)(`p`,{className:`fieldNote`,children:D===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:c.find(e=>e.id===D)?.description}),(0,u.jsxs)(`div`,{className:`labelRow`,children:[(0,u.jsx)(`label`,{className:`fieldLabel`,htmlFor:`generatorPrompt`,children:`生成用 system prompt`}),(0,u.jsx)(`button`,{className:`miniButton`,onClick:le,children:D===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,u.jsx)(`textarea`,{id:`generatorPrompt`,className:`promptEditor`,value:N,onChange:e=>{P(e.target.value),A(`custom`)},spellCheck:!1}),(0,u.jsx)(`p`,{className:`fieldNote`,children:`病人資料會自動接在 system prompt 後送出，不必複製到 prompt 內。`})]}),(0,u.jsxs)(`div`,{className:`outputPane`,children:[(0,u.jsxs)(`div`,{className:`outputHeader`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`span`,{className:`outputDot teal`}),(0,u.jsx)(`strong`,{children:`Gemini 報告`})]}),(0,u.jsx)(`span`,{children:L?k(L):`等待生成`})]}),(0,u.jsx)(`textarea`,{"aria-label":`Gemini產生的糖尿病衛教報告`,className:`outputEditor`,value:L,onChange:e=>{R(e.target.value),B(``)},placeholder:`產生的報告會顯示在這裡。您可以人工修改後，再送交 eval LLM 稽核。`,spellCheck:!1}),(0,u.jsxs)(`div`,{className:`outputActions`,children:[(0,u.jsx)(`button`,{onClick:()=>void $(L,`報告`),disabled:!L,children:q===`報告`?`已複製`:`複製`}),(0,u.jsx)(`button`,{onClick:()=>E(`糖尿病衛教報告.txt`,L),disabled:!L,children:`下載 TXT`})]})]})]}),(0,u.jsxs)(`div`,{className:`cardActions`,children:[(0,u.jsx)(`button`,{className:`primaryButton`,onClick:()=>void he(),disabled:Z||!n,children:V===`generating`?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`spinner`}),`Gemini 生成中… `,ie,` 秒`]}):`生成衛教報告`}),(0,u.jsx)(`button`,{className:`secondaryButton runAll`,onClick:()=>void ve(),disabled:Z||!n,children:`生成並接續稽核`}),V===`generating`&&(0,u.jsx)(`button`,{className:`stopButton`,onClick:_e,children:`停止生成`})]})]}),(0,u.jsxs)(`article`,{className:`stepCard evalCard`,children:[(0,u.jsxs)(`div`,{className:`stepHeading`,children:[(0,u.jsx)(`div`,{className:`stepNumber`,children:`03`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{children:`EVALUATE`}),(0,u.jsx)(`h2`,{children:`獨立品質稽核`}),(0,u.jsx)(`span`,{children:`eval LLM 同時看到整理後病人資料與待評估報告。`})]})]}),(0,u.jsxs)(`div`,{className:`twoColumns`,children:[(0,u.jsxs)(`div`,{className:`settingsPane`,children:[(0,u.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPromptPreset`,children:`稽核規則版本`}),(0,u.jsxs)(`select`,{id:`evalPromptPreset`,className:`textInput selectInput`,value:j,onChange:e=>ce(e.target.value),children:[l.map(e=>(0,u.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,u.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,u.jsx)(`p`,{className:`fieldNote`,children:j===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:l.find(e=>e.id===j)?.description}),j===`colleague`&&(0,u.jsx)(`p`,{className:`promptWarning`,children:`這個版本假設稽核模型已取得臨床指引；目前工作台不會自動附上兩份 PDF，因此輸出的指引章節與引用仍需人工核對。`}),(0,u.jsxs)(`div`,{className:`labelRow`,children:[(0,u.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPrompt`,children:`eval LLM system prompt`}),(0,u.jsx)(`button`,{className:`miniButton`,onClick:ue,children:j===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,u.jsx)(`textarea`,{id:`evalPrompt`,className:`promptEditor evalPrompt`,value:F,onChange:e=>{I(e.target.value),M(`custom`)},spellCheck:!1}),(0,u.jsxs)(`div`,{className:`evalInputMap`,children:[(0,u.jsx)(`span`,{children:`稽核輸入`}),(0,u.jsx)(`strong`,{children:`病人資料`}),(0,u.jsx)(`i`,{children:`＋`}),(0,u.jsx)(`strong`,{children:`報告`}),(0,u.jsx)(`i`,{children:`＋`}),(0,u.jsx)(`strong`,{children:`評分規則`})]})]}),(0,u.jsxs)(`div`,{className:`outputPane evalOutput`,children:[(0,u.jsxs)(`div`,{className:`outputHeader`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`span`,{className:`outputDot amber`}),(0,u.jsx)(`strong`,{children:`稽核結果`})]}),z?(0,u.jsx)(`span`,{className:`verdict ${oe.tone}`,children:oe.label}):(0,u.jsx)(`span`,{children:`等待稽核`})]}),(0,u.jsx)(`textarea`,{"aria-label":`eval LLM稽核結果`,className:`outputEditor`,value:z,onChange:e=>B(e.target.value),placeholder:`這裡會列出稽核結論、分項評分、重大問題與具體修改建議。`,spellCheck:!1}),(0,u.jsxs)(`div`,{className:`outputActions`,children:[(0,u.jsx)(`button`,{onClick:()=>void $(z,`稽核`),disabled:!z,children:q===`稽核`?`已複製`:`複製`}),(0,u.jsx)(`button`,{onClick:()=>E(`衛教報告_稽核結果.txt`,z),disabled:!z,children:`下載 TXT`})]})]})]}),(0,u.jsxs)(`div`,{className:`cardActions`,children:[(0,u.jsx)(`button`,{className:`primaryButton amberButton`,onClick:()=>void ge(),disabled:Z||!n||!L,children:V===`evaluating`?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`spinner`}),`品質稽核中… `,ie,` 秒`]}):`執行品質稽核`}),V===`evaluating`&&(0,u.jsx)(`button`,{className:`stopButton`,onClick:_e,children:`停止稽核`})]})]})]}),(0,u.jsxs)(`section`,{className:`safetyNote`,children:[(0,u.jsx)(`div`,{className:`safetyIcon`,children:`i`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`strong`,{children:`上線前的必要提醒`}),(0,u.jsx)(`p`,{children:`此工具是內容生成與稽核工作台，不是診斷系統。正式提供病人前，仍應由醫療團隊核准固定衛教內容、prompt、模型版本與發送規則，並建立人工抽查及版本紀錄。`})]})]}),(0,u.jsxs)(`footer`,{children:[(0,u.jsx)(`span`,{children:`糖尿病衛教報告工作台`}),(0,u.jsx)(`span`,{children:`資料僅在本頁處理；按下生成或稽核時才送往 Gemini API。`})]})]})}export{A as default};