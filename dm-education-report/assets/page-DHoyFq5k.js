...
`).trim()}function D(e){if(!e)return``;let t=e.error;return T(t)&&typeof t.message==`string`?t.message:typeof e.error==`string`?e.error:``}function De(e,t){let n=new AbortController,r=setTimeout(()=>n.abort(new DOMException(`timeout`,`TimeoutError`)),t);return{signal:AbortSignal.any([e,n.signal]),timedOut:()=>n.signal.aborted,cleanup:()=>clearTimeout(r)}}var O=class extends Error{constructor(e){super(e.title),this.name=`GeminiRequestError`,this.failure=e}};async function Oe(e){let{apiKey:t,model:n,systemPrompt:r,input:i,signal:a,direct:o,simulate:s}=e,c=De(a,e.timeoutMs??9e5),l=Date.now();try{if(o&&!t.trim())throw new O(w({status:null,apiMessage:`這個版本需要在頁面輸入 Gemini API 金鑰。`}));let e=await E(o?await fetch(Te,{method:`POST`,signal:c.signal,headers:{"Content-Type":`application/json`,"x-goog-api-key":t.trim()},body:JSON.stringify({model:n,input:i,system_instruction:r,store:!1})}):await fetch(`/api/gemini`,{method:`POST`,signal:c.signal,headers:{"Content-Type":`application/json`},body:JSON.stringify({apiKey:t,model:n,systemPrompt:r,input:i})}));if(!e.ok)throw new O(w({status:e.status,statusText:e.statusText,apiMessage:D(e.json),rawBody:e.json?``:e.rawBody}));if(!e.json)throw new O(w({status:e.status,statusText:e.statusText,rawBody:e.rawBody}));let a=o?Ee(e.json):String(e.json.text??``);if(!a.trim())throw new O(w({status:e.status,apiMessage:D(e.json)||`Gemini 已回應，但回應中找不到文字輸出。`,rawBody:e.json?``:e.rawBody}));return{text:a,usage:T(e.json.usage)?e.json.usage:T(e.json.usage_metadata)?e.json.usage_metadata:null,elapsedMs:Date.now()-l}}catch(e){throw e instanceof O?e:new O(w({cause:e,timedOut:c.timedOut()}))}finally{c.cleanup()}}async function ke(e){let{apiKey:t,model:n,text:r,direct:i,signal:a}=e,o=i?`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(n)}:countTokens`:`/api/gemini/count-tokens`,s=await E(i?await fetch(o,{method:`POST`,signal:a,headers:{"Content-Type":`application/json`,"x-goog-api-key":t.trim()},body:JSON.stringify({contents:[{parts:[{text:r}]}]})}):await fetch(o,{method:`POST`,signal:a,headers:{"Content-Type":`application/json`},body:JSON.stringify({apiKey:t,model:n,text:r})}));if(!s.ok||!s.json)throw new O(w({status:s.status,statusText:s.statusText,apiMessage:D(s.json),rawBody:s.json?``:s.rawBody}));let c=s.json.totalTokens??s.json.total_tokens??s.json.tokens,l=Number(c);if(!Number.isFinite(l))throw new O(w({status:s.status,apiMessage:`countTokens 回應中沒有 totalTokens。`}));return l}var Ae=`draft-0.1`,k=[{id:`BASE-01`,topic:`BASE`,title:`資料時效與使用範圍`,appliesWhen:`每份報告固定顯示，由程式自動加入，LLM 不需選取。`,typeGate:`any`,autoOnly:!0,patientText:`關於這份報告
...
}`;function st(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,i.click(),URL.revokeObjectURL(r)}function ct(e){return`${_(ce(e))} 字`}function lt(e){let t=e.match(/"audit_status"\s*:\s*"(PASS|REVISE|FAIL)"/i)?.[1]?.toUpperCase(),n=e.match(/(?:^|\n)\s*(?:##\s*稽核結論\s*\n\s*)?(PASS|REVISE|NEEDS_REVIEW|FAIL)\b/im)?.[1]?.toUpperCase(),r=t||n;return r===`FAIL`?{label:`FAIL`,tone:`danger`}:r===`REVISE`?{label:`REVISE`,tone:`warning`}:r===`NEEDS_REVIEW`?{label:`需人工覆核`,tone:`warning`}:r===`PASS`?{label:`PASS`,tone:`success`}:{label:`已完成`,tone:`neutral`}}function ut({blockers:e,label:t}){return e.length?(0,Q.jsxs)(`div`,{className:`blockerList`,role:`status`,children:[(0,Q.jsx)(`strong`,{children:t}),(0,Q.jsx)(`ul`,{children:e.map(e=>(0,Q.jsxs)(`li`,{className:e.hard?`hard`:`soft`,children:[(0,Q.jsx)(`span`,{className:`blockerMessage`,children:e.message}),(0,Q.jsx)(`span`,{className:`blockerFix`,children:e.howToFix})]},e.code))})]}):null}function dt({input:e,title:t,note:n}){let r=e.totalTokens>ae,i=Math.min(999,Math.round(e.totalTokens/ae*100));return(0,Q.jsxs)(`details`,{className:`compositionPanel`,children:[(0,Q.jsxs)(`summary`,{children:[t,`：約 `,_(e.totalTokens),` tokens（`,_(e.totalChars),` 字）`,(0,Q.jsxs)(`span`,{className:r?`limitBadge over`:`limitBadge`,children:[`模型上限的 `,i,`%`]})]}),(0,Q.jsx)(`table`,{children:(0,Q.jsxs)(`tbody`,{children:[e.parts.map(e=>(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`th`,{children:e.label}),(0,Q.jsxs)(`td`,{children:[_(e.chars),` 字`]}),(0,Q.jsxs)(`td`,{children:[`約 `,_(e.tokens),` tokens`,(0,Q.jsx)(`em`,{children:e.method===`measured`?`實測`:`估算`})]})]},e.label)),(0,Q.jsxs)(`tr`,{className:`totalRow`,children:[(0,Q.jsx)(`th`,{children:`合計`}),(0,Q.jsxs)(`td`,{children:[_(e.totalChars),` 字`]}),(0,Q.jsxs)(`td`,{children:[`約 `,_(e.totalTokens),` tokens`]})]})]})}),(0,Q.jsxs)(`p`,{children:[n?`${n} `:``,e.hasEstimate?`標示「估算」的段落是以字元組成推估，誤差在指引全文上約 0.1%，其他文字可能更大；需要精確值請按「用 countTokens 精算」。`:`所有段落都是 Gemini 官方實測值。`]})]})}function $(){let[e,t]=(0,r.useState)(``),[n,a]=(0,r.useState)(``),[s,p]=(0,r.useState)(``),[m,h]=(0,r.useState)(`raw`),[g,oe]=(0,r.useState)(``),[le,ue]=(0,r.useState)(!1),[de,he]=(0,r.useState)(et),[ge,_e]=(0,r.useState)(``),[v,y]=(0,r.useState)(`workbench`),[b,ve]=(0,r.useState)(`workbench`),[x,ye]=(0,r.useState)(i),[S,be]=(0,r.useState)(o),[C,Se]=(0,r.useState)(``),[Ce,we]=(0,r.useState)(``),[Te,T]=(0,r.useState)(null),[E,Ee]=(0,r.useState)(`A`),[D,De]=(0,r.useState)(``),[Ae,k]=(0,r.useState)(``),[A,j]=(0,r.useState)(``),[M,N]=(0,r.useState)(`idle`),[je,Me]=(0,r.useState)(null),[Ne,Pe]=(0,r.useState)(0),[P,F]=(0,r.useState)(rt),[I,L]=(0,r.useState)(null),[Fe,R]=(0,r.useState)(``),[z,B]=(0,r.useState)(!1),[V,Ie]=(0,r.useState)(``),Le=(0,r.useRef)(null),Re=(0,r.useRef)(null),H=(0,r.useRef)(null),He=(0,r.useRef)(null),U=M!==`idle`,W=(0,r.useMemo)(()=>lt(A),[A]),Ke=de===tt?ge.trim():de,qe=f(E),G=E===`B`,K=typeof window<`u`&&window.location.hostname.endsWith(`github.io`),q=(0,r.useMemo)(()=>{let t=e.trim();if(!t.startsWith(`{`)&&!t.startsWith(`[`))return null;try{return JSON.parse(t)}catch{return null}},[e]),J=(0,r.useMemo)(()=>q?Ze(q):null,[q]),Y=(0,r.useMemo)(()=>E===`C`?me({systemPrompt:ze,factsText:J?`${Qe(J)}\n\n${Ge(Ve(null,J))}`:``}):fe({systemPrompt:x,patientText:n,includeGuideline:G,guidelineText:C}),[E,J,x,n,G,C]),X=(0,r.useMemo)(()=>pe({systemPrompt:S,patientText:n,report:D,includeGuideline:G,guidelineText:C}),[S,n,D,G,C]),Je={arm:E,llmText:n,rawInput:e,generatorPrompt:x,evalPrompt:S,report:D,model:Ke,apiKey:g,requiresClientKey:K,guidelineText:C,tokenLimit:ae},Ye=(0,r.useMemo)(()=>{let e=ee({...Je,totalTokens:Y.totalTokens});return E===`C`&&!q&&e.push({code:`arm-c-needs-json`,message:`C（模組選擇流程）需要原始 JSON 病人資料才能做確定性事實抽取。`,howToFix:`請在步驟 01 上傳或貼上原始 JSON。純文字輸入無法使用 C。`,hard:!0}),e},[E,n,e,x,Ke,g,K,C,Y.totalTokens,q]),Xe=(0,r.useMemo)(()=>te({...Je,totalTokens:X.totalTokens}),[E,n,S,D,Ke,g,K,C,X.totalTokens]),Z=(0,r.useMemo)(()=>Te===null?se(C):{tokens:Te,method:`measured`},[C,Te]);(0,r.useEffect)(()=>{if(je===null)return;let e=window.setInterval(()=>{Pe(Math.floor((Date.now()-je)/1e3))},250);return()=>window.clearInterval(e)},[je]),(0,r.useEffect)(()=>{I&&He.current&&He.current.scrollIntoView({block:`nearest`,behavior:`smooth`})},[I]);function $(e,t){L({title:e,advice:t,raw:``,status:null,aborted:!1,timedOut:!1})}function ft(e){if(y(e),e===`custom`)return;let t=c.find(t=>t.id===e);t&&ye(t.prompt)}function pt(e){if(ve(e),e===`custom`)return;let t=l.find(t=>t.id===e);t&&be(t.prompt)}function mt(){ft(v===`custom`?`workbench`:v)}function ht(){pt(b===`custom`?`workbench`:b)}async function gt(e){if(L(null),e.size>$e){$(`指引 TXT 超過 5 MB`,`請確認是否選到正確的檔案；本工具不會自動截斷指引。`);return}if(!e.name.toLowerCase().endsWith(`.txt`)){$(`指引目前只支援 TXT`,`請先把 PDF 轉成純文字 TXT 再載入。`);return}let t=await e.text();if(!t.trim()){$(`指引 TXT 沒有可用文字`,`檔案讀起來是空的，請確認轉檔結果。`);return}Se(t),we(e.name),T(null);let n=ce(t);R(n===652078?`已載入指引：${_(n)} 字元，與已知全文完全相同，token 數採用官方實測值 ${_(ie)}。`:`已載入指引：${_(n)} 字元。與已知全文（${_(re)} 字元）不同，token 數為估算值。`)}function _t(e){let t=e.target.files?.[0];t&&gt(t),e.target.value=``}async function vt(e){if(L(null),e.size>$e){$(`檔案超過 5 MB`,`請先縮小檔案再上傳。`);return}let n=e.name.toLowerCase();if(!n.endsWith(`.json`)&&!n.endsWith(`.txt`)){$(`目前只支援 JSON 與 TXT`,`請改用 .json 或 .txt 檔案。`);return}let r=await e.text();if(ce(r)>it&&r.includes(`糖尿病臨床照護指引`)){$(`這個檔案看起來是指引全文，不是病人資料`,`已經略過，沒有覆蓋你目前的病人資料。指引請用下方「載入指引 TXT」按鈕載入。`);return}t(r),p(e.name),a(``),De(``),k(``),j(``),h(`raw`),R(`已載入新的病人資料，請重新按「整理為 LLM 好讀文字」。`)}function yt(e){let t=e.target.files?.[0];t&&vt(t),e.target.value=``}function bt(e){e.preventDefault(),B(!1);let t=e.dataTransfer.files?.[0];t&&vt(t)}function xt(){if(L(null),R(``),!e.trim()){$(`還沒有病人資料`,`請先上傳檔案、貼上文字，或按「載入去識別示範」。`);return}N(`formatting`);try{let t=e.trim();t.startsWith(`{`)||t.startsWith(`[`)?a(xe(JSON.parse(t))):a(t),h(`formatted`),De(``),k(``),j(``)}catch{$(`這段內容看起來像 JSON，但格式無法解析`,`請檢查括號、逗號或引號是否成對；也可以改用 TXT 純文字輸入。`)}finally{N(`idle`)}}async function St(e,t,n){return Oe({apiKey:g,model:Ke,systemPrompt:e,input:t,signal:n,direct:K,timeoutMs:P*60*1e3,simulate:void 0})}async function Ct(){if(L(null),R(``),ne(Ye)){let e=Ye.find(e=>e.hard);return e&&$(e.message,e.howToFix),``}N(`generating`),Me(Date.now()),Pe(0);let e=new AbortController;H.current=e;try{if(E===`C`){if(!J)throw Error(`缺少可用的 JSON 病人資料。`);let t={reportDate:J.reportDate.known?J.reportDate.value:null,dataCutoff:J.dataCutoff.known?J.dataCutoff.value:null},n=Ve(Be((await St(ze,Y.text,e.signal)).text),J),r=Ue(n,t);De(r),k(We(n,J,t)),j(``);let i=n.decisions.filter(e=>e.kind!==`excluded`&&e.kind!==`prevention-moderate`).length;return R(`完成：程式依 R／PR 納入 ${i} 個併發症主題、${n.moderateTopics.length} 個簡短提醒、${n.selfCareModuleIds.length} 個自我照護模組。病人可見正文完全來自固定文字；LLM 只提供優先排序與提醒${n.selection?.disagreements.length?`，並對程式判定提出 ${n.selection.disagreements.length} 點不同意見（已記錄未採用）`:``}。`),r}let t=await St(x,Y.text,e.signal);return De(t.text),k(``),j(``),t.text}catch(e){return e instanceof O?e.failure.aborted||L(e.failure):L(w({cause:e})),``}finally{H.current===e&&(H.current=null),Me(null),N(`idle`)}}async function wt(e){L(null);let t=e||D,r=te({...Je,report:t,totalTokens:X.totalTokens});if(ne(r)){let e=r.find(e=>e.hard);e&&$(e.message,e.howToFix);return}N(`evaluating`),Me(Date.now()),Pe(0);let i=new AbortController;H.current=i;try{j((await St(S,pe({systemPrompt:S,patientText:n,report:t,includeGuideline:G,guidelineText:C}).text,i.signal)).text)}catch(e){e instanceof O?e.failure.aborted||L(e.failure):L(w({cause:e}))}finally{H.current===i&&(H.current=null),Me(null),N(`idle`)}}function Tt(){H.current?.abort()}async function Et(){let e=await Ct();e&&await wt(e)}async function Dt(){if(L(null),!C.trim()){$(`還沒載入指引`,`請先按「載入指引 TXT」。`);return}if(K&&!g.trim()){$(`精算需要 Gemini 金鑰`,`請先在上方輸入金鑰；countTokens 不會產生生成費用。`);return}N(`counting`);let e=new AbortController;H.current=e;try{let t=await ke({apiKey:g,model:Ke,text:C,direct:K,signal:e.signal});T(t),R(`countTokens 實測：指引全文為 ${_(t)} tokens。`)}catch(e){e instanceof O?e.failure.aborted||L(e.failure):L(w({cause:e}))}finally{H.current===e&&(H.current=null),Me(null),N(`idle`)}}async function Ot(e,t){await navigator.clipboard.writeText(e),Ie(t),window.setTimeout(()=>Ie(``),1600)}function kt(){t(``),a(``),p(``),De(``),k(``),j(``),L(null),R(``),h(`raw`)}let At=U||ne(Ye),jt=U||ne(Xe);return(0,Q.jsxs)(`main`,{children:[(0,Q.jsxs)(`header`,{className:`topbar`,children:[(0,Q.jsxs)(`a`,{className:`brand`,href:`#top`,"aria-label":`糖衛工作台首頁`,children:[(0,Q.jsx)(`span`,{className:`brandMark`,children:`糖衛`}),(0,Q.jsx)(`span`,{children:`報告工作台`})]}),(0,Q.jsxs)(`div`,{className:`topMeta`,children:[(0,Q.jsxs)(`span`,{className:`privacyPill`,children:[(0,Q.jsx)(`span`,{className:`statusDot`}),`不寫入本站資料庫`]}),(0,Q.jsx)(`span`,{className:`modelPill`,children:`金鑰僅暫存本頁`})]})]}),(0,Q.jsxs)(`section`,{className:`hero`,id:`top`,children:[(0,Q.jsxs)(`div`,{className:`heroCopy`,children:[(0,Q.jsx)(`p`,{className:`eyebrow`,children:`DIABETES EDUCATION REPORT LAB`}),(0,Q.jsx)(`h1`,{children:`從病人資料，到可讀的衛教報告與品質稽核。`}),(0,Q.jsx)(`p`,{className:`heroLead`,children:`上傳 JSON、TXT 或直接貼上文字；先確認 LLM 好讀版本，再用可編輯的 prompt 生成報告並獨立稽核。`})]}),(0,Q.jsxs)(`div`,{className:`flowMap`,"aria-label":`處理流程`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`01`}),(0,Q.jsx)(`strong`,{children:`整理資料`}),(0,Q.jsx)(`small`,{children:`保留來源與限制`})]}),(0,Q.jsx)(`i`,{children:`→`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`02`}),(0,Q.jsx)(`strong`,{children:`生成報告`}),(0,Q.jsx)(`small`,{children:`自訂 system prompt`})]}),(0,Q.jsx)(`i`,{children:`→`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{children:`03`}),(0,Q.jsx)(`strong`,{children:`品質稽核`}),(0,Q.jsx)(`small`,{children:`看見風險與修改建議`})]})]})]}),I&&(0,Q.jsxs)(`div`,{className:`errorBanner`,role:`alert`,ref:He,children:[(0,Q.jsx)(`strong`,{children:`目前無法繼續`}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`b`,{children:I.title}),(0,Q.jsx)(`i`,{children:I.advice}),I.raw&&(0,Q.jsxs)(`code`,{children:[`原始錯誤：`,I.raw]})]}),(0,Q.jsx)(`button`,{onClick:()=>L(null),"aria-label":`關閉錯誤訊息`,children:`×`})]}),Fe&&!I&&(0,Q.jsxs)(`div`,{className:`noticeBanner`,role:`status`,children:[(0,Q.jsx)(`span`,{children:Fe}),(0,Q.jsx)(`button`,{onClick:()=>R(``),"aria-label":`關閉提示`,children:`×`})]}),(0,Q.jsxs)(`section`,{className:`workspace`,children:[(0,Q.jsxs)(`article`,{className:`stepCard inputCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`01`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`INPUT`}),(0,Q.jsx)(`h2`,{children:`病人資料整理`}),(0,Q.jsx)(`span`,{children:`JSON 會在瀏覽器內轉成文字；TXT 與貼上的純文字會保留原文。`})]})]}),(0,Q.jsxs)(`div`,{className:`inputGrid`,children:[(0,Q.jsxs)(`div`,{className:`dropZone ${z?`dragging`:``}`,onDragOver:e=>{e.preventDefault(),B(!0)},onDragLeave:()=>B(!1),onDrop:bt,children:[(0,Q.jsx)(`input`,{ref:Le,type:`file`,accept:`.json,.txt,application/json,text/plain`,onChange:yt,hidden:!0}),(0,Q.jsxs)(`div`,{className:`fileGlyph`,children:[`JSON`,(0,Q.jsx)(`br`,{}),`TXT`]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`strong`,{children:s||`拖曳檔案到這裡`}),(0,Q.jsx)(`p`,{children:s?`${ct(e)}，可重新上傳替換`:`支援 .json、.txt，單檔上限 5 MB`})]}),(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>Le.current?.click(),children:`選擇檔案`})]}),(0,Q.jsxs)(`div`,{className:`editorShell inputEditor`,children:[(0,Q.jsxs)(`div`,{className:`editorToolbar`,children:[(0,Q.jsxs)(`div`,{className:`tabs`,role:`tablist`,"aria-label":`病人資料版本`,children:[(0,Q.jsx)(`button`,{className:m===`raw`?`active`:``,onClick:()=>h(`raw`),children:`原始輸入`}),(0,Q.jsx)(`button`,{className:m===`formatted`?`active`:``,onClick:()=>h(`formatted`),children:`LLM 好讀文字`})]}),(0,Q.jsx)(`span`,{children:ct(m===`raw`?e:n)})]}),(0,Q.jsx)(`textarea`,{"aria-label":m===`raw`?`原始病人資料`:`LLM好讀病人資料`,value:m===`raw`?e:n,onChange:e=>m===`raw`?t(e.target.value):a(e.target.value),placeholder:m===`raw`?`在此貼上 JSON 或純文字病人資料…`:`整理後的文字會顯示在這裡，您仍可手動修改。`,spellCheck:!1})]})]}),(0,Q.jsxs)(`div`,{className:`cardActions splitActions`,children:[(0,Q.jsxs)(`div`,{className:`inlineActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton`,onClick:xt,disabled:U,children:`整理為 LLM 好讀文字`}),(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>{t(ot),p(`示範資料.json`),h(`raw`),a(``),R(`已載入示範資料，請按「整理為 LLM 好讀文字」。`)},disabled:U,children:`載入去識別示範`})]}),(0,Q.jsxs)(`div`,{className:`inlineActions`,children:[n&&(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>void Ot(n,`資料`),children:V===`資料`?`已複製`:`複製整理文字`}),n&&(0,Q.jsx)(`button`,{className:`textButton`,onClick:()=>st(`病人資料_整理版_for_llm.txt`,n),children:`下載 TXT`}),(e||n)&&(0,Q.jsx)(`button`,{className:`dangerTextButton`,onClick:kt,children:`清除本頁資料`})]})]})]}),(0,Q.jsxs)(`article`,{className:`stepCard generatorCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`02`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`GENERATE`}),(0,Q.jsx)(`h2`,{children:`生成糖尿病衛教報告`}),(0,Q.jsx)(`span`,{children:`prompt 與模型都可修改；API 金鑰僅在執行時使用，不會寫入本站。`})]})]}),(0,Q.jsxs)(`div`,{className:`guidelinePanel`,children:[(0,Q.jsxs)(`div`,{className:`guidelinePanelCopy`,children:[(0,Q.jsx)(`span`,{className:`guidelineEyebrow`,children:`GUIDELINE A/B/C TEST`}),(0,Q.jsx)(`strong`,{children:`流程比較`}),(0,Q.jsx)(`p`,{children:qe.description})]}),(0,Q.jsxs)(`div`,{className:`guidelineControls`,children:[(0,Q.jsx)(`input`,{ref:Re,type:`file`,accept:`.txt,text/plain`,onChange:_t,hidden:!0}),(0,Q.jsx)(`select`,{className:`textInput guidelineSelect`,"aria-label":`選擇生成流程`,value:E,onChange:e=>Ee(e.target.value),disabled:U,children:d.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id))}),(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>Re.current?.click(),disabled:U,children:C?`更換指引 TXT`:`載入指引 TXT`}),C&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`button`,{className:`secondaryButton`,onClick:()=>void Dt(),disabled:U,children:M===`counting`?`精算中…`:`用 countTokens 精算`}),(0,Q.jsx)(`button`,{className:`dangerTextButton`,onClick:()=>{Se(``),we(``),T(null),E===`B`&&Ee(`A`)},disabled:U,children:`移除指引`})]})]}),(0,Q.jsxs)(`dl`,{className:`guidelineFacts`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引是否已載入`}),(0,Q.jsx)(`dd`,{className:C?`ok`:`missing`,children:C?`已載入：${Ce}`:`尚未載入`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引字元數`}),(0,Q.jsx)(`dd`,{children:C?`${_(ce(C))} 字元`:`—`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`指引 token 數`}),(0,Q.jsx)(`dd`,{children:C?`${_(Z.tokens)} tokens（${Z.method===`measured`?`實測`:`估算`}）`:`—`})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`本次生成會帶入指引`}),(0,Q.jsxs)(`dd`,{className:Y.guidelineIncluded?`ok`:`missing`,children:[Y.guidelineIncluded?`會帶入`:`不會帶入`,Y.guidelineRequestedButMissing&&`（已選 B 但指引是空的）`]})]}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`dt`,{children:`本次稽核會帶入指引`}),(0,Q.jsx)(`dd`,{className:X.guidelineIncluded?`ok`:`missing`,children:X.guidelineIncluded?`會帶入`:`不會帶入`})]})]}),(0,Q.jsxs)(`p`,{className:`guidelinePrivacy`,children:[`指引只保留在本頁；選擇 B 並執行時才會隨請求送出，不寫入本站資料庫。整份指引會明顯增加輸入量、等待時間與費用。 本工具在任何情況下都不會自動截斷指引或病人資料。`,E===`C`&&` C 使用模組目錄 draft-0.1，尚未經醫療團隊核准，組出的報告只能用於流程比較。`]})]}),(0,Q.jsxs)(`div`,{className:`twoColumns`,children:[(0,Q.jsxs)(`div`,{className:`settingsPane`,children:[(0,Q.jsxs)(`div`,{className:`credentialBox`,children:[(0,Q.jsxs)(`div`,{className:`labelRow credentialLabelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:nt,children:`Gemini 臨時存取金鑰`}),(0,Q.jsx)(`span`,{children:`重新整理即清除`})]}),(0,Q.jsxs)(`div`,{className:`passwordRow`,children:[(0,Q.jsx)(`input`,{id:nt,name:`dmEducationGeminiTransientCredentialManualEntry`,className:`textInput apiKeyInput`,type:le?`text`:`password`,value:g,onChange:e=>oe(e.target.value),placeholder:`請手動貼上本次使用的 Gemini 金鑰`,autoComplete:`new-password`,autoCapitalize:`off`,autoCorrect:`off`,"data-1p-ignore":`true`,"data-lpignore":`true`,"data-bwignore":`true`,"data-form-type":`other`,spellCheck:!1}),(0,Q.jsx)(`button`,{type:`button`,className:`showKeyButton`,onClick:()=>ue(e=>!e),children:le?`隱藏`:`顯示`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`只暫存在本頁記憶體，不寫入資料庫或瀏覽器儲存空間。GitHub Pages 版會由瀏覽器直接傳給 Google Gemini；私人站版則透過本站伺服器。請只在可信任的網址輸入金鑰。`})]}),(0,Q.jsx)(`label`,{className:`fieldLabel modelLabel`,htmlFor:`model`,children:`Gemini 模型`}),(0,Q.jsx)(`select`,{id:`model`,className:`textInput selectInput`,value:de,onChange:e=>he(e.target.value),children:at.map(e=>(0,Q.jsx)(`option`,{value:e.value,children:e.label},e.value))}),de===tt&&(0,Q.jsx)(`input`,{className:`textInput customModelInput`,"aria-label":`自訂Gemini模型ID`,value:ge,onChange:e=>_e(e.target.value),placeholder:`例如 gemini-flash-latest`,spellCheck:!1}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`生成與品質稽核目前使用同一個模型；選擇自訂時請輸入 Gemini API 支援的模型 ID。`}),(0,Q.jsx)(`label`,{className:`fieldLabel modelLabel`,htmlFor:`timeout`,children:`單次請求逾時上限（分鐘）`}),(0,Q.jsx)(`input`,{id:`timeout`,className:`textInput`,type:`number`,min:1,max:60,value:P,onChange:e=>F(Math.max(1,Math.min(60,Number(e.target.value)||rt)))}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`帶入指引全文時單次可能需要數分鐘。逾時會明確顯示為逾時，與你按「停止」區分。`}),(0,Q.jsx)(`label`,{className:`fieldLabel promptPresetLabel`,htmlFor:`generatorPromptPreset`,children:`生成規則版本`}),(0,Q.jsxs)(`select`,{id:`generatorPromptPreset`,className:`textInput selectInput`,value:v,onChange:e=>ft(e.target.value),disabled:E===`C`,children:[c.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,Q.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:E===`C`?`C 使用固定的模組選擇器 prompt，不使用這裡的生成 prompt。`:v===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:c.find(e=>e.id===v)?.description}),(0,Q.jsxs)(`div`,{className:`labelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`generatorPrompt`,children:`生成用 system prompt`}),(0,Q.jsx)(`button`,{className:`miniButton`,onClick:mt,children:v===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,Q.jsx)(`textarea`,{id:`generatorPrompt`,className:`promptEditor`,value:E===`C`?ze:x,onChange:e=>{ye(e.target.value),y(`custom`)},readOnly:E===`C`,spellCheck:!1}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:`病人資料會自動接在 system prompt 後送出，不必複製到 prompt 內。`})]}),(0,Q.jsxs)(`div`,{className:`outputPane`,children:[(0,Q.jsxs)(`div`,{className:`outputHeader`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{className:`outputDot teal`}),(0,Q.jsx)(`strong`,{children:E===`C`?`組合後的病人版報告`:`Gemini 報告`})]}),(0,Q.jsx)(`span`,{children:D?ct(D):`等待生成`})]}),(0,Q.jsx)(`textarea`,{"aria-label":`Gemini產生的糖尿病衛教報告`,className:`outputEditor`,value:D,onChange:e=>{De(e.target.value),j(``)},placeholder:`產生的報告會顯示在這裡。您可以人工修改後，再送交 eval LLM 稽核。`,spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`outputActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(D,`報告`),disabled:!D,children:V===`報告`?`已複製`:`複製`}),(0,Q.jsx)(`button`,{onClick:()=>st(`糖尿病衛教報告.txt`,D),disabled:!D,children:`下載 TXT`})]}),Ae&&(0,Q.jsxs)(`details`,{className:`tracePanel`,open:!0,children:[(0,Q.jsx)(`summary`,{children:`醫師版報告（含 DCSI、R1–R7、PR1–PR7 代碼與分數，病人版不顯示）`}),(0,Q.jsx)(`pre`,{children:Ae}),(0,Q.jsxs)(`div`,{className:`traceActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(Ae,`醫師版`),children:V===`醫師版`?`已複製`:`複製醫師版`}),(0,Q.jsx)(`button`,{onClick:()=>st(`糖尿病衛教報告_醫師版.txt`,Ae),children:`下載醫師版 TXT`})]})]})]})]}),(0,Q.jsxs)(`div`,{className:`cardActionsColumn`,children:[(0,Q.jsx)(dt,{input:Y,title:`本次生成會送出的輸入`,note:E===`C`?`C 只送出精簡事實摘要，不送原始申報明細，也不送指引。`:void 0}),(0,Q.jsx)(ut,{blockers:Ye,label:`目前不能生成的原因`}),(0,Q.jsxs)(`div`,{className:`cardActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton`,onClick:()=>void Ct(),disabled:At,children:M===`generating`?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`spinner`}),`Gemini 生成中… `,Ne,` 秒`]}):`生成衛教報告`}),(0,Q.jsx)(`button`,{className:`secondaryButton runAll`,onClick:()=>void Et(),disabled:At,children:`生成並接續稽核`}),M===`generating`&&(0,Q.jsx)(`button`,{className:`stopButton`,onClick:Tt,children:`停止生成`})]})]})]}),(0,Q.jsxs)(`article`,{className:`stepCard evalCard`,children:[(0,Q.jsxs)(`div`,{className:`stepHeading`,children:[(0,Q.jsx)(`div`,{className:`stepNumber`,children:`03`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`p`,{children:`EVALUATE`}),(0,Q.jsx)(`h2`,{children:`獨立品質稽核`}),(0,Q.jsx)(`span`,{children:`eval LLM 同時看到整理後病人資料與待評估報告。`})]})]}),(0,Q.jsxs)(`div`,{className:`twoColumns`,children:[(0,Q.jsxs)(`div`,{className:`settingsPane`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPromptPreset`,children:`稽核規則版本`}),(0,Q.jsxs)(`select`,{id:`evalPromptPreset`,className:`textInput selectInput`,value:b,onChange:e=>pt(e.target.value),children:[l.map(e=>(0,Q.jsx)(`option`,{value:e.id,children:e.label},e.id)),(0,Q.jsx)(`option`,{value:`custom`,children:`自訂內容（目前文字）`})]}),(0,Q.jsx)(`p`,{className:`fieldNote`,children:b===`custom`?`下方文字已手動修改，重新整理頁面後不會保留。`:l.find(e=>e.id===b)?.description}),b===`colleague`&&!G&&(0,Q.jsxs)(`p`,{className:`promptWarning`,children:[`這個版本假設稽核模型已取得臨床指引；目前流程選的是 `,E,`，不會自動附上兩份 PDF，因此輸出的指引章節與引用仍需人工核對。`]}),(0,Q.jsxs)(`div`,{className:`labelRow`,children:[(0,Q.jsx)(`label`,{className:`fieldLabel`,htmlFor:`evalPrompt`,children:`eval LLM system prompt`}),(0,Q.jsx)(`button`,{className:`miniButton`,onClick:ht,children:b===`custom`?`恢復工作台預設`:`重新載入此版本`})]}),(0,Q.jsx)(`textarea`,{id:`evalPrompt`,className:`promptEditor evalPrompt`,value:S,onChange:e=>{be(e.target.value),ve(`custom`)},spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`evalInputMap`,children:[(0,Q.jsx)(`span`,{children:`稽核輸入`}),(0,Q.jsx)(`strong`,{children:`病人資料`}),(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`報告`}),(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`評分規則`}),X.guidelineIncluded&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`i`,{children:`＋`}),(0,Q.jsx)(`strong`,{children:`指引全文`})]})]})]}),(0,Q.jsxs)(`div`,{className:`outputPane evalOutput`,children:[(0,Q.jsxs)(`div`,{className:`outputHeader`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`span`,{className:`outputDot amber`}),(0,Q.jsx)(`strong`,{children:`稽核結果`})]}),A?(0,Q.jsx)(`span`,{className:`verdict ${W.tone}`,children:W.label}):(0,Q.jsx)(`span`,{children:`等待稽核`})]}),(0,Q.jsx)(`textarea`,{"aria-label":`eval LLM稽核結果`,className:`outputEditor`,value:A,onChange:e=>j(e.target.value),placeholder:`這裡會列出稽核結論、分項評分、重大問題與具體修改建議。`,spellCheck:!1}),(0,Q.jsxs)(`div`,{className:`outputActions`,children:[(0,Q.jsx)(`button`,{onClick:()=>void Ot(A,`稽核`),disabled:!A,children:V===`稽核`?`已複製`:`複製`}),(0,Q.jsx)(`button`,{onClick:()=>st(`衛教報告_稽核結果.txt`,A),disabled:!A,children:`下載 TXT`})]})]})]}),(0,Q.jsxs)(`div`,{className:`cardActionsColumn`,children:[(0,Q.jsx)(dt,{input:X,title:`本次稽核會送出的輸入`}),(0,Q.jsx)(ut,{blockers:Xe,label:`目前不能稽核的原因`}),(0,Q.jsxs)(`div`,{className:`cardActions`,children:[(0,Q.jsx)(`button`,{className:`primaryButton amberButton`,onClick:()=>void wt(),disabled:jt,children:M===`evaluating`?(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`span`,{className:`spinner`}),`品質稽核中… `,Ne,` 秒`]}):`執行品質稽核`}),M===`evaluating`&&(0,Q.jsx)(`button`,{className:`stopButton`,onClick:Tt,children:`停止稽核`})]})]})]})]}),(0,Q.jsxs)(`section`,{className:`safetyNote`,children:[(0,Q.jsx)(`div`,{className:`safetyIcon`,children:`i`}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`strong`,{children:`上線前的必要提醒`}),(0,Q.jsx)(`p`,{children:`此工具是內容生成與稽核工作台，不是診斷系統。正式提供病人前，仍應由醫療團隊核准固定衛教內容、prompt、模型版本與發送規則，並建立人工抽查及版本紀錄。`})]})]}),(0,Q.jsxs)(`footer`,{children:[(0,Q.jsx)(`span`,{children:`糖尿病衛教報告工作台`}),(0,Q.jsx)(`span`,{children:`資料僅在本頁處理；按下生成或稽核時才送往 Gemini API。`}),(0,Q.jsx)(`span`,{className:`buildStamp`,children:`build ${u}`})]})]})}export{$ as default};