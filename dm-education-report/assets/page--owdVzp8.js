...
5. 不要自行剪除厚繭、雞眼，也不要在傷口上使用來路不明的藥膏或偏方。`},{id:`SHARED-SMOKING`,title:`關於吸菸`,appliesWhen:`smoking`,text:`吸菸會同時傷害眼底、腎臟與全身大小血管，戒菸是對血管保護效益最大的一件事。可請醫療團隊轉介戒菸服務，或撥打戒菸專線。`}],ee=new Map(D.map(e=>[e.id,e])),O={1:[`interval-eye`,`interval-retina-followup`],2:[],3:[`interval-kidney`,`kidney-intensive-followup`],4:[`interval-neuropathy`],5:[`interval-lipid`],6:[`interval-foot`]},te=[`interval-hba1c`,`interval-lipid`,`interval-kidney`,`interval-oral`];function ne(e,t={}){let n=new Set(te);for(let t of e)for(let e of O[t]??[])n.add(e);t.kidneyIntensive||n.delete(`kidney-intensive-followup`),n.has(`kidney-intensive-followup`)&&n.delete(`interval-kidney`),n.has(`interval-retina-followup`)&&n.delete(`interval-eye`);let r=y.filter(e=>n.has(e.id)&&e.patientFacing);return r.length?{rules:r,text:ie(r)}:{rules:[],text:``}}var re={"interval-hba1c":`血糖控制指標`,"interval-lipid":`血脂`,"interval-kidney":`腎功能與尿液檢查`,"interval-oral":`口腔`,"interval-eye":`眼底`,"interval-retina-followup":`眼底檢查`,"interval-neuropathy":`神經與足部感覺`,"interval-foot":`足部循環`,"kidney-intensive-followup":`腎功能與尿液檢查（您的檢查結果顯示需要加強追蹤）`};function ie(e){return e.length?`${e.map((e,t)=>`${t+1}. ${re[e.id]??``}：${e.patientStatement??e.statement}`).join(`
`)}

實際的檢查時間由醫療團隊依您的狀況安排，上面是一般的參考間隔。`:``}var ae={"kidney-intensive-followup":`腎功能與尿液白蛋白`};function oe(e){return e.map(e=>{let t=ae[e.id];return`  ${t?`${t}：`:``}${e.statement}　〔${S(e)}〕`})}var k=n(),se=[{id:`education`,label:`衛教模組 ${m}`},{id:`selfCare`,label:`自我照護模組 ${C}`},{id:`rules`,label:`指引門檻表 ${_}`}];function ce({approved:e}){return(0,k.jsx)(`span`,{className:e?`libraryBadge libraryBadgeOk`:`libraryBadge libraryBadgeDraft`,children:e?`已核准`:`DRAFT・未經醫療團隊核准`})}function le({text:e}){return(0,k.jsx)(k.Fragment,{children:e.split(/\n{2,}/).map((e,t)=>(0,k.jsx)(`p`,{className:`libraryBody`,children:e},t))})}function ue(){return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`p`,{className:`fieldNote`,children:`病人版報告的併發症段落只會用到這裡的文字，模型不改寫。 主題模組只留該疾病特有的內容；每份報告都講一次的通用內容集中在下方的共同區塊。`}),h.map(e=>(0,k.jsxs)(`article`,{className:`libraryItem`,children:[(0,k.jsxs)(`header`,{className:`libraryItemHead`,children:[(0,k.jsx)(`h3`,{children:e.title}),(0,k.jsx)(`code`,{children:e.id}),(0,k.jsx)(`span`,{className:`libraryTag`,children:a[e.topic]}),e.typeGate===`any`?null:(0,k.jsx)(`span`,{className:`libraryTag`,children:o[e.typeGate]}),e.autoOnly?(0,k.jsx)(`span`,{className:`libraryTag`,children:`程式自動加入`}):null]}),(0,k.jsxs)(`p`,{className:`libraryMeta`,children:[`納入條件：`,e.appliesWhen]}),(0,k.jsx)(le,{text:e.patientText}),e.urgentSigns?(0,k.jsxs)(`p`,{className:`libraryUrgent`,children:[(0,k.jsx)(`strong`,{children:`就醫警訊`}),e.urgentSigns]}):null]},e.id)),(0,k.jsx)(`h3`,{className:`librarySubhead`,children:`共同區塊（整份報告各出現一次）`}),D.map(e=>(0,k.jsxs)(`article`,{className:`libraryItem`,children:[(0,k.jsxs)(`header`,{className:`libraryItemHead`,children:[(0,k.jsx)(`h3`,{children:e.title}),(0,k.jsx)(`code`,{children:e.id}),(0,k.jsx)(`span`,{className:`libraryTag`,children:e.appliesWhen===`always`?`固定納入`:`由主題觸發：${e.appliesWhen}`})]}),(0,k.jsx)(le,{text:e.text})]},e.id))]})}function de(){return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`p`,{className:`fieldNote`,children:`以 DSMES／ADCES7 七項自我照護行為為骨架。臨床照護指引不是為這些行為寫的， 所以這些文字不引指引，需由醫療團隊依院內衛教單張核定。`}),w.map(e=>(0,k.jsxs)(`article`,{className:`libraryItem`,children:[(0,k.jsxs)(`header`,{className:`libraryItemHead`,children:[(0,k.jsx)(`h3`,{children:e.title}),(0,k.jsx)(`code`,{children:e.id}),(0,k.jsx)(`span`,{className:`libraryTag`,children:s[e.behavior]??e.behavior}),e.core?(0,k.jsx)(`span`,{className:`libraryTag`,children:`固定納入`}):null]}),(0,k.jsxs)(`p`,{className:`libraryMeta`,children:[`納入條件：`,e.appliesWhen]}),(0,k.jsx)(le,{text:e.patientText}),e.definiteVariants?.length?(0,k.jsxs)(`div`,{className:`libraryVariants`,children:[(0,k.jsx)(`strong`,{children:`整句替換（兩句擇一，不會同時出現）`}),(0,k.jsx)(`p`,{className:`libraryVariantHint`,children:`正文寫成「若…」是因為要能給所有人看。程式已從資料確認這位病人符合下列條件時，那一句改用直述句。`}),e.definiteVariants.map((e,t)=>(0,k.jsxs)(`div`,{className:`libraryVariant`,children:[(0,k.jsx)(`p`,{className:`libraryVariantWhen`,children:(0,k.jsx)(`span`,{className:`libraryTag`,children:c[e.when]??e.when})}),(0,k.jsxs)(`p`,{className:`libraryVariantLine`,children:[(0,k.jsx)(`span`,{className:`libraryVariantSide`,children:`未確認時`}),(0,k.jsx)(`span`,{className:`libraryVariantFrom`,children:e.from})]}),(0,k.jsxs)(`p`,{className:`libraryVariantLine`,children:[(0,k.jsx)(`span`,{className:`libraryVariantSide libraryVariantSideOn`,children:`已確認時`}),(0,k.jsx)(`span`,{className:`libraryVariantTo`,children:e.to})]})]},t))]}):null,e.urgentSigns?(0,k.jsxs)(`p`,{className:`libraryUrgent`,children:[(0,k.jsx)(`strong`,{children:`就醫警訊`}),e.urgentSigns]}):null]},e.id))]})}function fe(){let e=[...u,...y.map(e=>e.category).filter(e=>!u.includes(e))].filter((e,t,n)=>n.indexOf(e)===t).map(e=>({category:e,rules:y.filter(t=>t.category===e)})).filter(e=>e.rules.length>0);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`p`,{className:`fieldNote`,children:[`來源：`,v,`。這裡記錄的是門檻數值、追蹤間隔與轉診急迫度等事實，以自己的文字陳述並附出處， 不重製指引原文。頁次指 PDF 實體頁次，可直接跳頁核對。共 `,y.length,` 條。`]}),e.map(e=>(0,k.jsxs)(`section`,{className:`libraryGroup`,children:[(0,k.jsxs)(`h3`,{className:`librarySubhead`,children:[l[e.category]??e.category,(0,k.jsx)(`span`,{className:`libraryCount`,children:e.rules.length})]}),(0,k.jsx)(`div`,{className:`libraryTableWrap`,children:(0,k.jsxs)(`table`,{className:`libraryTable`,children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`適用對象`}),(0,k.jsx)(`th`,{children:`門檻／間隔（醫師版用字）`}),(0,k.jsx)(`th`,{children:`病人版用字`}),(0,k.jsx)(`th`,{children:`出處`})]})}),(0,k.jsx)(`tbody`,{children:e.rules.map(e=>(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`code`,{children:e.id}),(0,k.jsx)(`span`,{children:e.appliesTo})]}),(0,k.jsx)(`td`,{children:e.statement}),(0,k.jsx)(`td`,{children:e.patientFacing?e.patientStatement??e.statement:(0,k.jsx)(`span`,{className:`libraryMuted`,children:`不對病人顯示`})}),(0,k.jsx)(`td`,{className:`libraryCitation`,children:S(e)})]},e.id))})]})})]},e.category))]})}function pe(){let[e,t]=(0,r.useState)(`education`);return(0,k.jsxs)(`article`,{className:`stepCard`,children:[(0,k.jsxs)(`div`,{className:`stepHeading`,children:[(0,k.jsx)(`span`,{className:`stepNumber`,children:`05`}),(0,k.jsxs)(`div`,{className:`stepHeadingText`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`CONTENT`}),(0,k.jsx)(`h2`,{children:`報告會用到的固定內容`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`唯讀。併發症風險與預防叮嚀的每一句都出自這裡，模型不改寫；觀察摘要、短期建議、中期目標三段則由模型撰寫。 內容改動走版本控制與送審，不在頁面上編輯。`})]})]}),(0,k.jsxs)(`div`,{className:`stepBody`,children:[(0,k.jsx)(`div`,{className:`tabs`,children:se.map(n=>(0,k.jsx)(`button`,{type:`button`,className:e===n.id?`active`:``,onClick:()=>t(n.id),children:n.label},n.id))}),(0,k.jsx)(`p`,{className:`libraryStatus`,children:(0,k.jsx)(ce,{approved:!1})}),(0,k.jsxs)(`div`,{className:`libraryScroll`,children:[e===`education`?(0,k.jsx)(ue,{}):null,e===`selfCare`?(0,k.jsx)(de,{}):null,e===`rules`?(0,k.jsx)(fe,{}):null]})]})]})}function me(e){let t=[];return e.rValue!==null&&t.push(`R${e.topic}=${e.rValue}`),e.prValue!==null&&t.push(`PR${e.topic}=${e.prValue}`),t.length?t.join(`　`):`R${e.topic}／PR${e.topic} 皆缺值`}function A(e){return g.get(e)?.title??T.get(e)?.title??ee.get(e)?.title??e}function he(e){let t=g.get(e)?.topic;return t===`BASE`?`固定`:t===`TYPE`?`類型說明`:`主題`}function ge(e,t){let n=e?b.get(e):void 0;return n?S(n):t}function j({n:e,title:t,note:n,count:r,children:i}){return(0,k.jsxs)(`section`,{className:`traceStage`,children:[(0,k.jsxs)(`header`,{className:`traceStageHead`,children:[(0,k.jsx)(`span`,{className:`traceStep`,children:e}),(0,k.jsx)(`h4`,{children:t}),r?(0,k.jsx)(`span`,{className:`traceCount`,children:r}):null]}),n?(0,k.jsx)(`p`,{className:`traceNote`,children:n}):null,i]})}function _e({plan:e,facts:t}){let n=e.targets.targets.filter(e=>e.value),r=e.patientModuleIds;return(0,k.jsxs)(`div`,{className:`traceBoard`,children:[(0,k.jsx)(`p`,{className:`traceLead`,children:`以下每一段都由程式判定，不需要 API 金鑰，也不會因為換模型而改變。左邊是輸入訊號，右邊是判定結果。`}),(0,k.jsx)(j,{n:`1`,title:`併發症主題：R／PR → 納入方式`,note:`同一個主題，來源只會給 R 或 PR 其中一個。給了 R 代表已發生；只給 PR 代表尚未發生，才會有風險預測。`,count:`${e.decisions.filter(e=>e.kind!==`excluded`).length}／${e.decisions.length} 納入`,children:(0,k.jsx)(`ul`,{className:`traceRows`,children:e.decisions.map(e=>(0,k.jsxs)(`li`,{className:e.kind===`excluded`?`traceRow traceRowOff`:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceSignal`,children:me(e)}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:f[e.kind],children:d[e.kind]}),(0,k.jsx)(`span`,{className:`traceSubject`,children:e.topicName}),(0,k.jsx)(`p`,{className:`traceReason`,children:e.reason})]},e.topic))})}),(0,k.jsxs)(j,{n:`2`,title:`依指引推導的目標`,note:`目標值來自門檻表，不是模型生成的。括號內是可回查的章表與頁次。`,count:`${n.length} 項`,children:[n.length?(0,k.jsx)(`ul`,{className:`traceRows`,children:n.map(e=>(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceSignal`,children:e.metric}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:e.value}),ge(e.ruleId,e.citation)?(0,k.jsx)(`span`,{className:`traceCitation`,children:ge(e.ruleId,e.citation)}):null,(0,k.jsx)(`p`,{className:`traceReason`,children:e.reason})]},e.metric))}):(0,k.jsx)(`p`,{className:`traceEmpty`,children:`沒有可解出的目標。`}),e.targets.undetermined.length?(0,k.jsx)(`ul`,{className:`traceNoteList`,children:e.targets.undetermined.map((e,t)=>(0,k.jsxs)(`li`,{children:[`資料不足、未判定：`,e]},t))}):null]}),(0,k.jsxs)(j,{n:`3`,title:`檢驗門檻判定`,note:`由實際數值觸發。這一段只做數值比對；判讀交給 LLM（下方②）。`,count:`${e.labThresholds.length} 則・已判定 ${e.evaluatedAnalytes} 項指標`,children:[e.labThresholds.length?(0,k.jsx)(`ul`,{className:`traceRows`,children:e.labThresholds.map((e,t)=>(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceSeverity traceSeverity-${e.severity}`,children:p[e.severity]??e.severity}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:e.clinicianMessage}),ge(e.ruleId,e.citation)?(0,k.jsx)(`span`,{className:`traceCitation`,children:ge(e.ruleId,e.citation)}):null]},`${e.code}-${t}`))}):(0,k.jsx)(`p`,{className:`traceEmpty`,children:`沒有數值達到門檻。`}),e.unevaluatedNumericItems>0?(0,k.jsxs)(`p`,{className:`traceNote`,children:[`另有 `,e.unevaluatedNumericItems,` 種有數值但未納入門檻判定的項目，會交給 LLM 判讀。`]}):null]}),(0,k.jsx)(j,{n:`4`,title:`追蹤間隔`,note:`由納入的主題決定要列哪些項目，間隔本身出自門檻表。`,count:`${e.followUp.rules.length} 項`,children:e.followUp.rules.length?(0,k.jsx)(`ul`,{className:`traceRows`,children:e.followUp.rules.map(e=>(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceSignal`,children:e.id}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:e.patientStatement??e.statement})]},e.id))}):(0,k.jsx)(`p`,{className:`traceEmpty`,children:`沒有適用的固定間隔。`})}),(0,k.jsx)(j,{n:`5`,title:`自我照護模組`,note:`與併發症主題無關，依用藥、低血糖紀錄與併發症數量觸發。`,count:`${e.selfCareModuleIds.length} 個`,children:(0,k.jsx)(`ul`,{className:`traceRows`,children:e.selfCareModuleIds.map(t=>(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceSignal`,children:t}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:A(t)}),e.selfCareReasons[t]?(0,k.jsx)(`p`,{className:`traceReason`,children:e.selfCareReasons[t]}):null]},t))})}),(0,k.jsxs)(j,{n:`6`,title:`病人版報告的段落順序`,note:`這就是組裝結果。正文逐字來自固定模組，模型不改寫。`,count:`${r.length+e.sharedBlockIds.length+e.selfCareModuleIds.length} 段`,children:[(0,k.jsxs)(`ol`,{className:`traceOutline`,children:[r.map(e=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{className:`traceOutlineTag`,children:he(e)}),A(e),(0,k.jsx)(`code`,{children:e})]},e)),e.sharedBlockIds.map(e=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{className:`traceOutlineTag`,children:`共同`}),A(e),(0,k.jsx)(`code`,{children:e})]},e)),e.selfCareModuleIds.map(e=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{className:`traceOutlineTag`,children:`自我照護`}),A(e),(0,k.jsx)(`code`,{children:e})]},`sc-${e}`))]}),e.urgentSigns.length?(0,k.jsxs)(`p`,{className:`traceNote`,children:[`另有 `,e.urgentSigns.length,` 則就醫警訊，集中放在報告開頭。`]}):null]}),(0,k.jsx)(j,{n:`→`,title:`接下來 LLM 會補的三件事`,note:`按下產出才會執行。任何一次失敗都只會少掉該段，不影響上面已經定案的內容。`,children:(0,k.jsxs)(`ul`,{className:`traceRows`,children:[(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceLlmTag`,children:`①`}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:`模組挑選：只回代碼與優先序，改不了上面第 1 段的判定`})]}),(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceLlmTag`,children:`②`}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsxs)(`span`,{className:`traceValue`,children:[`檢驗判讀：讀原始紀錄找第 3 段沒涵蓋的異常，結果進醫師版`,t.labItems.length?`（原始紀錄 ${t.labItems.length} 筆）`:``]})]}),(0,k.jsxs)(`li`,{className:`traceRow`,children:[(0,k.jsx)(`span`,{className:`traceLlmTag`,children:`③`}),(0,k.jsx)(`span`,{className:`traceArrow`,children:`→`}),(0,k.jsx)(`span`,{className:`traceValue`,children:`檢驗敘述：寫成病人看的段落，數值會逐一比對來源後才採用`})]})]})})]})}var ve=196,ye=48,be=[{id:`ingest`,x:262,y:16,title:`健保申報 JSON`,sub:`用藥 · 檢驗 · R/PR · DCSI`,tone:`flowNeutral`},{id:`decide`,x:262,y:112,title:`確定性事實與判定`,sub:`主題 · 目標 · 門檻（程式）`,tone:`flowNeutral`},{id:`selector`,x:16,y:208,title:`① 模組挑選`,sub:`只回代碼與優先序`,tone:`flowLlm`},{id:`labReview`,x:262,y:208,title:`② 檢驗判讀`,sub:`讀原始紀錄`,tone:`flowLlm`},{id:`narrative`,x:508,y:208,title:`③ 檢驗敘述`,sub:`寫成病人看的段落`,tone:`flowLlm`},{id:`assemble`,x:262,y:304,title:`驗證與組裝`,sub:`數值比對 · 禁止事項`,tone:`flowNeutral`},{id:`patientReport`,x:140,y:400,title:`病人版衛教報告`,sub:`正文來自固定模組`,tone:`flowOut`},{id:`clinicianReport`,x:384,y:400,title:`醫師版報告`,sub:`附指引章表與頁次`,tone:`flowOut`}],xe=[`M360 64 L360 112`,`M360 160 L360 184 L114 184 L114 208`,`M360 160 L360 208`,`M360 160 L360 184 L606 184 L606 208`,`M114 256 L114 280 L360 280 L360 304`,`M360 256 L360 304`,`M606 256 L606 280 L360 280 L360 304`,`M360 352 L360 376 L238 376 L238 400`,`M360 352 L360 376 L482 376 L482 400`],M={ingest:[`ingest`],decide:[`decide`],selector:[`selector`],labReview:[`labReview`],narrative:[`narrative`],assemble:[`assemble`,`patientReport`,`clinicianReport`]};function Se({highlight:e,compact:t=!1}){let n=e?.length?new Set(e):null,r=t?`flowArrowMini`:`flowArrow`;return(0,k.jsxs)(`svg`,{className:t?`flowDiagram flowMini`:`flowDiagram`,viewBox:`0 0 720 464`,role:`img`,"aria-label":n?`資料流位置：目前在「${be.filter(e=>n.has(e.id)).map(e=>e.title).join(`、`)}」`:`資料流：程式判定為主，三次 LLM 呼叫只負責規則做不到的事`,children:[(0,k.jsx)(`defs`,{children:(0,k.jsx)(`marker`,{id:r,viewBox:`0 0 10 10`,refX:`8`,refY:`5`,markerWidth:`6`,markerHeight:`6`,orient:`auto-start-reverse`,children:(0,k.jsx)(`path`,{d:`M2 1L8 5L2 9`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`})})}),be.map(e=>{let r=n?!n.has(e.id):!1;return(0,k.jsxs)(`g`,{className:`${e.tone}${r?` flowDim`:``}${n&&!r?` flowActive`:``}`,children:[(0,k.jsx)(`rect`,{x:e.x,y:e.y,width:ve,height:ye,rx:6}),(0,k.jsx)(`text`,{className:`flowTitle`,x:e.x+ve/2,y:t?e.y+30:e.y+21,textAnchor:`middle`,children:e.title}),t?null:(0,k.jsx)(`text`,{className:`flowSub`,x:e.x+ve/2,y:e.y+38,textAnchor:`middle`,children:e.sub})]},e.id)}),(0,k.jsx)(`g`,{className:n?`flowLine flowDim`:`flowLine`,markerEnd:`url(#${r})`,children:xe.map(e=>(0,k.jsx)(`path`,{d:e},e))})]})}var Ce=1048576;function we(e){return e>=19968&&e<=40959||e>=13312&&e<=19903||e>=63744&&e<=64255||e>=12288&&e<=12351||e>=65280&&e<=65519}function Te(e){let t=0,n=0,r=0,i=0,a=0;for(let o of e){a+=1;let e=o.codePointAt(0)??0;we(e)?t+=1:e<128?o===` `||o===`	`||o===`
`||o===`\r`||o===`\f`||o===`\v`?r+=1:n+=1:i+=1}return{total:a,cjk:t,asciiVisible:n,whitespace:r,other:i}}function Ee(e){if(!e)return 0;let{cjk:t,asciiVisible:n,whitespace:r,other:i}=Te(e);return Math.round(t+n/4+r/5+i/2)}function De(e){return[...e].length}function N(e){return e.toLocaleString(`zh-TW`)}var P={idle:`待命`,running:`執行中`,ok:`完成`,failed:`失敗`,skipped:`未執行`};function F({port:e}){let[t,n]=(0,r.useState)(!1),i=!e.text;return(0,k.jsxs)(`div`,{className:`pipePort`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`pipePortHead`,onClick:()=>n(e=>!e),disabled:i,"aria-expanded":t,children:[(0,k.jsx)(`span`,{className:`pipePortArrow`,children:t?`▾`:`▸`}),(0,k.jsx)(`span`,{className:`pipePortLabel`,children:e.label}),(0,k.jsx)(`span`,{className:`pipePortSize`,children:i?`—`:`${N(De(e.text))} 字`})]}),t&&!i?(0,k.jsx)(`pre`,{className:e.code?`pipePortBody pipePortCode`:`pipePortBody`,children:e.text}):null]})}function I({label:e,hint:t,ports:n}){return n.length?(0,k.jsxs)(`div`,{className:`pipeGroup`,children:[(0,k.jsxs)(`p`,{className:`pipeGroupLabel`,children:[e,t?(0,k.jsx)(`span`,{children:t}):null]}),n.map(e=>(0,k.jsx)(F,{port:e},e.label))]}):null}function L({station:e,index:t}){return(0,k.jsxs)(`li`,{className:`pipeStation pipeStation-${e.kind} pipeState-${e.state}`,children:[(0,k.jsxs)(`div`,{className:`pipeStationHead`,children:[(0,k.jsx)(`span`,{className:`pipeIndex`,children:t}),(0,k.jsx)(`h4`,{children:e.title}),(0,k.jsx)(`span`,{className:`pipeKind`,children:e.kind===`llm`?`LLM`:`程式`}),(0,k.jsx)(`span`,{className:`pipeState pipeState-${e.state}`,children:P[e.state]})]}),(0,k.jsx)(`p`,{className:`pipeRole`,children:e.role}),M[e.id]?(0,k.jsx)(`div`,{className:`pipeMap`,children:(0,k.jsx)(Se,{highlight:M[e.id],compact:!0})}):null,(0,k.jsx)(I,{label:`材料`,ports:e.inputs}),(0,k.jsx)(I,{label:`食譜`,hint:e.kind===`llm`?`system prompt 與實際執行的程式碼`:`實際執行的程式碼`,ports:e.recipe}),e.steps?.length?(0,k.jsxs)(`div`,{className:`pipeGroup`,children:[(0,k.jsxs)(`p`,{className:`pipeGroupLabel`,children:[`做了什麼`,(0,k.jsx)(`span`,{children:`依序`})]}),(0,k.jsx)(`ol`,{className:`pipeSteps`,children:e.steps.map((e,t)=>(0,k.jsx)(`li`,{children:e},t))})]}):null,(0,k.jsx)(I,{label:`成品`,ports:e.outputs}),e.problems?.length?(0,k.jsx)(`ul`,{className:`pipeProblems`,children:e.problems.map((e,t)=>(0,k.jsx)(`li`,{children:e},t))}):null]})}function Oe({stations:e}){return(0,k.jsx)(`ol`,{className:`pipeBoard`,children:e.map((e,t)=>(0,k.jsx)(L,{station:e,index:t+1},e.id))})}var R=`/**
 * 病人資料 → LLM 好讀文字。
 *
...
`)}function Ne(e){let t=[];return e.rawInput.trim()?e.parsedJson||t.push({code:`not-json`,message:`這份內容不是可解析的 JSON。`,howToFix:`這條流程需要結構化欄位（R／PR／CKD／檢驗紀錄）才能判定主題與門檻，純文字無法使用。請改上傳原始 JSON。`,hard:!0}):t.push({code:`no-input`,message:`還沒有病人資料。`,howToFix:`上傳健保申報 JSON、貼上 JSON 內容，或按「載入去識別示範」。`,hard:!0}),e.model.trim()||t.push({code:`no-model`,message:`沒有選擇模型。`,howToFix:`在下方選一個模型，或填入自訂模型 ID。`,hard:!0}),e.requiresClientKey&&!e.apiKey.trim()&&t.push({code:`no-key`,message:`這個版本需要在頁面輸入 Gemini API 金鑰。`,howToFix:`在下方貼上金鑰。金鑰只留在這一頁的記憶體，重新整理即清除。`,hard:!0}),e.totalTokens>e.tokenLimit&&t.push({code:`over-limit`,message:`輸入約 ${e.totalTokens.toLocaleString(`zh-TW`)} tokens，超過模型上限 ${e.tokenLimit.toLocaleString(`zh-TW`)}。`,howToFix:`本工具不會自動截斷病人資料。請改用可接受更長輸入的模型，或減少送入的紀錄。`,hard:!0}),t}function Pe(e){return e.some(e=>e.hard)}function Fe(e,t,n){let r=n??{tokens:Ee(t),method:`estimate`};return{label:e,chars:De(t),tokens:r.tokens,method:r.method}}function Ie(e){let t=[{label:`① 模組挑選：system prompt`,text:e.selectorPrompt},{label:`① 模組挑選：病人事實摘要`,text:e.factsText},{label:`② 檢驗判讀：system prompt`,text:e.labReviewPrompt},{label:`② 檢驗判讀：檢驗紀錄`,text:e.labText},{label:`③ 檢驗敘述：system prompt`,text:e.narrativePrompt},{label:`③ 檢驗敘述：檢驗紀錄與缺檢清單`,text:e.narrativeText}],n=t.map(e=>Fe(e.label,e.text));return{text:t.map(e=>e.text).join(`

`),systemPrompt:e.selectorPrompt,parts:n,totalChars:n.reduce((e,t)=>e+t.chars,0),totalTokens:n.reduce((e,t)=>e+t.tokens,0)}}var Le=[`REPORT_DATE`,`BIRTHDAY`,`INDX_DATE`,`SEX`,`P4P`,`HT`,`HL`,`CKD`,`T`,`DCSI`,`AGEGP`,`GRADE`],Re={REPORT_DATE:`報告日期`,BIRTHDAY:`出生日期`,INDX_DATE:`糖尿病指標日期`,SEX:`性別代碼`,P4P:`是否參加糖尿病P4P`,HT:`高血壓`,HL:`高血脂`,CKD:`慢性腎臟病`,T:`糖尿病病程年數`,DCSI:`DCSI總分`,AGEGP:`年齡分組`,GRADE:`整體分級`},ze={medication:`用藥紀錄`,labData:`檢驗資料`,chinesemed:`中藥用藥`,imaging:`影像資料`,allergy:`過敏資料`,surgery:`手術資料`,discharge:`出院資料`,medDays:`用藥天數資料`,patientSummary:`病人摘要`,cancerScreening:`癌症篩檢`,adultHealthCheck:`成人健檢`},U=new Set([`drug_code`,`drug_ing_code`,`func_seq_no`,`fee_ym`,`drug_multi_mark`,`drug_std_qty`,`assay_method`]);function W(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function G(e){return e==null||e===``||e===`null`?`未提供`:typeof e==`object`?JSON.stringify(e):String(e).replaceAll(`\r`,` `).replaceAll(`
`,` `).trim()||`未提供`}function Be(e){return Array.isArray(e)?e.map(Be):W(e)?Object.fromEntries(Object.keys(e).sort().map(t=>[t,Be(e[t])])):e}function Ve(e){let t=new Map;for(let n of e){let e=JSON.stringify(Be(n)),r=t.get(e);r?r.count+=1:t.set(e,{record:n,count:1})}return[...t.values()]}function He(e,t){let n=Le.indexOf(e),r=Le.indexOf(t);if(n!==-1||r!==-1)return n===-1?1:r===-1?-1:n-r;let i=e.match(/^(R|PR)(\d+)$/),a=t.match(/^(R|PR)(\d+)$/);return i&&a?i[1]===a[1]?Number(i[2])-Number(a[2]):i[1]===`R`?-1:1:i?-1:a?1:e.localeCompare(t)}function Ue(e,t=0){let n=`  `.repeat(t);if(Array.isArray(e))return e.length?e.flatMap((e,r)=>W(e)||Array.isArray(e)?[`${n}- 第 ${r+1} 筆`,...Ue(e,t+1)]:[`${n}- ${G(e)}`]):[`${n}（空陣列）`];if(W(e)){let r=Object.entries(e);return r.length?r.flatMap(([e,r])=>W(r)||Array.isArray(r)?[`${n}${e}：`,...Ue(r,t+1)]:[`${n}${e}：${G(r)}`]):[`${n}（空物件）`]}return[`${n}${G(e)}`]}function We(e,t){let n=e[t];return W(n)&&Array.isArray(n.rObject)?n.rObject:[]}function Ge(e){return W(e)?Object.entries(e).filter(([,e])=>e!=null&&e!==``&&e!==`null`).map(([e,t])=>`${e}:${G(t)}`).join(`｜`):G(e)}function Ke(e){if(!W(e))return[`【輸入資料】`,...Ue(e),``,`【資料使用限制】`,`以上僅重新排版，沒有推定缺少的診斷、日期、用藥狀態或治療資訊。`].join(`
...
`);let t=[`【檔案與基本資料】`,`資料匯出類型：${G(e.downloadType)}`],n=W(e.userInfo)?e.userInfo:{},r=W(e.userInput)?e.userInput:{},i=W(e.rawSources)?e.rawSources:{};for(let[e,r]of Object.entries(n))t.push(`${e}：${G(r)}`);t.push(``,`【來源模型欄位】`,`以下保留來源原值；未提供不等同於0。`);let a=Object.keys(r).sort(He);a.length||t.push(`未提供來源模型欄位。`);for(let e of a){let n=Re[e]?`（${Re[e]}）`:``;t.push(`${e}${n}：${G(r[e])}`)}t.push(``,`【DCSI與風險欄位說明】`),t.push(`僅保留來源DCSI、R與PR原始欄位；整理階段不重新解釋分數。來源未出現的欄位不得自行補值，也不得直接視為0。`),t.push(``,`【資料來源概況】`);let o=Object.entries(i);o.length||t.push(`未提供rawSources資料來源。`);for(let[e,n]of o){let r=W(n)&&Array.isArray(n.rObject)?n.rObject:[];t.push(`${ze[e]??e}（${e}）：${r.length}筆${r.length?``:`，來源為空陣列`}`)}let s=We(i,`medication`),c=Ve(s),l=new Map;for(let e of c){let t=W(e.record)?e.record:{},n=`${G(t.drug_date).replaceAll(`/`,`-`)}｜${`ICD ${G(t.icd_code)}｜${G(t.icd_cname)}`}`,r=Ge(Object.fromEntries(Object.entries(t).filter(([e])=>![`drug_date`,`icd_code`,`icd_cname`,`drug_ename`].includes(e)&&!U.has(e)))),i=l.get(n)??[];i.push({text:r||`原紀錄沒有其他欄位`,count:e.count}),l.set(n,i)}t.push(``,`【用藥紀錄】`),t.push(`來源共${s.length}筆；完全相同紀錄合併後${c.length}筆。重複次數以×N保留；不同欄位不合併。`),s.length||t.push(`未提供用藥紀錄。`);for(let e of[...l.keys()].sort().reverse()){t.push(e);for(let n of l.get(e)??[])t.push(`- ${n.text}${n.count>1?`｜×${n.count}`:``}`)}let u=We(i,`labData`),d=Ve(u),f=new Map;for(let e of d){let t=W(e.record)?e.record:{},n=[G(t.fee_ym),G(t.order_code),G(t.order_name),`檢體或模式:${G(t.inspect_mode)}`].join(`｜`),r=`${G(t.assay_item_name)}=${G(t.assay_value)}`;G(t.unit_data)!==`未提供`&&(r+=` ${G(t.unit_data)}`),r+=`｜參考:${G(t.consult_value)}`;let i=Object.entries(t).filter(([e,t])=>![`fee_ym`,`order_code`,`order_name`,`assay_method`,`inspect_mode`,`assay_item_name`,`assay_value`,`unit_data`,`consult_value`].includes(e)&&!U.has(e)&&t!=null&&t!==``).map(([e,t])=>`${e}:${G(t)}`);i.length&&(r+=`｜其他欄位:${i.join(`、`)}`);let a=f.get(n)??[];a.push({text:r,count:e.count}),f.set(n,a)}t.push(``,`【檢驗與檢查紀錄】`),t.push(`來源共${u.length}筆；完全相同紀錄合併後${d.length}筆。若來源只有費用年月而沒有採檢日時，不得推定同月份內的先後順序。`),u.length||t.push(`未提供檢驗與檢查紀錄。`);for(let e of[...f.keys()].sort().reverse()){t.push(e);for(let n of f.get(e)??[])t.push(`- ${n.text}${n.count>1?`｜×${n.count}`:``}`)}t.push(``,`【其他來源的非空紀錄】`);let p=0;for(let[e]of o.filter(([e])=>![`medication`,`labData`].includes(e))){let n=We(i,e);if(!n.length)continue;p+=n.length;let r=Ve(n);t.push(`${ze[e]??e}（${e}）：來源${n.length}筆，完全相同紀錄合併後${r.length}筆。`),r.forEach((e,n)=>{t.push(`- ${n+1}. ${Ge(e.record)}${e.count>1?`｜×${e.count}`:``}`)})}p||t.push(`其餘來源目前沒有可列出的紀錄。`);let m=Object.keys(e).filter(e=>![`downloadType`,`userInfo`,`userInput`,`rawSources`].includes(e));if(m.length){t.push(``,`【其他根層欄位】`);for(let n of m)t.push(`${n}：${G(e[n])}`)}return t.push(``,`【資料使用限制】`),t.push(`以上為來源JSON重新排版；除合併完全相同紀錄外，未刪除不同結果，也未判定哪一筆較可信。重複筆數均以×N保留。`),t.push(`不同檢驗數值可能代表真實病程變化，也可能涉及資料品質；若有疑義，應由醫療人員結合實際採檢時間與臨床狀況確認。`),t.push(`來源未提供的日期、糖尿病類型、診斷、檢驗、用藥狀態或治療資訊不得自行補寫；歷史申報用藥不得直接描述為目前仍在使用。`),t.join(`
...
}`;function At(e,t,n){let r=mt(ht(t));return[Et(e),`【程式初步判定：可能完全沒有紀錄的核心指標（待你核對）】`,r.length?r.map(e=>`- ${e}`).join(`
...
`)}var jt=[{pattern:/最近一次|最新一筆|目前的?數值為|已(改善|惡化)|持續(上升|下降|惡化)|趨勢/,label:`聲稱時序或趨勢`},{pattern:/建議(您)?(開始|停用|停止|加|減|換|調整).{0,6}(藥|劑量|治療)|應(停用|加藥|減量)/,label:`處置建議`},{pattern:/(診斷為|確診為|罹患了|您(有|患有)).{0,10}(症|病變|症候群)/,label:`推測診斷`}],Mt=new Set([`1`,`2`,`3`,`4`,`5`,`15`,`24`,`119`,`1925`]),Nt=new Set(y.flatMap(e=>[...`${e.statement} ${e.targetValue??``} ${e.patientStatement??``}`.matchAll(/(?<![\d.])\d+(?:\.\d+)?(?![\d.])/g)].map(e=>String(Number(e[0])))));function Pt(e){let t=String(e).trim().match(/-?\d+(?:\.\d+)?/);return t?String(Number(t[0])):null}function Ft(e,t){let n=e.trim(),r=n.match(/```(?:json)?\s*([\s\S]*?)```/i),i=r?r[1].trim():n,a;try{a=JSON.parse(i)}catch{let e=i.indexOf(`{`),t=i.lastIndexOf(`}`);if(e===-1||t<=e)throw Error(`檢驗敘述器沒有回傳可解析的 JSON。`);a=JSON.parse(i.slice(e,t+1))}let o=a??{},s=String(o.narrative??``).trim(),c=String(o.short_term??``).trim(),l=String(o.mid_term??``).trim(),u=[s,c,l].filter(Boolean).join(`

`),d=(Array.isArray(o.cited_values)?o.cited_values:[]).filter(e=>!!e&&typeof e==`object`).map(e=>({item:String(e.item??``).trim(),value:String(e.value??``).trim()})).filter(e=>e.value),f=new Set;for(let e of t.labItems)for(let t of e.rawValues){let e=Pt(t);e!==null&&f.add(e)}let p=d.filter(e=>{let t=Pt(e.value);return t!==null&&!f.has(t)}),m=new Set(d.map(e=>Pt(e.value)).filter(e=>e!==null)),h=[...new Set([...u.matchAll(/(?<![\d.])\d+(?:\.\d+)?(?![\d.])/g)].map(e=>e[0]).filter(e=>{let t=Pt(e);return t!==null&&!m.has(t)&&!Mt.has(t)&&!Nt.has(t)}))],g=jt.filter(e=>e.pattern.test(u)).map(e=>e.label);return{narrative:s,shortTerm:c,midTerm:l,foundAfterAll:(Array.isArray(o.found_after_all)?o.found_after_all:[]).filter(e=>!!e&&typeof e==`object`).map(e=>({item:String(e.item??``).trim(),as:String(e.as??``).trim()})).filter(e=>e.item),unverifiedValues:p,uncitedNumbers:h,bannedPhrases:g}}function It(e){let t=[];return e.unverifiedValues.length&&t.push(`引用了來源中找不到的數值：${e.unverifiedValues.map(e=>`${e.item} ${e.value}`).join(`、`)}`),e.uncitedNumbers.length&&t.push(`文中這些數字既不在引用清單也不在指引門檻表，未經比對：${e.uncitedNumbers.join(`、`)}`),e.bannedPhrases.length&&t.push(`可能踩到禁止事項：${e.bannedPhrases.join(`、`)}`),e.foundAfterAll.length&&t.push(`程式判定為缺檢但實際存在：${e.foundAfterAll.map(e=>`${e.item}（紀錄中寫作 ${e.as}）`).join(`、`)}——項目名稱比對有漏，需修正`),t}function Lt(e){let t=[e.narrative],n=It(e);return n.length&&t.push(``,`⚠ 這一段未通過自動檢查，不可直接提供給病人：${n.join(`；`)}`),t}function Rt(e){let t=b.get(e);if(!t)throw Error(`規則不存在：${e}`);return t}function Y(e,t,n,r=!1){let i=Rt(t);return{metric:e,value:i.statement,ruleId:t,reason:n,needsClinicianConfirmation:r,citation:x(i)}}function zt(e){return e.existingComplications.filter(e=>(e.value??0)>0).map(e=>Number(e.code.slice(1)))}function Bt(e,t){let n=[],r=[],i=[],a=zt(e),o=t??a.length,s=a.includes(5),c=a.includes(2),l=a.includes(3)||e.comorbidityFlags.ckd.known&&e.comorbidityFlags.ckd.value,u=e.ageYears.known?e.ageYears.value:null,d=u!==null&&u>=65;if(!d)n.push(Y(`糖化血色素`,`hba1c-general`,u===null?`年齡未知，先套用一般成人通則`:`年齡 ${u} 歲，未達 65 歲高齡放寬條件`,u===null)),n.push(Y(`空腹血糖`,`fpg-general`,`一般成人通則`)),n.push(Y(`餐後血糖`,`ppg-general`,`一般成人通則`));else{let t=`DCSI ${e.dcsiTotal.known?e.dcsiTotal.value:`未知`}，已發生併發症 ${o} 項`;n.push({metric:`糖化血色素`,value:null,ruleId:null,reason:`年齡 ${u} 歲屬高齡，指引依健康狀態分為三級（低於 7–7.5%／低於 8.0%／不以糖化血色素為唯一目標）。健康狀態需評估共病、認知與身體機能及預期餘命，申報資料無法判定。目前可得的負擔指標：${t}。`,needsClinicianConfirmation:!0,citation:x(Rt(`hba1c-elderly-intermediate`))}),i.push(`高齡者的健康狀態分級，因此糖化血色素、空腹與餐後血糖目標都需醫療團隊定案。`)}if(e.comorbidityFlags.ckd.known&&e.comorbidityFlags.ckd.value){let e=Rt(`hba1c-unreliable`);r.push({code:`hba1c-reliability`,severity:`attention`,message:e.statement,ruleId:e.id,citation:x(e)})}s||c?(n.push(Y(`血壓`,`bp-target-intensive`,`資料顯示已有${s?`心血管`:``}${s&&c?`與`:``}${c?`腦血管`:``}疾病，屬可考慮加嚴的族群；是否可耐受需醫療團隊評估。`,!0)),d&&r.push({code:`orthostatic-risk`,severity:`attention`,message:`高齡合併心血管或腦血管疾病，降壓過於嚴格可能增加姿勢性低血壓與跌倒風險，血壓目標需個別化。`,ruleId:`bp-target-intensive`,citation:x(Rt(`bp-target-intensive`))})):n.push(Y(`血壓`,`bp-target-general`,`未見已發生的心血管或腦血管疾病，套用一般目標`)),s||c?n.push(Y(`低密度脂蛋白膽固醇`,`ldl-cvd`,`資料顯示已有心血管或腦血管疾病`)):n.push(Y(`低密度脂蛋白膽固醇`,`ldl-general`,`一般糖尿病人通則`)),n.push(Y(`高密度脂蛋白膽固醇`,`hdl-target`,e.sex.known?e.sex.value:`性別未知，兩個目標值都列出`,!e.sex.known)),n.push(Y(`三酸甘油酯`,`tg-target`,`一般糖尿病人通則`));let f=e.labItems.find(e=>/eGFR/i.test(e.itemName));return e.medicationClasses.some(e=>/抗糖尿病|metformin|雙胍/i.test(e.atcClass))&&!f&&i.push(`資料中有抗糖尿病藥物的申報紀錄，但沒有可用的 eGFR 數值，因此無法依指引判定 metformin 的腎功能安全性。`),l&&!f&&i.push(`資料標記腎臟相關問題，但沒有可用的 eGFR 或 UACR 數值可供判定追蹤頻率。`),!e.labHasDrawDates&&e.labRecordCount>0&&i.push(`檢驗資料只有費用年月、沒有採檢日，因此無法判定任何一項是否為「最近一次」，也無法建立趨勢。`),e.diabetesType.verdict!==`type1-confirmed`&&e.diabetesType.verdict!==`type2-confirmed`&&i.push(`糖尿病類型判定為 ${e.diabetesType.verdict}，不得據以套用分型專屬建議。`),{targets:n,safetyFlags:r,undetermined:i}}function Vt(e){let t=b.get(e);return t?x(t):null}function Ht(e){let t=b.get(e);return t?S(t):null}function Ut(e){let t=e.existingComplications.filter(e=>(e.value??0)>0).map(e=>Number(e.code.slice(1)));return t.includes(2)||t.includes(5)}function Wt(e,t){let n=[],r=t=>e.find(e=>e.analyte===t),i=t.ageYears.known?t.ageYears.value:null,a=i!==null&&i>=65,o=r(`HbA1c`);if(o){let e=o.max,t=e>(a?8:7);n.push({analyte:`HbA1c`,label:`糖化血色素`,worst:e,target:a?`高齡者依健康狀態分為 <7–7.5%／<8.0%／不以此為唯一目標`:`低於 7.0%`,outOfTarget:t,severity:e>=10?`urgent`:t?`attention`:`info`,clinicianMessage:t?`HbA1c 曾出現 ${e}%，超過${a?`指引高齡分級中最寬的數值門檻 8.0%（健康狀況差者不以糖化血色素為唯一目標，需醫療團隊判定）`:`一般成人目標 7.0%`}。`:`HbA1c 曾出現 ${e}%，未超過${a?`高齡分級中最寬的數值門檻 8.0%`:`一般成人目標 7.0%`}。`,patientMessage:t?`您的資料中曾出現偏高的糖化血色素（${e}%）。這是反映一段期間平均血糖的指標，請與醫療團隊確認適合您的目標值與下一步。`:null,citation:Vt(a?`hba1c-elderly-intermediate`:`hba1c-general`),citationShort:Ht(a?`hba1c-elderly-intermediate`:`hba1c-general`),targetNeedsConfirmation:a})}let s=r(`postprandial-glucose`);if(s){let e=s.max,t=e>160;n.push({analyte:`postprandial-glucose`,label:`餐後血糖`,worst:e,target:`80–160 mg/dL`,outOfTarget:t,severity:e>=250?`attention`:`info`,clinicianMessage:`Glucose PC 曾出現 ${s.min}–${s.max} mg/dL${t?`，最高超過目標上限 160`:``}。`,patientMessage:t?`您的資料中曾出現偏高的餐後血糖（最高 ${e} mg/dL）。這些紀錄沒有附檢查日期，請在回診時和醫療團隊一起看實際結果。`:null,citation:Vt(`ppg-general`),citationShort:Ht(`ppg-general`),targetNeedsConfirmation:a})}let c=r(`fasting-glucose`);if(c){let e=c.max,t=e>130;n.push({analyte:`fasting-glucose`,label:`飯前血糖`,worst:e,target:`80–130 mg/dL（高齡或多重共病可放寬至 90–150）`,outOfTarget:t,severity:e>=250?`attention`:`info`,clinicianMessage:`Glucose AC 曾出現 ${c.min}–${c.max} mg/dL${t?`，最高超過一般成人目標上限 130`:``}。`,patientMessage:t?`您的資料中曾出現偏高的飯前血糖（最高 ${e} mg/dL）。這些紀錄沒有附檢查日期，請在回診時和醫療團隊一起看實際結果。`:null,citation:Vt(`fpg-general`),citationShort:Ht(`fpg-general`),targetNeedsConfirmation:a})}let l=r(`LDL-C`);if(l){let e=Ut(t),r=e?70:100,i=l.max,a=i>r;n.push({analyte:`LDL-C`,label:`低密度脂蛋白膽固醇`,worst:i,target:`低於 ${r} mg/dL`,outOfTarget:a,severity:a?`attention`:`info`,clinicianMessage:`LDL-C 曾出現 ${i} mg/dL，目標低於 ${r}（${e?`已有心血管或腦血管疾病`:`一般糖尿病人`}）。`,patientMessage:a?`您的資料中曾出現偏高的低密度脂蛋白膽固醇（${i} mg/dL）。請與醫療團隊確認您的目標值。`:null,citation:Vt(e?`ldl-cvd`:`ldl-general`),citationShort:Ht(e?`ldl-cvd`:`ldl-general`),targetNeedsConfirmation:!1})}let u=r(`HDL-C`);if(u){let e=u.min,t=e<40,r=e<50;n.push({analyte:`HDL-C`,label:`高密度脂蛋白膽固醇`,worst:e,target:`男性高於 40、女性高於 50 mg/dL`,outOfTarget:r,severity:t?`attention`:`info`,clinicianMessage:t?`HDL-C 曾出現 ${e} mg/dL，低於男女兩種目標值。`:r?`HDL-C 曾出現 ${e} mg/dL，若為女性則低於目標（>50）；來源性別代碼意義未確認。`:`HDL-C 曾出現 ${e} mg/dL。`,patientMessage:t?`您的資料中曾出現偏低的高密度脂蛋白膽固醇（${e} mg/dL）。請與醫療團隊確認是否需要處理。`:null,citation:Vt(`hdl-target`),citationShort:Ht(`hdl-target`),targetNeedsConfirmation:!t&&r})}let d=r(`triglyceride`);if(d){let e=d.max,t=e>=150;n.push({analyte:`triglyceride`,label:`三酸甘油酯`,worst:e,target:`低於 150 mg/dL`,outOfTarget:t,severity:e>=500?`urgent`:t?`attention`:`info`,clinicianMessage:`三酸甘油酯曾出現 ${e} mg/dL${e>=500?`，達到需藥物處理的門檻`:t?`，高於目標 150`:``}。`,patientMessage:t?`您的資料中曾出現偏高的三酸甘油酯（${e} mg/dL）。請與醫療團隊確認是否需要調整。`:null,citation:Vt(`tg-target`),citationShort:Ht(`tg-target`),targetNeedsConfirmation:!1})}return n}function Gt(e){return e.filter(e=>e.outOfTarget)}var Kt={eGFR:`KIDNEY-CORE`,UACR:`KIDNEY-CORE`,creatinine:`KIDNEY-CORE`,"LDL-C":`HEART-CORE`,"HDL-C":`HEART-CORE`,triglyceride:`HEART-CORE`},qt={2:`積極照護`,1:`適度介入`,0:`日常維持`},Jt={1:`EYE-CORE`,2:`STROKE-CORE`,3:`KIDNEY-CORE`,4:`NERVE-CORE`,5:`HEART-CORE`,6:`LEG-CIRCULATION-CORE`},Yt={1:`視網膜病變`,2:`腦血管疾病`,3:`腎臟病變`,4:`神經病變`,5:`心血管疾病`,6:`周邊血管疾病`,7:`代謝性急症`};function Xt(e){let t=[],n=e.comorbidityFlags.ckd,r=n.known&&n.value,i=e.ckdIcdCodes;for(let n=1;n<=6;n+=1){let a=e.existingComplications.find(e=>e.code===`R${n}`),o=e.riskPredictions.find(e=>e.code===`PR${n}`),s=!!a?.present,c=s?a?.value??null:null,l=o?.present?o.value:null,u={topic:n,topicName:Yt[n],moduleId:Jt[n],rValue:c,prValue:l};if(c!==null&&c>0){t.push({...u,kind:`established`,reason:`R${n}=${c}，屬已發生的併發症現況。`});continue}if(n===3&&(r||i.length>0)){let e=r?`來源 CKD 欄位為 1`:`申報診斷碼出現慢性腎臟病（${i.join(`、`)}）`;t.push({...u,kind:`established`,reason:`${e}，即使 R3${s?`=${c}`:` 缺值`} 也以已發生處理。`});continue}if(l===2){t.push({...u,kind:`prevention-active`,reason:`來源以 PR${n}=2（${qt[2]}）呈現、未輸出 R${n}，依資料模型代表尚未發生；納入預防內容。`});continue}if(l===1){t.push({...u,kind:`prevention-moderate`,reason:`PR${n}=1（${qt[1]}），尚未發生；納入預防內容。`});continue}if(l===0){t.push({...u,kind:`excluded`,reason:`PR${n}=0（${qt[0]}），維持既有照護即可，不納入主題內容。`});continue}t.push({...u,kind:`excluded`,reason:`來源同時未提供 R${n} 與 PR${n}，無從判斷是否發生，不得補值，因此不納入。`})}return t}var Zt=`你是糖尿病衛教報告的輔助判讀器。
...
}`;function Qt(e){let t=e.trim(),n=t.match(/```(?:json)?\s*([\s\S]*?)```/i),r=n?n[1].trim():t,i;try{i=JSON.parse(r)}catch{let e=r.indexOf(`{`),t=r.lastIndexOf(`}`);if(e===-1||t<=e)throw Error(`輔助判讀器沒有回傳可解析的 JSON。`);i=JSON.parse(r.slice(e,t+1))}if(!i||typeof i!=`object`)throw Error(`輔助判讀器回傳的不是 JSON 物件。`);let a=i,o=e=>Array.isArray(e)?e.filter(e=>typeof e==`string`).map(String):[],s=a.echo??null,c=e=>typeof e==`number`&&Number.isFinite(e)?e:null;return{echo:s?{ageYears:c(s.age_years),dcsi:c(s.dcsi)}:null,priorities:(Array.isArray(a.priorities)?a.priorities:[]).filter(e=>!!e&&typeof e==`object`).map(e=>({module_id:String(e.module_id??``).trim(),why:String(e.why??``).trim()})).filter(e=>e.module_id),clinician_notes:o(a.clinician_notes),data_concerns:o(a.data_concerns),disagreements:(Array.isArray(a.disagreements)?a.disagreements:[]).filter(e=>!!e&&typeof e==`object`).map(e=>({topic:String(e.topic??``).trim(),program_decision:String(e.program_decision??``).trim(),your_view:String(e.your_view??``).trim()})).filter(e=>e.topic)}}function $t(e,t){let n=Xt(t),r=n.filter(e=>e.kind===`established`).sort((e,t)=>(t.rValue??0)-(e.rValue??0)||e.topic-t.topic),i=n.filter(e=>e.kind===`prevention-active`).sort((e,t)=>e.topic-t.topic),a=n.filter(e=>e.kind===`prevention-moderate`).sort((e,t)=>e.topic-t.topic),o=t.diabetesType.verdict===`type1-confirmed`?`T1`:t.diabetesType.verdict===`type2-confirmed`?`T2`:null,s={"EYE-CORE":`EYE`,"KIDNEY-CORE":`KIDNEY`,"NERVE-CORE":`NERVE`},c=[];for(let e of[...r,...i,...a]){c.push(e.moduleId);let t=s[e.moduleId];o&&t&&g.has(`${t}-${o}`)&&c.push(`${t}-${o}`)}let l=[`BASE-01`],u=t.diabetesType.verdict;(u===`conflicting`||u===`absent`)&&l.push(`TYPE-UNCLEAR`),l.push(...c),(c.includes(`NERVE-CORE`)||c.includes(`LEG-CIRCULATION-CORE`))&&l.push(`BASE-02`);let d=ht(t),f=St(d,t),p=dt(d),m=E(t,r.length,p),h=new Set([...l,...m.moduleIds,...a.map(e=>e.moduleId)]),_=(e?.priorities??[]).map(e=>e.module_id).filter(e=>!h.has(e)),v=new Set;for(let e of c)for(let t of g.get(e)?.needsShared??[])v.add(t);let y=D.filter(e=>e.appliesWhen===`always`||v.has(e.appliesWhen)).map(e=>e.id),b=[];for(let e of c){let t=g.get(e)?.urgentSigns;t&&!b.includes(t)&&b.push(t)}for(let e of m.moduleIds){let t=T.get(e)?.urgentSigns;t&&!b.includes(t)&&b.push(t)}let x=[...r,...i].map(e=>e.topic),S=Wt(d,t),C={},w={},ee=new Set;for(let e of d){let t=Kt[e.analyte];if(!t||!c.includes(t))continue;let n=vt(e);(C[t]??=[]).push(n),(w[t]??=[]).push({text:n,messages:[...f.filter(t=>t.analyte===e.analyte&&t.patientMessage).map(e=>e.patientMessage),...S.filter(t=>t.analyte===e.analyte&&t.outOfTarget&&t.patientMessage).map(e=>e.patientMessage)]}),ee.add(e.analyte)}let O={},te=new Set(d.map(e=>e.analyte));for(let[e,t]of Object.entries(tn)){if(!c.includes(e))continue;let n=t.filter(e=>!te.has(e.analyte)).map(e=>e.label);n.length&&(O[e]=n)}let re=null;if(t.medicationDateRange.known&&t.reportDate.known){let e=Date.parse(`${t.medicationDateRange.value.latest}T00:00:00Z`),n=Date.parse(`${t.reportDate.value}T00:00:00Z`);Number.isFinite(e)&&Number.isFinite(n)&&(re=Math.round((n-e)/864e5))}return{decisions:n,topicModuleIds:c,moderateTopics:a,selfCareModuleIds:m.moduleIds,selfCareReasons:m.reasons,medicationIngredients:t.medicationIngredients,patientModuleIds:l,targets:Bt(t,r.length),selection:e,rejectedPriorities:_,labNotes:d.filter(e=>!ee.has(e.analyte)).map(vt),labNotesForClinician:d.map(yt),labPatientMessages:f.map(e=>e.patientMessage).filter(e=>!!e),labNoteEntries:d.filter(e=>!ee.has(e.analyte)).map(e=>{let t=f.filter(t=>t.analyte===e.analyte&&t.patientMessage),n=S.filter(t=>t.analyte===e.analyte&&t.outOfTarget&&t.patientMessage),r=[...t.map(e=>e.patientMessage),...n.map(e=>e.patientMessage)];return{text:vt(e),messages:r,rank:t.some(e=>e.severity===`urgent`)?0:r.length?1:2}}).sort((e,t)=>e.rank-t.rank).map(({text:e,messages:t})=>({text:e,messages:t})),labThresholds:f,sharedBlockIds:y,targetComparisons:S,labByModule:C,labEntriesByModule:w,missingByModule:O,medicationLabGapDays:re,evaluatedAnalytes:d.length,evaluatedAnalyteKeys:d.map(e=>e.analyte),unevaluatedNumericItems:t.labItems.filter(e=>e.rawValues.some(e=>/^[≧≥><＞＜]?\s*\d/.test(e.trim()))).length-d.length,followUp:ne(x,{kidneyIntensive:f.some(e=>e.code===`kidney-intensive-followup`)}),urgentSigns:b}}function en(e=!1){let t=e?[`※ 本報告的「觀察摘要」「短期建議」「中期目標」三段由模型直接撰寫，未經醫療團隊逐句核准；數值已由程式逐一比對來源，目標值取自指引門檻表。`]:[];return[`※ DRAFT｜衛教模組 ${m}／自我照護模組 ${C}／指引門檻表 ${_} 均尚未經醫療團隊核准，僅供流程比較，不得提供給病人。`,...t,``]}var tn={"KIDNEY-CORE":[{analyte:`UACR`,label:`尿液白蛋白／肌酸酐比值（UACR）`},{analyte:`creatinine`,label:`血清肌酸酐`},{analyte:`eGFR`,label:`腎絲球過濾率（eGFR）`}]},nn={urgent:`優先核實`,attention:`留意`,info:`參考`};function X(e,t){e.push(`────────────────────────────────`,`【${t}】`,``)}function rn(e,t){let n=[...en(!!t.labNarrative)];n.push(`糖尿病衛教報告`),n.push(`報告產生日期：${t.reportDate??`未提供`}`),n.push(`資料截至日期：${t.dataCutoff??`未提供`}`),n.push(``);let r=new Map(e.decisions.map(e=>[e.moduleId,e])),i=!t.labNarrative,a=(t,r=``,a=[])=>{let o=g.get(t);if(!o)return;n.push(`◆ ${o.title}${r}`,``),n.push(o.patientText,``);for(let e of a)n.push(e,``);let s=i?e.labEntriesByModule[t]:void 0;s?.length&&(n.push(`您的${o.title}相關數值：`,``),s.forEach(e=>{n.push(`・${e.text}`);for(let t of e.messages)n.push(`   ${t}`)}),n.push(``));let c=i?e.missingByModule[t]:void 0;c?.length&&n.push(`您的資料中沒有${c.join(`、`)}的紀錄。回診時可以確認是否需要安排。`,``)};for(let t of[`BASE-01`,`TYPE-UNCLEAR`])e.patientModuleIds.includes(t)&&a(t);(e.labNotes.length>0||Object.keys(e.labByModule).length>0)&&n.push(`以下提到的檢驗數值都來自健保申報紀錄。這些紀錄只有費用年月、沒有檢查日期，因此無法確認先後順序，也無法確認哪一筆最新。`,``);let o=e.patientModuleIds.filter(e=>![`BASE-01`,`TYPE-UNCLEAR`].includes(e)),s=[];for(let e of[`established`,`prevention-active`,`prevention-moderate`])for(let t of o){if(/-T[12]$/.test(t))continue;let n=r.get(t),i=n?null:o.find(e=>r.get(e)&&t.startsWith(e.split(`-`)[0]));(n?.kind??(i?r.get(i)?.kind:void 0))===e&&s.push(t)}if(t.labNarrative)X(n,`觀察摘要：您的檢驗數值`),n.push(...Lt(t.labNarrative),``);else{let t=new Set([...e.labNoteEntries.flatMap(e=>e.messages),...Object.values(e.labEntriesByModule).flatMap(e=>e.flatMap(e=>e.messages))]),r=[...e.labPatientMessages.filter(e=>!t.has(e)),...Gt(e.targetComparisons).map(e=>e.patientMessage).filter(e=>!!e).filter(e=>!t.has(e))];if(e.labNoteEntries.length||r.length){X(n,`觀察摘要：您的其他檢驗數值`),e.labNoteEntries.forEach(e=>{n.push(`・${e.text}`);for(let t of e.messages)n.push(`   ${t}`)}),e.labNoteEntries.length&&n.push(``);for(let e of r)n.push(e,``)}}t.labNarrative?.shortTerm&&(X(n,`短期建議：這一兩週可以開始做的事`),n.push(t.labNarrative.shortTerm,``));let c=e.targets.targets.filter(e=>e.value&&!e.needsClinicianConfirmation);if(t.labNarrative?.midTerm||c.length||e.followUp.text){if(X(n,`中期目標：下一階段要達到的數字`),t.labNarrative?.midTerm)n.push(t.labNarrative.midTerm,``);else if(c.length){n.push(`以下是依中華民國糖尿病學會指引、對照您的狀況推出的控制目標。實際數字仍以醫療團隊的評估為準。`,``);for(let e of c){let t=e.ruleId?b.get(e.ruleId):void 0;n.push(`◆ ${e.metric}：${t?.patientStatement??e.value}`,``)}}!t.labNarrative?.midTerm&&e.followUp.text&&(n.push(`下次檢查的建議時間：`,``),n.push(e.followUp.text,``))}if(s.length){let e=s.some(e=>{let t=r.get(e)??r.get(o.find(t=>e.startsWith(t.split(`-`)[0]))??``);return t?.kind===`prevention-active`||t?.kind===`prevention-moderate`});X(n,`併發症風險：與您有關的健康重點`),n.push(`以下項目是依您的健康紀錄挑選出來，建議您特別注意。如果您不確定自己是否有相關診斷，請在回診時向醫療團隊確認。`,...e?[`其中有些項目來自風險評估而不是診斷，列出來是為了提早注意，不代表您已經有這個疾病。`]:[],``);for(let e of s)a(e,``,o.filter(t=>/-T[12]$/.test(t)&&t.split(`-`)[0]===e.split(`-`)[0]).map(e=>g.get(e)?.patientText).filter(e=>!!e))}if(e.sharedBlockIds.length||e.selfCareModuleIds.length){X(n,`預防叮嚀：日常照護`);for(let t of e.sharedBlockIds){let e=D.find(e=>e.id===t);e&&(n.push(`◆ ${e.title}`,``),n.push(e.text,``))}let t=e.decisions.some(e=>e.kind===`established`&&(e.topic===3||e.topic===5)),r=e.medicationIngredients.join(` `),i={"kidney-or-heart":t,"sick-day-hold-drugs":/metformin|雙胍|gliflozin/i.test(r),sglt2:/gliflozin/i.test(r)};for(let t of e.selfCareModuleIds){let e=T.get(t);if(!e)continue;let r=e.patientText,a=!1;for(let t of e.definiteVariants??[])i[t.when]&&(r=r.replace(t.from,t.to),a=!0);a&&(r=an(r)),n.push(`◆ ${e.title}`,``),n.push(r,``)}}if(e.urgentSigns.length){X(n,`什麼情況要立刻就醫`);let t=e=>/119/.test(e)&&!/儘速就醫|當天/.test(e),r=[[`立即撥打 119`,e.urgentSigns.filter(t)],[`儘速就醫`,e.urgentSigns.filter(e=>!t(e))]];for(let[e,t]of r)t.length&&(n.push(`◆ ${e}`,``),t.forEach((e,t)=>n.push(`${t+1}. ${e}`,``)))}return n.join(`
`).trimEnd()}function an(e){let t=0;return e.split(`
`).map(e=>/^\d+\.\s/.test(e)?e.replace(/^\d+\.\s/,`${++t}. `):e).join(`
`)}var on={"type1-confirmed":`診斷碼指向第 1 型`,"type2-confirmed":`第 2 型`,conflicting:`⚠ 第 1 型與第 2 型診斷碼並存`,absent:`資料中無糖尿病診斷碼`};function sn(e,t,n){let r=[...en()];r.push(`【AI 醫療人員報告】`),r.push(`報告產生日期：${n.reportDate??`未提供`}`),r.push(`資料截至日期：${n.dataCutoff??`未提供`}`),r.push(`年齡：${t.ageYears.known?`${t.ageYears.value} 歲`:`未提供`}｜性別：${t.sex.known?t.sex.value:`未提供`}｜糖尿病病程：${t.diabetesDurationYears.known?`${t.diabetesDurationYears.value} 年`:`未提供`}`),r.push(``);let i=[`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`],a=0,o=e=>`${i[a++]}、${e}`;r.push(o(`併發症現況與風險預測`)),r.push(`DCSI 總分：${t.dcsiTotal.known?t.dcsiTotal.value:`來源未提供`}`);let s=new Map(t.existingComplications.map(e=>[e.code.slice(1),e])),c=new Map(t.riskPredictions.map(e=>[e.code.slice(2),e])),l=new Map(e.decisions.map(e=>[String(e.topic),e.kind])),u=Object.keys(Yt).map(Number).sort((e,t)=>e-t),d=Math.max(...u.map(e=>Yt[e].length));for(let e of u){let t=String(e),n=s.get(t),i=c.get(t),a;a=n?.present?`已發生（嚴重度 ${n.rawValue}）`:l.get(t)===`established`?`已發生（依來源 CKD 註記；本項未輸出嚴重度）`:i?.present&&i.value!==null?`未發生｜風險預測：${qt[i.value]??`未定義分級`}`:`來源未提供現況與風險預測`,r.push(`  ${Yt[e].padEnd(d,`　`)}  ${a}`)}if(r.push(`  （來源對每一項只輸出其一：已發生者給嚴重度分數，未發生者給風險預測。）`),r.push(``),t.diabetesType.verdict!==`type2-confirmed`){r.push(o(`糖尿病類型`)),r.push(`  ${on[t.diabetesType.verdict]}｜${t.diabetesType.note}`);let e=[...t.diabetesType.type1IcdCodes,...t.diabetesType.type2IcdCodes];e.length&&r.push(`  相關診斷碼：${e.join(`、`)}`),r.push(``)}let f={血壓:`BP`,低密度脂蛋白膽固醇:`LDL-C`,高密度脂蛋白膽固醇:`HDL-C`,三酸甘油酯:`TG`,糖化血色素:`HbA1c`,空腹血糖:`Glucose AC`,餐後血糖:`Glucose PC`},p=e.targets.targets.filter(e=>e.value);if(p.length){r.push(`${o(`依指引推導的個別化目標`)}　來源：${v}`);for(let e of p){let t=e.ruleId?b.get(e.ruleId):void 0;r.push(`  ${f[e.metric]??e.metric}：${t?.targetValue??e.value}${t?`　〔${S(t)}〕`:``}`)}r.push(``)}e.followUp.rules.length&&(r.push(o(`依指引的追蹤間隔`)),r.push(...oe(e.followUp.rules)),r.push(``));let m=e.selection?.disagreements??[],h=Gt(e.targetComparisons);if(e.targets.safetyFlags.length||e.labThresholds.length||h.length||m.length){r.push(o(`需核實的檢驗結果`));let t={urgent:0,attention:1,info:2},n=[];for(let e of h)n.push({severity:e.severity,text:`${e.clinicianMessage}${e.citationShort?`　〔${e.citationShort}〕`:``}`});for(let t of e.labThresholds){let e=t.ruleId?b.get(t.ruleId):void 0;n.push({severity:t.severity,text:`${t.clinicianMessage}${e?`　〔${S(e)}〕`:``}`})}let i=e.labThresholds.some(e=>e.code===`hba1c-unreliable`||e.code===`hba1c-missing`)?new Set([`hba1c-reliability`]):new Set;for(let t of e.targets.safetyFlags){if(i.has(t.code))continue;let e=t.ruleId?b.get(t.ruleId):void 0;n.push({severity:t.severity,text:`${t.message}${e?`　〔${S(e)}〕`:``}`})}n.sort((e,n)=>t[e.severity]-t[n.severity]);for(let e of n)r.push(`  [${nn[e.severity]}] ${e.text}`);for(let e of m)r.push(`  [異議] ${e.topic}｜程式：${e.program_decision}`),r.push(`    LLM：${e.your_view}`);r.push(``)}if(e.labNotesForClinician.length||n.labReview){if(r.push(o(`檢驗結果`)),e.labNotesForClinician.length){r.push(`  依指引門檻表逐條判定的核心指標：`);for(let t of e.labNotesForClinician)r.push(`  ${t}`)}n.labReview&&r.push(Ot(n.labReview,new Set(e.evaluatedAnalyteKeys))),r.push(``)}return r.join(`
`).trimEnd()}function cn(e){let t=[`【程式已完成的主題判定（不可更改）】`];for(let n of e.decisions){let e=n.kind===`established`?`已納入・已發生`:n.kind===`prevention-active`?`已納入・積極照護`:n.kind===`prevention-moderate`?`已納入・適度介入`:`未納入`;t.push(`${n.moduleId}（R${n.topic} ${n.topicName}）：${e}｜${n.reason}`)}t.push(``,`【程式已納入的自我照護模組】`);for(let n of e.selfCareModuleIds)t.push(`${n}：${e.selfCareReasons[n]??``}`);t.push(``,`【程式推導的個別化目標】`);for(let n of e.targets.targets)t.push(`${n.metric}：${n.value??`需醫療團隊定案`}（${n.reason}）`);if(e.targets.undetermined.length){t.push(``,`【資料不足無法判定】`);for(let n of e.targets.undetermined)t.push(`- ${n}`)}return t.join(`
`)}function Z(e){return{known:!0,value:e}}function Q(e){return{known:!1,reason:e}}var ln=/^(E1[0-4]2|N0[0-8]|N1[89]|N2[5-8]|Z940|Z992|Z49)/i,un=/^E10/i,dn=/^E11/i,fn=/^E1[234]/i;function pn(e){if(e==null||e===``)return null;let t=Number(String(e).trim());return Number.isFinite(t)?t:null}function mn(e){if(e==null)return null;let t=String(e).trim().replaceAll(`/`,`-`);return/^\d{4}-\d{2}-\d{2}$/.test(t)?t:null}function hn(e,t){let n=Date.parse(`${e}T00:00:00Z`),r=Date.parse(`${t}T00:00:00Z`);return!Number.isFinite(n)||!Number.isFinite(r)?null:Math.round((r-n)/864e5)}function gn(e,t){let n=pn(e);return n===null?Q(`來源未提供 ${t} 欄位`):Z(n===1)}function _n(e,t){let n=[];for(let r=1;r<=7;r+=1){let i=`${t}${r}`,a=Object.hasOwn(e,i),o=a?e[i]:null;n.push({code:i,present:a,value:a?pn(o):null,rawValue:a&&o!=null?String(o):null})}return n}function vn(e){let t=new Set,n=new Set,r=new Set;for(let i of e){if(!W(i))continue;let e=String(i.icd_code??``).trim();e&&(un.test(e)?t.add(e):dn.test(e)?n.add(e):fn.test(e)&&r.add(e))}let i=[...t].sort(),a=[...n].sort(),o=[...r].sort();return i.length&&a.length?{verdict:`conflicting`,type1IcdCodes:i,type2IcdCodes:a,otherDiabetesIcdCodes:o,note:`申報資料同時出現第一型與第二型糖尿病診斷碼，無法據此判定類型；不得啟用任何 T1／T2 補充模組。`}:i.length?{verdict:`type1-confirmed`,type1IcdCodes:i,type2IcdCodes:[],otherDiabetesIcdCodes:o,note:`申報資料只出現第一型糖尿病診斷碼。注意申報診斷碼是計費用途，仍應由醫療團隊確認。`}:a.length?{verdict:`type2-confirmed`,type1IcdCodes:[],type2IcdCodes:a,otherDiabetesIcdCodes:o,note:`申報資料只出現第二型糖尿病診斷碼。注意申報診斷碼是計費用途，仍應由醫療團隊確認。`}:{verdict:`absent`,type1IcdCodes:[],type2IcdCodes:[],otherDiabetesIcdCodes:o,note:`申報用藥紀錄中沒有 E10／E11 糖尿病診斷碼，無法判定類型。`}}function yn(e,t){let n=new Map,r=[];for(let t of e){if(!W(t))continue;let e=String(t.drug_atc5_name??``).trim()||`未分類或來源未提供分類`,i=String(t.drug_ename??``).trim(),a=mn(t.drug_date);a&&r.push(a);let o=n.get(e)??{names:new Set,count:0,dates:[]};i&&o.names.add(i),o.count+=1,a&&o.dates.push(a),n.set(e,o)}let i=[...n.entries()].map(([e,n])=>{let r=[...n.dates].sort(),i=r.length?r[r.length-1]:null;return{atcClass:e,drugNames:[...n.names].sort().slice(0,8),recordCount:n.count,lastClaimDate:i,daysSinceLastClaim:i&&t?hn(i,t):null}}).sort((e,t)=>e.lastClaimDate&&t.lastClaimDate&&e.lastClaimDate!==t.lastClaimDate?t.lastClaimDate.localeCompare(e.lastClaimDate):t.recordCount-e.recordCount),a=r.sort();return{classes:i,dateRange:a.length?Z({earliest:a[0],latest:a[a.length-1]}):Q(`用藥紀錄沒有可解析的日期`)}}function bn(e){let t=new Map,n=!1;for(let r of e){if(!W(r))continue;(mn(r.assay_date)||mn(r.inspect_date))&&(n=!0);let e=String(r.assay_item_name??``).trim()||String(r.order_name??``).trim()||`未提供項目名稱`,i=String(r.assay_value??``).trim();if(!i)continue;let a=`${e}｜${String(r.unit_data??``).trim()}｜${String(r.order_code??``).trim()}`,o=t.get(a)??{values:[],units:new Set,refs:new Set,months:new Set,codes:new Set},s=String(r.order_code??``).trim();s&&o.codes.add(s),o.values.push(i);let c=String(r.unit_data??``).trim();c&&c!==`null`&&o.units.add(c);let l=String(r.consult_value??``).trim();l&&l!==`null`&&o.refs.add(l);let u=String(r.fee_ym??``).trim();u&&o.months.add(u),t.set(a,o)}return{items:[...t.entries()].map(([e,t])=>({itemName:e.split(`｜`)[0],orderCodes:[...t.codes].sort(),rawValues:t.values,unit:t.units.size===1?[...t.units][0]:t.units.size>1?[...t.units].join(` / `):null,referenceRange:t.refs.size?[...t.refs][0]:null,feeMonths:[...t.months].sort(),hasDrawDates:n})).sort((e,t)=>t.rawValues.length-e.rawValues.length),hasDrawDates:n}}function xn(e){let t=W(e)?e:{},n=W(t.userInput)?t.userInput:{},r=W(t.rawSources)?t.rawSources:{},i=mn(n.REPORT_DATE),a=mn(n.BIRTHDAY),o=mn(n.INDX_DATE),s=a&&i?hn(a,i):null,c=pn(n.T),l=We(r,`medication`),u=We(r,`labData`),{classes:d,dateRange:f}=yn(l,i),{items:p,hasDrawDates:m}=bn(u),h=[];!m&&u.length&&h.push(`檢驗紀錄只有費用年月、沒有採檢日期，因此無法建立時間順序或趨勢。任何「趨勢」「最近一次」的敘述都沒有資料支持。`),i||h.push(`來源未提供 REPORT_DATE，無法標示資料截止日。`);let g=_n(n,`R`),_=_n(n,`PR`),v=[...g,..._].filter(e=>!e.present).map(e=>e.code);v.length&&h.push(`來源未出現下列欄位，不得補值也不得視為 0：${v.join(`、`)}。`);let y=vn(l);y.verdict===`conflicting`&&h.push(y.note);let b=String((W(t.userInfo)?t.userInfo.gender:``)??``).trim().toUpperCase(),x=b===`M`||b===`男`?`男性`:b===`F`||b===`女`?`女性`:null;return{reportDate:i?Z(i):Q(`來源未提供 REPORT_DATE`),dataCutoff:i?Z(i):Q(`來源未提供資料截止日`),birthday:a?Z(a):Q(`來源未提供 BIRTHDAY`),ageYears:s===null?Q(`缺少出生日期或報告日期，無法計算年齡`):Z(Math.floor(s/365.25)),sexCode:n.SEX!==void 0&&n.SEX!==null&&n.SEX!==``?Z(String(n.SEX)):Q(`來源未提供 SEX`),sex:x?Z(x):Q(`userInfo.gender 未提供或無法解讀`),diabetesOnsetDate:o?Z(o):Q(`來源未提供 INDX_DATE`),diabetesDurationYears:c===null?Q(`來源未提供 T`):Z(Number(c.toFixed(1))),ckdIcdCodes:[...new Set(l.map(e=>W(e)?String(e.icd_code??``).trim():``).filter(e=>e&&ln.test(e.replace(/\./g,``))))].sort(),comorbidityFlags:{hypertension:gn(n.HT,`HT`),hyperlipidemia:gn(n.HL,`HL`),ckd:gn(n.CKD,`CKD`),p4p:gn(n.P4P,`P4P`)},dcsiTotal:pn(n.DCSI)===null?Q(`來源未提供 DCSI`):Z(pn(n.DCSI)),grade:n.GRADE===void 0?Q(`來源未提供 GRADE`):Z(String(n.GRADE)),ageGroup:n.AGEGP===void 0?Q(`來源未提供 AGEGP`):Z(String(n.AGEGP)),existingComplications:g,riskPredictions:_,diabetesType:y,medicationIngredients:[...new Set(l.map(e=>W(e)?String(e.drug_ing_name??``).trim():``).filter(Boolean))].sort(),medicationClasses:d,medicationRecordCount:l.length,medicationDateRange:f,labItems:p,labRecordCount:u.length,labHasDrawDates:m,dataQualityFlags:h}}function $(e,t){return e.known?t?t(e.value):String(e.value):`未知（${e.reason}）`}function Sn(e,t={}){let n=t.maxMedicationClasses??25,r=[];r.push(`【基本判斷依據】`),r.push(`報告日期：${$(e.reportDate)}`),r.push(`年齡：${$(e.ageYears,e=>`${e} 歲`)}`),r.push(`性別：${e.sex.known?e.sex.value:$(e.sex)}`),r.push(`糖尿病病程年數：${$(e.diabetesDurationYears,e=>`${e} 年`)}`),r.push(`DCSI 總分：${$(e.dcsiTotal)}`),r.push(`高血壓：${$(e.comorbidityFlags.hypertension,e=>e?`是`:`否`)}`),r.push(`高血脂：${$(e.comorbidityFlags.hyperlipidemia,e=>e?`是`:`否`)}`),r.push(`慢性腎臟病：${$(e.comorbidityFlags.ckd,e=>e?`是`:`否`)}`),r.push(``,`【已發生併發症現況（R）】`);for(let t of e.existingComplications)r.push(`${t.code}：${t.present?`${t.rawValue}`:`來源未出現此欄位（不得視為 0）`}`);r.push(``,`【未來風險預測（PR）】`);for(let t of e.riskPredictions)r.push(`${t.code}：${t.present?`${t.rawValue}`:`來源未出現此欄位（不得視為 0）`}`);r.push(``,`【糖尿病類型證據】`),r.push(`判定：${e.diabetesType.verdict}`),r.push(`第一型診斷碼：${e.diabetesType.type1IcdCodes.join(`、`)||`無`}`),r.push(`第二型診斷碼：${e.diabetesType.type2IcdCodes.join(`、`)||`無`}`),r.push(`說明：${e.diabetesType.note}`),r.push(``,`【用藥申報分類（非目前用藥）】`),r.push(`共 ${e.medicationRecordCount} 筆申報紀錄，涵蓋 ${e.medicationClasses.length} 個 ATC 分類。以下為最近申報的前 ${Math.min(n,e.medicationClasses.length)} 類。`);for(let t of e.medicationClasses.slice(0,n)){let e=t.lastClaimDate?`最後申報 ${t.lastClaimDate}${t.daysSinceLastClaim===null?``:`（距報告日 ${t.daysSinceLastClaim} 天）`}`:`來源無日期`;r.push(`- ${t.atcClass}｜${t.recordCount} 筆｜${e}`)}if(r.push(``,`【檢驗資料可用性】`),r.push(`共 ${e.labRecordCount} 筆；是否有採檢日：${e.labHasDrawDates?`有`:`沒有，只有費用年月`}`),e.dataQualityFlags.length){r.push(``,`【資料限制】`);for(let t of e.dataQualityFlags)r.push(`- ${t}`)}return r.join(`
`)}var Cn=5*1024*1024,wn=`gemini-3.6-flash`,Tn=`__custom__`,En=`dmEducationGeminiTransientCredential2026`,Dn=15,On=[{value:`gemini-3.6-flash`,label:`Gemini 3.6 Flash｜預設・較高品質`},{value:`gemini-3.5-flash-lite`,label:`Gemini 3.5 Flash-Lite｜較快・較低成本`},{value:Tn,label:`自訂模型 ID`}],kn=[{id:`selector`,label:`① 模組挑選`,role:`只回模組代碼、優先序與異議。它寫的任何文字都不會出現在報告裡。`,text:Zt},{id:`labReview`,label:`② 檢驗判讀`,role:`讀原始檢驗紀錄判斷異常，結果進醫師版。程式逐一比對它引用的每一個數值。`,text:Ct},{id:`narrative`,label:`③ 檢驗敘述`,role:`寫觀察摘要、短期建議、中期目標三段。這是報告中唯一未經逐句核准的文字。`,text:kt}],An={ingest:[{label:`format-patient.ts — formatPatientJson()`,text:H(R,[`formatPatientJson`],`format-patient.ts`)},{label:`patient-facts.ts — extractPatientFacts()`,text:H(z,[`extractPatientFacts`],`patient-facts.ts`)}],decide:[{label:`module-plan.ts — decideTopics()`,text:H(B,[`decideTopics`],`module-plan.ts`)},{label:`module-plan.ts — resolvePlan()`,text:H(B,[`resolvePlan`],`module-plan.ts`)}],selector:[{label:`module-plan.ts — parseModuleSelection()`,text:H(B,[`parseModuleSelection`],`module-plan.ts`)}],labReview:[{label:`lab-llm.ts — parseLabReview()`,text:H(ke,[`parseLabReview`],`lab-llm.ts`)}],narrative:[{label:`lab-narrative.ts — parseLabNarrative()`,text:H(V,[`parseLabNarrative`],`lab-narrative.ts`)}],assemble:[{label:`lab-narrative.ts — formatLabNarrative()（把核實結果就地標示）`,text:H(V,[`formatLabNarrative`],`lab-narrative.ts`)},{label:`module-plan.ts — assemblePatientReport()`,text:H(B,[`assemblePatientReport`],`module-plan.ts`)},{label:`module-plan.ts — assembleClinicianReport()`,text:H(B,[`assembleClinicianReport`],`module-plan.ts`)},{label:`validate-report.ts — validateReport()`,text:H(Ae,[`validateReport`],`validate-report.ts`)}]},jn=[{id:`patient`,label:`病人版衛教報告`,filename:`病人版衛教報告.txt`,note:`併發症風險與預防叮嚀逐字來自固定模組；觀察摘要、短期建議、中期目標三段由模型撰寫。`},{id:`clinician`,label:`醫師版報告`,filename:`醫師版報告.txt`,note:`由固定模組組裝，附指引章表與頁次。`},{id:`rawSelector`,label:`① 原始回應`,filename:`原始回應-模組挑選.txt`,note:`模組挑選的完整回應，未解析。它的意見改不了程式的主題判定，僅供核對。`},{id:`rawLabReview`,label:`② 原始回應`,filename:`原始回應-檢驗判讀.txt`,note:`檢驗判讀的完整回應，未解析。報告中只採用通過數值比對的部分。`},{id:`rawNarrative`,label:`③ 原始回應`,filename:`原始回應-檢驗敘述.txt`,note:`檢驗敘述的完整回應，未解析。報告中的版本已經過數值比對與禁止事項掃描。`}],Mn=`{
...
}`;function Nn(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,i.click(),URL.revokeObjectURL(r)}function Pn({blockers:e}){return e.length?(0,k.jsxs)(`div`,{className:`blockerList`,role:`status`,children:[(0,k.jsx)(`strong`,{children:`目前不能執行的原因`}),(0,k.jsx)(`ul`,{children:e.map(e=>(0,k.jsxs)(`li`,{className:e.hard?`hard`:`soft`,children:[(0,k.jsx)(`span`,{className:`blockerMessage`,children:e.message}),(0,k.jsx)(`span`,{className:`blockerFix`,children:e.howToFix})]},e.code))})]}):null}function Fn({input:e}){let t=e.totalTokens>Ce,n=Math.min(999,Math.round(e.totalTokens/Ce*100));return(0,k.jsxs)(`details`,{className:`compositionPanel`,children:[(0,k.jsxs)(`summary`,{children:[`三次呼叫合計送出：約 `,N(e.totalTokens),` tokens（`,N(e.totalChars),` 字）`,(0,k.jsxs)(`span`,{className:t?`limitBadge over`:`limitBadge`,children:[`模型上限的 `,n,`%`]})]}),(0,k.jsx)(`table`,{children:(0,k.jsx)(`tbody`,{children:e.parts.map(e=>(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:e.label}),(0,k.jsxs)(`td`,{children:[N(e.chars),` 字`]}),(0,k.jsxs)(`td`,{children:[`約 `,N(e.tokens),` tokens`,(0,k.jsx)(`em`,{children:`估算`})]})]},e.label))})}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`②③ 讀的是同一份檢驗紀錄，重複的部分在這裡看得見。本工具在任何情況下都不會自動截斷病人資料。`})]})}function In(){let[e,t]=(0,r.useState)(``),[n,a]=(0,r.useState)(``),[o,s]=(0,r.useState)(`raw`),[c,l]=(0,r.useState)(``),[u,d]=(0,r.useState)(!1),[f,p]=(0,r.useState)(wn),[h,g]=(0,r.useState)(``),[y,x]=(0,r.useState)(Dn),[S,w]=(0,r.useState)(`patient`),[T,E]=(0,r.useState)(``),[D,ee]=(0,r.useState)(``),[O,te]=(0,r.useState)({}),[ne,re]=(0,r.useState)({selector:`idle`,labReview:`idle`,narrative:`idle`}),[ie,ae]=(0,r.useState)({}),[oe,se]=(0,r.useState)([]),[ce,le]=(0,r.useState)(`idle`),[ue,de]=(0,r.useState)(null),[fe,me]=(0,r.useState)(0),[A,he]=(0,r.useState)(null),[ge,j]=(0,r.useState)(``),[ve,ye]=(0,r.useState)(!1),[be,xe]=(0,r.useState)(``),M=(0,r.useRef)(null),we=(0,r.useRef)(null),Te=f===Tn?h.trim():f,Ee=typeof window<`u`&&window.location.hostname.endsWith(`github.io`),P=(0,r.useMemo)(()=>{let t=e.trim();if(!t.startsWith(`{`)&&!t.startsWith(`[`))return null;try{return JSON.parse(t)}catch{return null}},[e]),F=(0,r.useMemo)(()=>P?xn(P):null,[P]),I=(0,r.useMemo)(()=>P?Ke(P):``,[P]),L=(0,r.useMemo)(()=>F?$t(null,F):null,[F]),R=(0,r.useMemo)(()=>F?Sn(F):``,[F]),z=(0,r.useMemo)(()=>L?cn(L):``,[L]),B=(0,r.useMemo)(()=>R&&z?`${R}\n\n${z}`:``,[R,z]),ke=(0,r.useMemo)(()=>Et(I),[I]),V=(0,r.useMemo)(()=>F&&L?At(I,F,{targets:L.targets.targets.filter(e=>e.value&&!e.needsClinicianConfirmation).map(e=>({metric:e.metric,value:(e.ruleId?b.get(e.ruleId)?.patientStatement:null)??e.value})),followUp:L.followUp.text}):``,[I,F,L]),Ae=(0,r.useMemo)(()=>Ie({selectorPrompt:Zt,factsText:B,labReviewPrompt:Ct,labText:ke,narrativePrompt:kt,narrativeText:V}),[B,ke,V]),je=(0,r.useMemo)(()=>Ne({rawInput:e,parsedJson:!!P,model:Te,apiKey:c,requiresClientKey:Ee,totalTokens:Ae.totalTokens,tokenLimit:Ce}),[e,P,Te,c,Ee,Ae.totalTokens]);(0,r.useEffect)(()=>{if(ue===null)return;let e=window.setInterval(()=>{me(Math.floor((Date.now()-ue)/1e3))},1e3);return()=>window.clearInterval(e)},[ue]),(0,r.useEffect)(()=>{A&&we.current?.scrollIntoView({behavior:`smooth`,block:`center`})},[A]);function Me(){E(``),ee(``),se([]),j(``)}function H(e){if(e.size>Cn){he(K({apiMessage:`檔案 ${e.name} 超過 5 MB 上限。`}));return}let n=new FileReader;n.onload=()=>{t(String(n.result??``)),a(e.name),Me(),he(null)},n.readAsText(e,`utf-8`)}async function Fe(){if(he(null),j(``),se([]),te({}),ae({}),re({selector:`running`,labReview:`running`,narrative:`running`}),Pe(je)||!F)return;le(`running`),de(Date.now()),me(0);let e=new AbortController;M.current=e;let t=(t,n)=>it({apiKey:c,model:Te,systemPrompt:t,input:n,signal:e.signal,direct:Ee,timeoutMs:y*60*1e3});try{let e=await Promise.allSettled([t(Zt,B),t(Ct,ke),t(kt,V)]),n=t=>e[t].status===`fulfilled`?e[t].value.text:null,r=(e,t)=>{if(!e)return null;try{return t(e)}catch{return null}};te({rawSelector:n(0)??``,rawLabReview:n(1)??``,rawNarrative:n(2)??``});let i=r(n(0),Qt),a=r(n(1),e=>Dt(e,F)),o=r(n(2),e=>Ft(e,F));re({selector:e[0].status===`fulfilled`&&i?`ok`:`failed`,labReview:e[1].status===`fulfilled`&&a?`ok`:`failed`,narrative:e[2].status===`fulfilled`&&o?`ok`:`failed`}),ae({selector:{taken:i?[`優先序 ${i.priorities.length} 項，其中 ${i.priorities.length-$t(i,F).rejectedPriorities.length} 項在已納入清單中、被採用`,`clinician_notes ${i.clinician_notes.length} 則、data_concerns ${i.data_concerns.length} 則：目前一律丟棄，不進任何報告`,`disagreements ${i.disagreements.length} 則：僅供核對，改不了程式的主題判定`]:[],problems:i?[...$t(i,F).rejectedPriorities.length?[`指定了 ${$t(i,F).rejectedPriorities.length} 個不在納入清單中的模組，已忽略`]:[],...i.echo&&F.dcsiTotal.known&&i.echo.dcsi!==null&&i.echo.dcsi!==F.dcsiTotal.value?[`回抄的 DCSI（${i.echo.dcsi}）與輸入不符，可能不是同一位病人`]:[]]:[`回應無法解析，這一站的產出全部不採用`]},labReview:{taken:a?[`異常項目 ${a.review.abnormal.length} 則、系統性歸納 ${a.review.groups.length} 組，進醫師版`,`涵蓋來源檢驗 ${N(a.sourceRecords)} 筆`]:[],problems:a?[...a.unverifiedValues.length?[`${a.unverifiedValues.length} 個數值在來源中找不到，已在報告中就地標示`]:[],...a.unknownItems.length?[`${a.unknownItems.length} 個項目名稱來源中沒有`]:[]]:[`回應無法解析，醫師版退回程式輸出`]},narrative:{taken:o?[`敘述 ${N(De(o.narrative))} 字，放進病人版的「您的檢驗數值」`]:[],problems:o?[...o.unverifiedValues.length?[`${o.unverifiedValues.length} 個數值在來源中找不到`]:[],...o.uncitedNumbers.length?[`${o.uncitedNumbers.length} 個數字既未引用也不在門檻表：${o.uncitedNumbers.join(`、`)}`]:[],...o.bannedPhrases.length?[`踩到禁止事項：${o.bannedPhrases.join(`、`)}`]:[],...o.foundAfterAll.length?[`程式判缺檢但實際存在 ${o.foundAfterAll.length} 項，是程式的漏`]:[]]:[`回應無法解析，病人版退回固定句型`]}});let s={reportDate:new Date().toISOString().slice(0,10),dataCutoff:F.dataCutoff.known?F.dataCutoff.value:null},c=$t(i,F);E(rn(c,{...s,labNarrative:o??void 0})),ee(sn(c,F,{...s,labReview:a??void 0})),w(`patient`);let l=[],u=[i?null:`① 模組挑選`,a?null:`② 檢驗判讀`,o?null:`③ 檢驗敘述`].filter(Boolean);o?.foundAfterAll.length&&l.push(`敘述器在紀錄中找到程式判定為缺檢的 ${o.foundAfterAll.length} 項（${o.foundAfterAll.map(e=>`${e.item} → ${e.as}`).join(`、`)}）：項目名稱比對有漏，需修正程式。`),o?.unverifiedValues.length&&l.push(`病人版敘述引用了 ${o.unverifiedValues.length} 個來源中找不到的數值，已在報告中就地標示。`),o?.bannedPhrases.length&&l.push(`病人版敘述可能踩到禁止事項：${o.bannedPhrases.join(`、`)}。`),a?.unverifiedValues.length&&l.push(`醫師版判讀引用了 ${a.unverifiedValues.length} 個來源中找不到的數值，已在報告中就地標示。`),u.length&&l.push(`${u.join(`、`)}未取得，該部分已退回程式輸出。`),se(l);let d=c.decisions.filter(e=>e.kind!==`excluded`&&e.kind!==`prevention-moderate`).length;j(`完成：程式依 R／PR 納入 ${d} 個併發症主題、${c.selfCareModuleIds.length} 個自我照護模組${l.length?``:`；自動檢查全數通過`}。`)}catch(e){e instanceof J?e.failure.aborted||he(e.failure):he(K({cause:e}))}finally{M.current===e&&(M.current=null),de(null),le(`idle`)}}async function Le(e,t){await navigator.clipboard.writeText(e),xe(t),window.setTimeout(()=>xe(``),1500)}let Re=(0,r.useMemo)(()=>{let t=e=>e.map(e=>({...e,code:!0})),n=(e,n,r,i,a)=>{let o=kn.find(t=>t.id===e),s=O[a]??``;return{id:e,kind:`llm`,title:n,role:r,state:ne[e],inputs:[{label:e===`selector`?`送出的輸入（確定性事實＋判定結果）`:`送出的輸入（檢驗紀錄）`,text:i}],recipe:[{label:`system prompt（唯讀，隨版本送審）`,text:o?.text??``},...t(An[e])],steps:ie[e]?.taken,outputs:[{label:`原始回應（未解析）`,text:s}],problems:ie[e]?.problems}};return[{id:`ingest`,kind:`program`,title:`讀取申報 JSON`,role:`把申報 JSON 拆成兩份東西：一份給模型讀的純文字，一份給程式判定用的結構化事實。不改任何數值。`,state:I?`ok`:`idle`,inputs:[{label:`原始 JSON`,text:e}],recipe:t(An.ingest),steps:F?[`讀到檢驗 ${N(F.labRecordCount)} 筆、用藥 ${N(F.medicationRecordCount)} 筆`,F.labHasDrawDates?`檢驗有採檢日`:`檢驗只有費用年月、沒有採檢日，因此後面所有敘述都不得聲稱時序`,`R／PR 欄位缺 key 就記成「未提供」，不補 0`]:[],outputs:[{label:`LLM 好讀文字（給②③讀原始紀錄）`,text:I},{label:`確定性事實（給下一站判定）`,text:R}]},{id:`decide`,kind:`program`,title:`確定性判定`,role:`依 R／PR 與指引門檻表決定主題、目標與追蹤間隔。這一站不呼叫模型，換模型不會改變結果。`,state:L?`ok`:`idle`,inputs:[{label:`確定性事實`,text:R}],recipe:t(An.decide),steps:L?[`逐一判定 6 個併發症主題：納入 ${L.decisions.filter(e=>e.kind!==`excluded`).length} 個`,`依併發症與年齡解出指引目標 ${L.targets.targets.filter(e=>e.value).length} 項`,`把檢驗值比對門檻表：命中 ${L.labThresholds.length} 則`,`依用藥與低血糖紀錄選出自我照護模組 ${L.selfCareModuleIds.length} 個`]:[],outputs:[{label:`主題判定結果（附每一項的理由）`,text:z}]},n(`selector`,`① 模組挑選`,`只回模組代碼與優先序。它改不了上一站的主題判定，寫的任何文字也不會出現在病人版。`,B,`rawSelector`),n(`labReview`,`② 檢驗判讀`,`讀原始檢驗紀錄，找程式門檻沒涵蓋到的異常。結果進醫師版，每個數值都會被比對回來源。`,ke,`rawLabReview`),n(`narrative`,`③ 檢驗敘述`,`寫觀察摘要、短期建議、中期目標三段。目標數字由上一站的門檻表決定，模型只負責寫成病人的話。`,V,`rawNarrative`),{id:`assemble`,kind:`program`,title:`驗證與組裝`,role:`拿前面五站的產出，把模型寫的部分逐一比對來源數值、掃描禁止事項，通過的才組進報告；沒通過的就地標示，不改寫也不刪除。`,state:T?`ok`:`idle`,inputs:[{label:`主題判定結果（第 2 站）`,text:z},{label:`① 原始回應（第 3 站）`,text:O.rawSelector??``},{label:`② 原始回應（第 4 站）`,text:O.rawLabReview??``},{label:`③ 原始回應（第 5 站）`,text:O.rawNarrative??``}],recipe:t(An.assemble),steps:T?[`解析三份原始回應；任何一份解析不了就整份丟棄，該段退回程式輸出`,`把③敘述裡的每個數字比對回原始檢驗紀錄，對不上的標記為未核實`,`掃描禁止事項（時序宣稱、風險標籤、叫病人自行停藥等）`,`依固定模組逐字組裝兩份報告；未通過的部分就地加註警語，文字本身不改寫`,...oe.map(e=>`⚠ ${e}`)]:[],outputs:[{label:`病人版衛教報告`,text:T},{label:`醫師版報告`,text:D}]}]},[e,I,F,L,R,z,B,ke,V,ne,ie,O,T,D,oe]),ze=jn.find(e=>e.id===S)??jn[0],U=S===`patient`?T:S===`clinician`?D:O[S]??``;return(0,k.jsxs)(`main`,{className:`workspace`,children:[(0,k.jsxs)(`header`,{className:`topbar`,children:[(0,k.jsxs)(`div`,{className:`brand`,children:[(0,k.jsx)(`span`,{className:`brandMark`,children:`糖衛`}),(0,k.jsx)(`span`,{children:`報告產生器`})]}),(0,k.jsxs)(`div`,{className:`topMeta`,children:[(0,k.jsxs)(`span`,{className:`privacyPill`,children:[(0,k.jsx)(`span`,{className:`statusDot`}),`不寫入本站資料庫`]}),(0,k.jsx)(`span`,{className:`privacyPill`,children:`金鑰僅暫存本頁`})]})]}),(0,k.jsxs)(`section`,{className:`hero`,children:[(0,k.jsxs)(`div`,{className:`heroCopy`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`DIABETES EDUCATION REPORT`}),(0,k.jsxs)(`h1`,{children:[`一份健保申報 JSON，`,(0,k.jsx)(`br`,{}),`兩份可用的報告。`]}),(0,k.jsx)(`p`,{className:`heroLead`,children:`併發症主題、個別化目標與追蹤間隔完全由程式依 R／PR 與指引門檻表判定；LLM 只負責規則做不到的三件事。 病人可見的衛教正文來自固定模組，不由模型改寫。`})]}),(0,k.jsx)(Se,{})]}),(0,k.jsxs)(`article`,{className:`stepCard`,children:[(0,k.jsxs)(`div`,{className:`stepHeading`,children:[(0,k.jsx)(`span`,{className:`stepNumber`,children:`01`}),(0,k.jsxs)(`div`,{className:`stepHeadingText`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`INPUT`}),(0,k.jsx)(`h2`,{children:`病人資料`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`需要原始 JSON。這條流程要讀 R／PR／CKD 與檢驗紀錄的結構化欄位，純文字無法判定主題與門檻。`})]})]}),(0,k.jsxs)(`div`,{className:`stepBody`,children:[(0,k.jsxs)(`div`,{className:`inputGrid`,children:[(0,k.jsxs)(`div`,{className:ve?`dropZone dragging`:`dropZone`,onDragOver:e=>{e.preventDefault(),ye(!0)},onDragLeave:()=>ye(!1),onDrop:e=>{e.preventDefault(),ye(!1);let t=e.dataTransfer.files?.[0];t&&H(t)},children:[(0,k.jsx)(`span`,{className:`fileGlyph`,children:`JSON`}),(0,k.jsx)(`p`,{children:`拖曳檔案到這裡`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`上限 5 MB，只在瀏覽器內處理`}),(0,k.jsxs)(`label`,{className:`secondaryButton`,children:[`選擇檔案`,(0,k.jsx)(`input`,{type:`file`,accept:`.json,application/json`,hidden:!0,onChange:e=>{let t=e.target.files?.[0];t&&H(t),e.target.value=``}})]}),n?(0,k.jsx)(`p`,{className:`fieldNote`,children:n}):null]}),(0,k.jsxs)(`div`,{className:`editorShell`,children:[(0,k.jsxs)(`div`,{className:`editorToolbar`,children:[(0,k.jsxs)(`div`,{className:`tabs`,children:[(0,k.jsx)(`button`,{type:`button`,className:o===`raw`?`active`:``,onClick:()=>s(`raw`),children:`原始 JSON`}),(0,k.jsx)(`button`,{type:`button`,className:o===`formatted`?`active`:``,onClick:()=>s(`formatted`),disabled:!I,children:`LLM 好讀文字`})]}),(0,k.jsxs)(`span`,{className:`fieldNote`,children:[N(De(o===`raw`?e:I)),` 字`]})]}),(0,k.jsx)(`textarea`,{className:`inputEditor`,value:o===`raw`?e:I,readOnly:o===`formatted`,onChange:e=>{t(e.target.value),Me()},placeholder:`在此貼上健保申報 JSON…`,spellCheck:!1}),(0,k.jsxs)(`div`,{className:`inlineActions`,children:[(0,k.jsx)(`button`,{type:`button`,className:`textButton`,onClick:()=>{t(Mn),a(``),Me()},children:`載入合成示範資料`}),(0,k.jsx)(`span`,{className:`fieldNote`,children:`示範資料為虛構，非真實病人`})]})]})]}),L&&F?(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`dl`,{className:`factGrid`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`已發生的併發症主題`}),(0,k.jsxs)(`dd`,{children:[L.decisions.filter(e=>e.kind===`established`).length,` 項`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`預防重點・積極照護`}),(0,k.jsxs)(`dd`,{children:[L.decisions.filter(e=>e.kind===`prevention-active`).length,` 項`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`預防重點・適度介入`}),(0,k.jsxs)(`dd`,{children:[L.moderateTopics.length,` 項`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`需核實的檢驗結果`}),(0,k.jsxs)(`dd`,{children:[L.labThresholds.length,` 則`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`自我照護模組`}),(0,k.jsxs)(`dd`,{children:[L.selfCareModuleIds.length,` 個`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`dt`,{children:`依指引推導的目標`}),(0,k.jsxs)(`dd`,{children:[L.targets.targets.filter(e=>e.value).length,` 項`]})]})]}),(0,k.jsxs)(`details`,{className:`traceToggle`,open:!0,children:[(0,k.jsx)(`summary`,{children:`看這位病人實際跑出來的判定路徑`}),(0,k.jsx)(_e,{plan:L,facts:F})]})]}):null]})]}),(0,k.jsxs)(`article`,{className:`stepCard generatorCard`,children:[(0,k.jsxs)(`div`,{className:`stepHeading`,children:[(0,k.jsx)(`span`,{className:`stepNumber`,children:`02`}),(0,k.jsxs)(`div`,{className:`stepHeadingText`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`RUN`}),(0,k.jsx)(`h2`,{children:`產出兩份報告`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`按一次並行送出三個請求。金鑰只在執行時使用，不寫入本站。`})]})]}),(0,k.jsxs)(`div`,{className:`stepBody`,children:[(0,k.jsxs)(`div`,{className:`settingsPane`,children:[(0,k.jsxs)(`div`,{className:`credentialBox`,children:[(0,k.jsxs)(`div`,{className:`credentialLabelRow`,children:[(0,k.jsx)(`label`,{className:`fieldLabel`,htmlFor:En,children:`Gemini 臨時存取金鑰`}),(0,k.jsx)(`span`,{className:`fieldNote`,children:`重新整理即清除`})]}),(0,k.jsxs)(`div`,{className:`passwordRow`,children:[(0,k.jsx)(`input`,{id:En,className:`apiKeyInput`,type:u?`text`:`password`,value:c,onChange:e=>l(e.target.value),autoComplete:`off`,spellCheck:!1,placeholder:`貼上金鑰`}),(0,k.jsx)(`button`,{type:`button`,className:`showKeyButton`,onClick:()=>d(e=>!e),children:u?`隱藏`:`顯示`})]}),(0,k.jsxs)(`p`,{className:`fieldNote`,children:[`只暫存在本頁記憶體，不寫入資料庫或瀏覽器儲存空間。`,Ee?`此版本由瀏覽器直接傳給 Google Gemini。`:`私人站版透過本站伺服器轉送。`,`請只在可信任的網址輸入金鑰。`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{className:`fieldLabel`,htmlFor:`modelSelect`,children:`Gemini 模型`}),(0,k.jsx)(`select`,{id:`modelSelect`,className:`selectInput`,value:f,onChange:e=>p(e.target.value),children:On.map(e=>(0,k.jsx)(`option`,{value:e.value,children:e.label},e.value))}),f===Tn?(0,k.jsx)(`input`,{className:`customModelInput`,value:h,onChange:e=>g(e.target.value),placeholder:`輸入 Gemini API 支援的模型 ID`}):null]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{className:`fieldLabel`,htmlFor:`timeoutInput`,children:`單次請求逾時上限（分鐘）`}),(0,k.jsx)(`input`,{id:`timeoutInput`,className:`textInput`,type:`number`,min:1,max:60,value:y,onChange:e=>x(Number(e.target.value)||Dn)}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`逾時會明確顯示為逾時，與你按「停止」區分。`})]})]}),(0,k.jsx)(Fn,{input:Ae}),A?(0,k.jsxs)(`div`,{className:`errorBanner`,ref:we,role:`alert`,children:[(0,k.jsx)(`strong`,{children:A.title}),(0,k.jsx)(`p`,{children:A.advice}),A.raw?(0,k.jsx)(`pre`,{children:A.raw}):null]}):null,ge?(0,k.jsx)(`div`,{className:`noticeBanner`,children:ge}):null,oe.length?(0,k.jsxs)(`div`,{className:`blockerList`,role:`status`,children:[(0,k.jsx)(`strong`,{children:`自動檢查發現`}),(0,k.jsx)(`ul`,{children:oe.map(e=>(0,k.jsx)(`li`,{className:`soft`,children:(0,k.jsx)(`span`,{className:`blockerMessage`,children:e})},e))})]}):null,(0,k.jsx)(Pn,{blockers:je}),(0,k.jsxs)(`div`,{className:`cardActions`,children:[(0,k.jsx)(`button`,{type:`button`,className:`primaryButton`,onClick:Fe,disabled:ce!==`idle`||Pe(je),children:ce===`running`?(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`span`,{className:`spinner`}),`三次呼叫並行中… `,fe,` 秒`]}):`產出兩份報告`}),ce===`running`?(0,k.jsx)(`button`,{type:`button`,className:`stopButton`,onClick:()=>M.current?.abort(),children:`停止`}):null]})]})]}),(0,k.jsxs)(`article`,{className:`stepCard`,children:[(0,k.jsxs)(`div`,{className:`stepHeading`,children:[(0,k.jsx)(`span`,{className:`stepNumber`,children:`03`}),(0,k.jsxs)(`div`,{className:`stepHeadingText`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`OUTPUT`}),(0,k.jsx)(`h2`,{children:`兩份報告`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`兩份由同一份判定組出，主題、目標與門檻一致。`})]})]}),(0,k.jsxs)(`div`,{className:`stepBody`,children:[(0,k.jsxs)(`div`,{className:`outputHeader`,children:[(0,k.jsx)(`div`,{className:`tabs`,children:jn.map(e=>(0,k.jsx)(`button`,{type:`button`,className:S===e.id?`active`:``,onClick:()=>w(e.id),children:e.label},e.id))}),(0,k.jsxs)(`div`,{className:`outputActions`,children:[(0,k.jsx)(`span`,{className:`fieldNote`,children:U?`${N(De(U))} 字`:`等待產出`}),(0,k.jsx)(`button`,{type:`button`,className:`miniButton`,onClick:()=>Le(U,S),disabled:!U,children:be===S?`已複製`:`複製`}),(0,k.jsx)(`button`,{type:`button`,className:`miniButton`,onClick:()=>Nn(ze.filename,U),disabled:!U,children:`下載 TXT`})]})]}),(0,k.jsx)(`p`,{className:`fieldNote`,children:ze.note}),(0,k.jsx)(`textarea`,{className:`outputEditor`,value:U,readOnly:!0,spellCheck:!1,placeholder:S.startsWith(`raw`)?`尚未呼叫，或該次呼叫失敗。`:`尚未產出。`})]})]}),(0,k.jsxs)(`article`,{className:`stepCard`,children:[(0,k.jsxs)(`div`,{className:`stepHeading`,children:[(0,k.jsx)(`span`,{className:`stepNumber`,children:`04`}),(0,k.jsxs)(`div`,{className:`stepHeadingText`,children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`PIPELINE`}),(0,k.jsx)(`h2`,{children:`管線的每一站`}),(0,k.jsx)(`p`,{className:`fieldNote`,children:`每一站點開就看得到餵進去什麼、吐出什麼，以及程式從中採用了哪些、丟掉哪些。 system prompt 由程式定義並隨版本一起送審，不在頁面上編輯。`})]})]}),(0,k.jsx)(`div`,{className:`stepBody`,children:(0,k.jsx)(Oe,{stations:Re})})]}),(0,k.jsx)(pe,{}),(0,k.jsxs)(`section`,{className:`safetyNote`,children:[(0,k.jsx)(`span`,{className:`safetyIcon`,children:`i`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`上線前的必要提醒`}),(0,k.jsxs)(`p`,{children:[`衛教模組 `,m,`、自我照護模組 `,C,`、指引門檻表 `,_,`（`,v,`）均尚未經醫療團隊核准。病人版的觀察摘要、短期建議、中期目標三段由模型撰寫，數值已由程式逐一比對來源， 但文字未經逐句核准。正式提供病人前，仍應由醫療團隊核准固定內容、prompt 與模型版本，並建立人工抽查與版本紀錄。`]})]})]}),(0,k.jsxs)(`footer`,{className:`buildStamp`,children:[(0,k.jsx)(`span`,{children:`糖尿病衛教報告產生器`}),(0,k.jsx)(`span`,{children:`資料僅在本頁處理；按下產出時才送往 Gemini API。`}),(0,k.jsx)(`span`,{children:`build ${i}`})]})]})}export{In as default};